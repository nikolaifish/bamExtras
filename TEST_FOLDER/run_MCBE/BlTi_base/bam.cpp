...
cout << endl;
  ...
  batchfecpar_a.allocate("batchfecpar_a");
  batchfecpar_b.allocate("batchfecpar_b");
  nbatch.allocate("nbatch");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  wgt_lb.allocate(1,nages,"wgt_lb");
    ...
    wgt_lb.initialize();
  #endif
  batchfec.allocate(1,nages,"batchfec");
  #ifndef NO_AD_INITIALIZE
    batchfec.initialize();
  #endif
  fec.allocate(1,nages,"fec");
  #ifndef NO_AD_INITIALIZE
    fec.initialize();
  #endif
  ...
  log_q_cpue_cLL.allocate(log_q_cLL_LO,log_q_cLL_HI,log_q_cLL_PH,"log_q_cpue_cLL");
  ...
  #endif
  log_q_cLL_out.allocate(1,8,"log_q_cLL_out");
  #ifndef NO_AD_INITIALIZE
    log_q_cLL_out.initialize();
  #endif
  ...
  q_RW_log_dev_cLL.allocate(styr_cpue_cLL,endyr_cpue_cLL-1,log_RWq_LO,log_RWq_HI,log_RWq_PH,"q_RW_log_dev_cLL");
  ...
  #endif
  f_cLL_RWq_cpue.allocate("f_cLL_RWq_cpue");
  #ifndef NO_AD_INITIALIZE
  f_cLL_RWq_cpue.initialize();
  #endif
