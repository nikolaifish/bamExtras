...
open_r_df("parm.cons",1,8,2);
    ...
    wrt_r_df_col("log_dm_lenc_cHL",log_dm_cHL_lc_out);
	wrt_r_df_col("log_dm_lenc_cLL",log_dm_cLL_lc_out);
	wrt_r_df_col("log_dm_lenc_rGN",log_dm_rGN_lc_out);
	...
	// wrt_r_df_col("selpar_A502_cHL2",selpar_A502_cHL2_out);
    // wrt_r_df_col("selpar_slope2_cHL2",selpar_slope2_cHL2_out);	
    // wrt_r_df_col("selpar_A50_cHL3",selpar_A50_cHL3_out);
    // wrt_r_df_col("selpar_slope_cHL3",selpar_slope_cHL3_out);

    wrt_r_df_col("selpar_A50_cLL1",selpar_A50_cLL1_out);
    wrt_r_df_col("selpar_slope_cLL1",selpar_slope_cLL1_out);	
    // wrt_r_df_col("selpar_A50_cLL2",selpar_A50_cLL2_out);
    // wrt_r_df_col("selpar_slope_cLL2",selpar_slope_cLL2_out);
	// wrt_r_df_col("selpar_A502_cLL2",selpar_A502_cLL2_out);
    // wrt_r_df_col("selpar_slope2_cLL2",selpar_slope2_cLL2_out);		
    // wrt_r_df_col("selpar_A50_cLL3",selpar_A50_cLL3_out);
    // wrt_r_df_col("selpar_slope_cLL3",selpar_slope_cLL3_out);		
	...
	wrt_r_df_col("log_q_cpue_cLL",log_q_cLL_out);    
	...
	wrt_r_df_col("log_avg_F_L_cLL",log_avg_F_cLL_out);
