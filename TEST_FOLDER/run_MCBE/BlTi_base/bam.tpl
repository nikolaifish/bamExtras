...
// init_int endyr_selex_phase1_cHL; // cHL
// init_int endyr_selex_phase1_cLL; // cLL
init_int endyr_selex_phase1_rGN; // rGN
// ending years of selectivity block 2
// init_int endyr_selex_phase2_cHL; // cHL
...
//######################################################################################################
//## cHL ######## INDEX ########
//## cHL ## Starting and ending years of CPUE index
init_int styr_cpue_cHL;                                             
init_int endyr_cpue_cHL;
//## cHL ## Observed index CPUE and CVs                                            
init_vector obs_cpue_cHL(styr_cpue_cHL,endyr_cpue_cHL);
init_vector obs_cv_cpue_cHL(styr_cpue_cHL,endyr_cpue_cHL);

//## cHL ######## LANDINGS ########
//## cHL ## Starting and ending years of landings (bt50 landings+discards; includes cHL and cOT (commercial other))
init_int styr_L_cHL;
init_int endyr_L_cHL;
//## cHL ## Observed landings (1000 lbs) and assumed CVs
init_vector obs_L_cHL(styr_L_cHL,endyr_L_cHL);
init_vector obs_cv_L_cHL(styr_L_cHL,endyr_L_cHL);

//## cHL ######## LENGTH COMPS ########
//## cHL ## Number and vector of years of length compositions
init_int nyr_lenc_cHL;
init_ivector yrs_lenc_cHL(1,nyr_lenc_cHL);
//## cHL ## Sample size of length comp data (first row observed n.trips, second row n.fish)
init_vector nsamp_lenc_cHL(1,nyr_lenc_cHL);
init_vector nfish_lenc_cHL(1,nyr_lenc_cHL);
//## cHL ## Observed length comps (3cm bins; proportions by year)
...
//######################################################################################################
//## cLL ######## INDEX ########
//## cLL ## Starting and ending years of CPUE index
init_int styr_cpue_cLL;                                             
init_int endyr_cpue_cLL;
//## cLL ## Observed index CPUE and CVs                                            
init_vector obs_cpue_cLL(styr_cpue_cLL,endyr_cpue_cLL);
init_vector obs_cv_cpue_cLL(styr_cpue_cLL,endyr_cpue_cLL);

//## cLL ######## LANDINGS ########
//## cLL ## Starting and ending years of landings (bt50 landings+discards)
init_int styr_L_cLL;
init_int endyr_L_cLL;
//## cLL ## Observed landings (1000 lbs) and assumed CVs
init_vector obs_L_cLL(styr_L_cLL,endyr_L_cLL);
init_vector obs_cv_L_cLL(styr_L_cLL,endyr_L_cLL);

//## cLL ######## LENGTH COMPS ########
//## cLL ## Number and vector of years of length compositions
init_int nyr_lenc_cLL;
init_ivector yrs_lenc_cLL(1,nyr_lenc_cLL);
//## cLL ## Sample size of length comp data (first row observed n.trips, second row n.fish)
init_vector nsamp_lenc_cLL(1,nyr_lenc_cLL);
init_vector nfish_lenc_cLL(1,nyr_lenc_cLL);

//## cLL ## Observed length comps (3cm bins; proportions by year)
...
init_vector set_log_dm_lenc_cHL(1,7);  	// Dirichlet-multinomial overdispersion parameter (log-space): cHL length comps
init_vector set_log_dm_lenc_cLL(1,7); 		// Dirichlet-multinomial overdispersion parameter (log-space): cLL length comps
//init_vector set_log_dm_rHB_lc(1,7);  	// Dirichlet-multinomial overdispersion parameter (log-space): rHB length comps
init_vector set_log_dm_lenc_rGN(1,7);  	// Dirichlet-multinomial overdispersion parameter (log-space): rGN length comps
//######## Selectivity ########
init_vector set_selpar_A50_cHL1(1,7);	// cHL age at 0.5 selectivity
init_vector set_selpar_slope_cHL1(1,7);	// cHL slope of ascending limb
// init_vector set_selpar_A50_cHL2(1,7);	// cHL age at 0.5 selectivity (block 2)
// init_vector set_selpar_slope_cHL2(1,7);	// cHL slope of ascending limb (block 2)
// init_vector set_selpar_A502_cHL2(1,7);	// cHL L502 (block 2)
// init_vector set_selpar_slope2_cHL2(1,7);	// cHL slope of descending limb (block 2)
// init_vector set_selpar_A50_cHL3(1,7);	// cHL age at 0.5 selectivity (block 3)
// init_vector set_selpar_slope_cHL3(1,7);	// cHL slope of ascending limb (block 3)
...
//######## IndexCatchability ########
init_vector set_log_q_cpue_cHL(1,7);      	// cHL CPUE (log q)
init_vector set_log_q_cpue_cLL(1,7);      	// cLL CPUE (log q)
init_vector set_log_q_cpue_rHB(1,7);      	// rHB CPUE (log q)
//######## FishingMortality ########
init_vector set_F_init(1,7);  			// initial F (not log space) 
init_vector set_log_avg_F_L_cHL(1,7);		// cHL log mean F
init_vector set_log_avg_F_L_cLL(1,7);		// cLL log mean F
init_vector set_log_avg_F_L_rGN(1,7);		// rGN log mean F

//######################################################################################################
//## Dev vectors
//######################################################################################################
init_vector set_log_dev_F_L_cHL(1,3); 		// cHL F devs
init_vector set_log_dev_F_L_cLL(1,3);		// cLL F devs
...
init_number set_w_cpue_cHL;         // cHL index
init_number set_w_cpue_cLL;         // cLL index
init_number set_w_cpue_rHB;         // rHB index
init_number set_w_lenc_cHL;        // cHL length comps
init_number set_w_lenc_cLL;        // cLL length comps
init_number set_w_lenc_rGN;		// rGN length comps
...
init_number minSS_lenc_cHL;	// cHL len comps
init_number minSS_lenc_cLL;	// cLL len comps
// init_number minSS_rHB_lenc;	// rHB len comps	(to be removed for bt50)
init_number minSS_lenc_rGN;	// rGN len comps
...
//##################################################################################################
 ...
 LOCAL_CALCS
  ...
  // const double selpar_A502_cHL2_LO=set_selpar_A502_cHL2(2); const double selpar_A502_cHL2_HI=set_selpar_A502_cHL2(3); const double selpar_A502_cHL2_PH=set_selpar_A502_cHL2(4);
  // const double selpar_slope2_cHL2_LO=set_selpar_slope2_cHL2(2); const double selpar_slope2_cHL2_HI=set_selpar_slope2_cHL2(3); const double selpar_slope2_cHL2_PH=set_selpar_slope2_cHL2(4); 
  ...
  // const double selpar_slope_cLL3_LO=set_selpar_slope_cLL3(2); const double selpar_slope_cLL3_HI=set_selpar_slope_cLL3(3); const double selpar_slope_cLL3_PH=set_selpar_slope_cLL3(4);  
  ...
  const double log_q_cLL_LO=set_log_q_cpue_cLL(2); const double log_q_cLL_HI=set_log_q_cpue_cLL(3); const double log_q_cLL_PH=set_log_q_cpue_cLL(4);  
...
//Commercial handline-------------------------------------------------
  ...
  // init_bounded_number selpar_slope_cLL3(selpar_slope_cLL3_LO,selpar_slope_cLL3_HI,selpar_slope_cLL3_PH);  
  ...
  // vector selpar_slope_cLL3_out(1,8);    
...
//---Catchability (CPUE q's)----------------------------------------------------------
  ...
  init_bounded_number log_q_cpue_cLL(log_q_cLL_LO,log_q_cLL_HI,log_q_cLL_PH);  
...
//Fishery dependent random walk catchability
 ...
 init_bounded_vector q_RW_log_dev_cLL(styr_cpue_cLL,endyr_cpue_cLL-1,log_RWq_LO,log_RWq_HI,log_RWq_PH);
...
// Set values of fixed parameters or set initial guess of estimated parameters
 ...
 //Population		
  ...
  // selpar_A502_cHL2=set_selpar_A502_cHL2(1);
  ...
  // selpar_slope_cLL3=set_selpar_slope_cLL3(1);    
...
FUNCTION get_selectivity
  ...
  sel_cLL_block1=logistic(agebins, selpar_A50_cLL1, selpar_slope_cLL1);
  // sel_cLL_block2=logistic(agebins, selpar_A50_cLL2, selpar_slope_cLL2);
  // sel_cLL_block2=logistic_double(agebins, selpar_A50_cLL2, selpar_slope_cLL2, selpar_A502_cLL2, selpar_slope2_cLL2);  
  // sel_cLL_block3=logistic(agebins, selpar_A50_cLL3, selpar_slope_cLL3);  
  ...
  sel_rHB_block2=sel_rGN_block2; // Use rGN selectivity for rHB
  // sel_rHB_block3=sel_rGN_block3; // Use rGN selectivity for rHB  
  ...
  //BLOCK 2 for selex  
  // for (iyear=(endyr_selex_phase1_cHL+1); iyear<=endyr_selex_phase2_cHL; iyear++)
   // {    
    // sel_cHL(iyear)=sel_cHL_block2;
   // }
  // BLOCK 3 for selex  
  // for (iyear=(endyr_selex_phase2_cHL+1); iyear<=endyr; iyear++)
   // {    
  ...
  for (iyear=styr; iyear<=endyr; iyear++)
   {     
	sel_cLL(iyear)=sel_cLL_block1;
   }
  //BLOCK 2 for selex  
  // for (iyear=(endyr_selex_phase1_cLL+1); iyear<=endyr_selex_phase2_cLL; iyear++)
   // {    
	// sel_cLL(iyear)=sel_cLL_block2;
   // } 
  //BLOCK 3 for selex  
  // for (iyear=(endyr_selex_phase2_cLL+1); iyear<=endyr; iyear++)
   // {    
	// sel_cLL(iyear)=sel_cLL_block3;
   // } 
  ...
  // BLOCK 2 for selex  
  for (iyear=(endyr_selex_phase1_rGN+1); iyear<=endyr; iyear++)
   {    
    sel_rHB(iyear)=sel_rHB_block2;
    sel_rGN(iyear)=sel_rGN_block2;
   }
  //BLOCK 3 for selex  
  // for (iyear=(endyr_selex_phase2_rGN+1); iyear<=endyr; iyear++)
   // {    
...
//Initialization
  ...
  F_init_denom=mfexp(log_avg_F_L_cHL+log_F_dev_init_cHL)+mfexp(log_avg_F_L_cLL+log_F_dev_init_cLL)+mfexp(log_avg_F_L_rGN+log_F_dev_init_rGN);
  F_init_cHL_prop= mfexp(log_avg_F_L_cHL+log_F_dev_init_cHL)/F_init_denom;
  F_init_cLL_prop= mfexp(log_avg_F_L_cLL+log_F_dev_init_cLL)/F_init_denom;
...
FUNCTION get_weighted_current 
  ...
  wgt_wgted_L_denom=F_cHL_prop+F_cLL_prop+F_rGN_prop;  //+F_rHB_prop
...
//switch here if var_rec_dev <=dzero 
  ...
  for(iyear=styr; iyear<=endyr; iyear++)
  {
        L_total_klb_yr(iyear)=pred_cHL_L_klb(iyear)+pred_cLL_L_klb(iyear)+pred_rGN_L_klb(iyear);//+pred_rHB_L_klb(iyear)
  ...
  L_total_num=L_cHL_num+L_cLL_num+L_rGN_num;//+L_rHB_num   //landings at age in number fish
  L_total_klb=L_cHL_klb+L_cLL_klb+L_rGN_klb;//+L_rHB_klb   //landings at age in klb whole weight
...
//pdf type 1=none, 2=lognormal, 3=normal, 4=beta 
  ...
  // f_priors+=neg_log_prior(selpar_A502_cHL2,set_selpar_A502_cHL2(5), set_selpar_A502_cHL2(6), set_selpar_A502_cHL2(7));
  // f_priors+=neg_log_prior(selpar_slope2_cHL2,set_selpar_slope2_cHL2(5), set_selpar_slope2_cHL2(6), set_selpar_slope2_cHL2(7));  
  ...
  // f_priors+=neg_log_prior(selpar_slope_cLL3,set_selpar_slope_cLL3(5), set_selpar_slope_cLL3(6), set_selpar_slope_cLL3(7));   
...
REPORT_SECTION
  ...
  if (last_phase())  
  {
      ...
      //################################################################################################# 
       ...
       // selpar_A502_cHL2_out(8)=selpar_A502_cHL2; selpar_A502_cHL2_out(1,7)=set_selpar_A502_cHL2;
       // selpar_slope2_cHL2_out(8)=selpar_slope2_cHL2; selpar_slope2_cHL2_out(1,7)=set_selpar_slope2_cHL2;	   
       ...
       // selpar_slope_cLL3_out(8)=selpar_slope_cLL3; selpar_slope_cLL3_out(1,7)=set_selpar_slope_cLL3;	   
       ...
       log_q_cLL_out(8)=log_q_cpue_cLL; log_q_cLL_out(1,7)=set_log_q_cpue_cLL;	   
