...
cout << endl;
  ...
  styr_L_cDV.allocate("styr_L_cDV");
  endyr_L_cDV.allocate("endyr_L_cDV");
  obs_L_cDV.allocate(styr_L_cDV,endyr_L_cDV,"obs_L_cDV");
  obs_cv_L_cDV.allocate(styr_L_cDV,endyr_L_cDV,"obs_cv_L_cDV");
  nyr_agec_cDV.allocate("nyr_agec_cDV");
  yrs_agec_cDV.allocate(1,nyr_agec_cDV,"yrs_agec_cDV");
  nsamp_agec_cDV.allocate(1,nyr_agec_cDV,"nsamp_agec_cDV");
  nfish_agec_cDV.allocate(1,nyr_agec_cDV,"nfish_agec_cDV");
  obs_agec_cDV.allocate(1,nyr_agec_cDV,1,nages_agec,"obs_agec_cDV");
  ...
  set_log_dm_agec_cDV.allocate(1,7,"set_log_dm_agec_cDV");
  ...
  set_selpar_A50_cDV2.allocate(1,7,"set_selpar_A50_cDV2");
  set_selpar_slope_cDV2.allocate(1,7,"set_selpar_slope_cDV2");
  set_selpar_A502_cDV2.allocate(1,7,"set_selpar_A502_cDV2");
  set_selpar_slope2_cDV2.allocate(1,7,"set_selpar_slope2_cDV2");
  ...
  set_log_avg_F_L_cDV.allocate(1,7,"set_log_avg_F_L_cDV");
  ...
  set_log_dev_F_L_cDV.allocate(1,3,"set_log_dev_F_L_cDV");
  ...
  set_log_dev_vals_F_L__cDV.allocate(styr_L_cDV,endyr_L_cDV,"set_log_dev_vals_F_L__cDV");
  ...
  set_w_agec_cDV.allocate("set_w_agec_cDV");
  ...
  minSS_agec_cDV.allocate("minSS_agec_cDV");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  #endif
  len_cDV_mm.allocate(styr,endyr,1,nages,"len_cDV_mm");
  #ifndef NO_AD_INITIALIZE
    len_cDV_mm.initialize();
  #endif
  wholewgt_cDV_klb.allocate(styr,endyr,1,nages,"wholewgt_cDV_klb");
  #ifndef NO_AD_INITIALIZE
    wholewgt_cDV_klb.initialize();
  #endif
  gutwgt_cDV_klb.allocate(styr,endyr,1,nages,"gutwgt_cDV_klb");
  #ifndef NO_AD_INITIALIZE
    gutwgt_cDV_klb.initialize();
  #endif
  ...
  #endif
  gutwgt_rHB_klb.allocate(styr,endyr,1,nages,"gutwgt_rHB_klb");
  #ifndef NO_AD_INITIALIZE
    gutwgt_rHB_klb.initialize();
  #endif
  ...
  #endif
  gutwgt_cHL_D_klb.allocate(styr,endyr,1,nages,"gutwgt_cHL_D_klb");
  #ifndef NO_AD_INITIALIZE
    gutwgt_cHL_D_klb.initialize();
  #endif
  ...
  #endif
  gutwgt_rHB_D_klb.allocate(styr,endyr,1,nages,"gutwgt_rHB_D_klb");
  #ifndef NO_AD_INITIALIZE
    gutwgt_rHB_D_klb.initialize();
  #endif
  ...
  #endif
  gutwgt_rGN_D_klb.allocate(styr,endyr,1,nages,"gutwgt_rGN_D_klb");
  #ifndef NO_AD_INITIALIZE
    gutwgt_rGN_D_klb.initialize();
  #endif
  ...
  #endif
  pred_cDV_agec.allocate(1,nyr_agec_cDV,1,nages_agec,"pred_cDV_agec");
  #ifndef NO_AD_INITIALIZE
    pred_cDV_agec.initialize();
  #endif
  pred_cDV_agec_allages.allocate(1,nyr_agec_cDV,1,nages,"pred_cDV_agec_allages");
  #ifndef NO_AD_INITIALIZE
    pred_cDV_agec_allages.initialize();
  #endif
  ErrorFree_cDV_agec.allocate(1,nyr_agec_cDV,1,nages,"ErrorFree_cDV_agec");
  #ifndef NO_AD_INITIALIZE
    ErrorFree_cDV_agec.initialize();
  #endif
  ...
  #endif
  nsamp_cDV_agec_allyr.allocate(styr,endyr,"nsamp_cDV_agec_allyr");
  #ifndef NO_AD_INITIALIZE
    nsamp_cDV_agec_allyr.initialize();
  #endif
  ...
  #endif
  nfish_cDV_agec_allyr.allocate(styr,endyr,"nfish_cDV_agec_allyr");
  #ifndef NO_AD_INITIALIZE
    nfish_cDV_agec_allyr.initialize();
  #endif
  ...
  #endif
  neff_cDV_agec_allyr.allocate(styr,endyr,"neff_cDV_agec_allyr");
  #ifndef NO_AD_INITIALIZE
    neff_cDV_agec_allyr.initialize();
  #endif
  ...
  log_dm_agec_cDV.allocate(log_dm_cDV_ac_LO,log_dm_cDV_ac_HI,log_dm_cDV_ac_PH,"log_dm_agec_cDV");
  ...
  #endif
  log_dm_cDV_ac_out.allocate(1,8,"log_dm_cDV_ac_out");
  #ifndef NO_AD_INITIALIZE
    log_dm_cDV_ac_out.initialize();
  #endif
  ...
  #endif
  sel_cDV.allocate(styr,endyr,1,nages,"sel_cDV");
  #ifndef NO_AD_INITIALIZE
    sel_cDV.initialize();
  #endif
  sel_cDV_block1.allocate(1,nages,"sel_cDV_block1");
  #ifndef NO_AD_INITIALIZE
    sel_cDV_block1.initialize();
  #endif
  sel_cDV_block2.allocate(1,nages,"sel_cDV_block2");
  #ifndef NO_AD_INITIALIZE
    sel_cDV_block2.initialize();
  #endif
  sel_cDV_block3.allocate(1,nages,"sel_cDV_block3");
  #ifndef NO_AD_INITIALIZE
    sel_cDV_block3.initialize();
  #endif
  selpar_A50_cDV2.allocate(selpar_A50_cDV2_LO,selpar_A50_cDV2_HI,selpar_A50_cDV2_PH,"selpar_A50_cDV2");
  selpar_slope_cDV2.allocate(selpar_slope_cDV2_LO,selpar_slope_cDV2_HI,selpar_slope_cDV2_PH,"selpar_slope_cDV2");
  selpar_A502_cDV2.allocate(selpar_A502_cDV2_LO,selpar_A502_cDV2_HI,selpar_A502_cDV2_PH,"selpar_A502_cDV2");
  selpar_slope2_cDV2.allocate(selpar_slope2_cDV2_LO,selpar_slope2_cDV2_HI,selpar_slope2_cDV2_PH,"selpar_slope2_cDV2");
  selpar_A50_cDV2_out.allocate(1,8,"selpar_A50_cDV2_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A50_cDV2_out.initialize();
  #endif
  selpar_slope_cDV2_out.allocate(1,8,"selpar_slope_cDV2_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope_cDV2_out.initialize();
  #endif
  selpar_A502_cDV2_out.allocate(1,8,"selpar_A502_cDV2_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A502_cDV2_out.initialize();
  #endif
  selpar_slope2_cDV2_out.allocate(1,8,"selpar_slope2_cDV2_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope2_cDV2_out.initialize();
  #endif
  ...
  #endif
  L_cDV_num.allocate(styr,endyr,1,nages,"L_cDV_num");
  #ifndef NO_AD_INITIALIZE
    L_cDV_num.initialize();
  #endif
  L_cDV_klb.allocate(styr,endyr,1,nages,"L_cDV_klb");
  #ifndef NO_AD_INITIALIZE
    L_cDV_klb.initialize();
  #endif
  pred_cDV_L_knum.allocate(styr,endyr,"pred_cDV_L_knum");
  #ifndef NO_AD_INITIALIZE
    pred_cDV_L_knum.initialize();
  #endif
  pred_cDV_L_klb.allocate(styr,endyr,"pred_cDV_L_klb");
  #ifndef NO_AD_INITIALIZE
    pred_cDV_L_klb.initialize();
  #endif
  ...
  #endif
  F_cDV_prop.allocate("F_cDV_prop");
  #ifndef NO_AD_INITIALIZE
  F_cDV_prop.initialize();
  #endif
  ...
  #endif
  log_avg_F_L_cDV.allocate(log_avg_F_cDV_LO,log_avg_F_cDV_HI,log_avg_F_cDV_PH,"log_avg_F_L_cDV");
  log_avg_F_cDV_out.allocate(1,8,"log_avg_F_cDV_out");
  #ifndef NO_AD_INITIALIZE
    log_avg_F_cDV_out.initialize();
  #endif
  log_dev_F_L_cDV.allocate(styr_L_cDV,endyr_L_cDV,log_F_dev_cDV_LO,log_F_dev_cDV_HI,log_F_dev_cDV_PH,"log_dev_F_L_cDV");
  log_F_dev_cDV_out.allocate(styr_L_cDV,endyr_L_cDV,"log_F_dev_cDV_out");
  #ifndef NO_AD_INITIALIZE
    log_F_dev_cDV_out.initialize();
  #endif
  F_cDV.allocate(styr,endyr,1,nages,"F_cDV");
  #ifndef NO_AD_INITIALIZE
    F_cDV.initialize();
  #endif
  F_cDV_out.allocate(styr,endyr,"F_cDV_out");
  #ifndef NO_AD_INITIALIZE
    F_cDV_out.initialize();
  #endif
  log_F_dev_init_cDV.allocate("log_F_dev_init_cDV");
  #ifndef NO_AD_INITIALIZE
  log_F_dev_init_cDV.initialize();
  #endif
  log_F_dev_end_cDV.allocate("log_F_dev_end_cDV");
  #ifndef NO_AD_INITIALIZE
  log_F_dev_end_cDV.initialize();
  #endif
  ...
  #endif
  sdnr_ac_cDV.allocate("sdnr_ac_cDV");
  #ifndef NO_AD_INITIALIZE
  sdnr_ac_cDV.initialize();
  #endif
  ...
  #endif
  w_agec_cDV.allocate("w_agec_cDV");
  #ifndef NO_AD_INITIALIZE
  w_agec_cDV.initialize();
  #endif
  ...
  #endif
  f_cDV_agec.allocate("f_cDV_agec");
  #ifndef NO_AD_INITIALIZE
  f_cDV_agec.initialize();
  #endif
