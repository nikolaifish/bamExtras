...
init_int nyr_lenc_pool_rGN_D;
init_ivector yrs_lenc_pool_rGN_D(1,nyr_lenc_pool_rGN_D);
//# Annual sample size (nfish) of length comp data; used to weight years for pooling
init_vector nfish_lenc_pool_rGN_D(1,nyr_lenc_pool_rGN_D);
...
//----Predicted length and age compositions
  ...
  matrix pred_rGN_D_lenc_yr(1,nyr_lenc_pool_rGN_D,1,nlenbins); //annual predicted length comps
