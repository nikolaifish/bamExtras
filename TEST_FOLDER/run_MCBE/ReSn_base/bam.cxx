...
open_r_info_list("parms", false);
	...
	wrt_r_item("D.mort.cHL1", Dmort_cHL1);
	wrt_r_item("D.mort.rHB1", Dmort_rHB1);
	wrt_r_item("D.mort.rGN1", Dmort_rGN1);
	wrt_r_item("D.mort.cHL2", Dmort_cHL2);
	wrt_r_item("D.mort.rHB2", Dmort_rHB2);
	wrt_r_item("D.mort.rGN2", Dmort_rGN2);
	wrt_r_item("D.mort.cHL3", Dmort_cHL3);
	wrt_r_item("D.mort.rHB3", Dmort_rHB3);
	wrt_r_item("D.mort.rGN3", Dmort_rGN3);	
	...
	wrt_r_item("q.rHB.D", mfexp(log_q_cpue_rHB_D));
	wrt_r_item("q.sCT", mfexp(log_q_cpue_sCT));
	wrt_r_item("q.sVD", mfexp(log_q_cpue_sVD));
	wrt_r_item("log.dm.cHL.lc",log_dm_lenc_cHL);
	wrt_r_item("log.dm.cHL.D.lc",log_dm_lenc_cHL_D);
	wrt_r_item("log.dm.rHB.D.lc",log_dm_lenc_rHB_D);
    wrt_r_item("log.dm.rGN.D.lc",log_dm_lenc_rGN_D);
	wrt_r_item("log.dm.cHL.ac",log_dm_agec_cHL);
	wrt_r_item("log.dm.rHB.ac",log_dm_agec_rHB);
	wrt_r_item("log.dm.sCT.ac",log_dm_agec_sCT);
	wrt_r_item("log.dm.rGN.ac",log_dm_agec_rGN);
...
open_r_df("parm.cons",1,8,2);
    ...
    wrt_r_df_col("selpar_A50_cHL3",selpar_A50_cHL3_out);
    wrt_r_df_col("selpar_slope_cHL3",selpar_slope_cHL3_out);
	
	wrt_r_df_col("selpar_A501_cHL2_D",selpar_A50_cHL2_D_out);
	wrt_r_df_col("selpar_slope1_cHL2_D",selpar_slope_cHL2_D_out);
	wrt_r_df_col("selpar_A502_cHL2_D",selpar_A502_cHL2_D_out);
	wrt_r_df_col("selpar_slope2_cHL2_D",selpar_slope2_cHL2_D_out);
	wrt_r_df_col("selpar_A50_cHL3_D",selpar_A50_cHL3_D_out);
	wrt_r_df_col("selpar_slope_cHL3_D",selpar_slope_cHL3_D_out);
	
    wrt_r_df_col("selpar_A50_rHB1",selpar_A50_rHB1_out);
    wrt_r_df_col("selpar_slope_rHB1",selpar_slope_rHB1_out);
    wrt_r_df_col("selpar_A502_rHB1",selpar_A502_rHB1_out);
	wrt_r_df_col("selpar_slope2_rHB1",selpar_slope2_rHB1_out);
	wrt_r_df_col("selpar_A501_rHB2",selpar_A50_rHB2_out);
    wrt_r_df_col("selpar_slope1_rHB2",selpar_slope_rHB2_out);
	wrt_r_df_col("selpar_A502_rHB2",selpar_A502_rHB2_out);
	wrt_r_df_col("selpar_slope2_rHB2",selpar_slope2_rHB2_out);
	wrt_r_df_col("selpar_A501_rHB3",selpar_A50_rHB3_out);
    wrt_r_df_col("selpar_slope1_rHB3",selpar_slope_rHB3_out);
	wrt_r_df_col("selpar_A502_rHB3",selpar_A502_rHB3_out);
	wrt_r_df_col("selpar_slope2_rHB3",selpar_slope2_rHB3_out);
	
	wrt_r_df_col("selpar_A501_rHB2_D",selpar_A50_rHB2_D_out);
	wrt_r_df_col("selpar_slope1_rHB2_D",selpar_slope_rHB2_D_out);
	wrt_r_df_col("selpar_A502_rHB2_D",selpar_A502_rHB2_D_out);
	wrt_r_df_col("selpar_slope2_rHB2_D",selpar_slope2_rHB2_D_out);
	wrt_r_df_col("selpar_A501_rHB3_D",selpar_A50_rHB3_D_out);
	wrt_r_df_col("selpar_slope1_rHB3_D",selpar_slope_rHB3_D_out);
	wrt_r_df_col("selpar_A502_rHB3_D",selpar_A502_rHB3_D_out);
	wrt_r_df_col("selpar_slope2_rHB3_D",selpar_slope2_rHB3_D_out);
	
    wrt_r_df_col("selpar_A501_rGN2",selpar_A50_rGN2_out);
    wrt_r_df_col("selpar_slope1_rGN2",selpar_slope_rGN2_out);
	wrt_r_df_col("selpar_A502_rGN2",selpar_A502_rGN2_out);
	wrt_r_df_col("selpar_slope2_rGN2",selpar_slope2_rGN2_out);

	wrt_r_df_col("selpar_A50_rGN3",selpar_A50_rGN3_out);
    wrt_r_df_col("selpar_slope_rGN3",selpar_slope_rGN3_out);
	
    wrt_r_df_col("selpar_A501_rGN3_D",selpar_A50_rGN3_D_out);
	wrt_r_df_col("selpar_slope1_rGN3_D",selpar_slope_rGN3_D_out);
	wrt_r_df_col("selpar_A502_rGN3_D",selpar_A502_rGN3_D_out);
	wrt_r_df_col("selpar_slope2_rGN3_D",selpar_slope2_rGN3_D_out);
	
	wrt_r_df_col("selpar_A50_sCT",selpar_A50_sCT_out);
    wrt_r_df_col("selpar_slope_sCT",selpar_slope_sCT_out);
	wrt_r_df_col("selpar_A502_sCT",selpar_A502_sCT_out);
    wrt_r_df_col("selpar_slope2_sCT",selpar_slope2_sCT_out);
    
	wrt_r_df_col("log_q_cpue_cHL",log_q_cHL_out);
    wrt_r_df_col("log_q_cpue_rHB",log_q_rHB_out);
    wrt_r_df_col("log_q_cpue_rHB.D",log_q_rHB_D_out);
	wrt_r_df_col("log_q_cpue_sCT",log_q_sCT_out);
	wrt_r_df_col("log_q_cpue_sVD",log_q_sVD_out);
	
    wrt_r_df_col("log.dm.cHL.lc",log_dm_cHL_lc_out);
    wrt_r_df_col("log.dm.cHL.D.lc",log_dm_cHL_D_lc_out);
    wrt_r_df_col("log.dm.rHB.D.lc",log_dm_rHB_D_lc_out);	
	wrt_r_df_col("log.dm.rGN.D.lc",log_dm_rGN_D_lc_out);	
	wrt_r_df_col("log.dm.cHL.ac",log_dm_cHL_ac_out);
	wrt_r_df_col("log.dm.rHB.ac",log_dm_rHB_ac_out);
	wrt_r_df_col("log.dm.sCT.ac",log_dm_sCT_ac_out);
    ...
    wrt_r_df_col("log_avg_F_L_rHB",log_avg_F_rHB_out);
    wrt_r_df_col("log_avg_F_L_rGN",log_avg_F_rGN_out);
    wrt_r_df_col("log_avg_F_D_cHL",log_avg_F_cHL_D_out);
    wrt_r_df_col("log_avg_F_D_rHB",log_avg_F_rHB_D_out);
...
open_r_vector("sdnr");
    ...
    wrt_r_item("sdnr.U.rHB.D", sdnr_I_rHB_D);
    ...
    wrt_r_item("sdnr.lc.rGN.D", sdnr_lc_rHB_D);
...
open_r_df("t.series", styr, (endyr+1), 2);
    ...
    wrt_r_df_col("U.rHB.D.ob", obs_cpue_rHB_D);
    wrt_r_df_col("U.rHB.D.pr", pred_rHB_D_cpue);
    wrt_r_df_col("cv.U.rHB.D", obs_cv_cpue_rHB_D/w_cpue_rHB_D);
	wrt_r_df_col("cv.unwgted.U.rHB.D", obs_cv_cpue_rHB_D);
	
	wrt_r_df_col("U.sCT.ob", obs_cpue_sCT);
    wrt_r_df_col("U.sCT.pr", pred_sCT_cpue);
	...
	// wrt_r_df_col("lcomp.cHL.D.neff", nsamp_cHL_D_lenc_allyr*w_lenc_cHL_D);
	...
	// wrt_r_df_col("acomp.sCT.neff", nsamp_sCT_agec_allyr*w_agec_sCT);
	// wrt_r_df_col("acomp.rGN.neff", nsamp_rGN_agec_allyr*w_agec_rGN);    
