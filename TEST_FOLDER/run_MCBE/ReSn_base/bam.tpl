...
init_int nyr_cHL_D_lenc_pool1;
init_ivector yrs_cHL_D_lenc_pool1(1,nyr_cHL_D_lenc_pool1);
//Annual sample size (ntrips) of length comp data; used to weight years for pooling
init_vector nsamp_cHL_D_lenc_pool1(1,nyr_cHL_D_lenc_pool1);

// Number and vector of years of length compositions to be pooled in second pooled comp (2010-2019)
init_int nyr_cHL_D_lenc_pool2;
init_ivector yrs_cHL_D_lenc_pool2(1,nyr_cHL_D_lenc_pool2);
//Annual sample sizes (ntrips) used to weight years for pooling
init_vector nsamp_cHL_D_lenc_pool2(1,nyr_cHL_D_lenc_pool2);
...
// rHB discards CPUE
init_int styr_D_cpue_rHB;                                             
init_int endyr_D_cpue_rHB;                                            
init_vector obs_cpue_rHB_D(styr_D_cpue_rHB,endyr_D_cpue_rHB);//Observed CPUE
init_vector obs_cv_cpue_rHB_D(styr_D_cpue_rHB,endyr_D_cpue_rHB); //CV of cpue
...
//----Predicted length and age compositions
  ...
  matrix pred_cHL_D_lenc_yr1(1,nyr_cHL_D_lenc_pool1,1,nlenbins); //annual predicted length comps, used for pooling first pooled comp
  matrix pred_cHL_D_lenc_yr2(1,nyr_cHL_D_lenc_pool2,1,nlenbins); //annual predicted length comps, used for pooling second pooled comp
...
//-------CPUE Predictions--------------------------------
  ...
  vector pred_rHB_D_cpue(styr_D_cpue_rHB,endyr_D_cpue_rHB);            //predicted rHB disc index (number fish per effort)
  matrix N_rHB_D(styr_D_cpue_rHB,endyr_D_cpue_rHB,1,nages);            //used to compute rHB disc index
...
//---Catchability (CPUE q's)----------------------------------------------------------
  ...
  vector q_rate_fcn_rHB_D(styr_D_cpue_rHB,endyr_D_cpue_rHB);         //increase due to technology creep (saturates in 2003) 
...
//Fishery dependent random walk catchability
 ...
 vector q_RW_log_dev_rHB_D(styr_D_cpue_rHB,endyr_D_cpue_rHB-1); 
...
//Fishery dependent catchability over time, may be constant
 ...
 vector q_rHB_D(styr_D_cpue_rHB,endyr_D_cpue_rHB); 
