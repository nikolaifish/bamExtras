//##  Author: NMFS, Miami, Sustainable Fisheries Division
//##  Analyst: Francesca Forrestal and Skyler Sagarese
//##  Species: Scamp Grouper
//##  Region: US South Atlantic
//##  SEDAR: 68
//##  Date: 2022-10-21 18:09:41


//##--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>
//##
//##  SEDAR 68  Scamp assessment model, Fall 2020
//##  NMFS, Beaufort Lab, Sustainable Fisheries Branch
//##
//##--><>--><>--><>--><>--><>--><>--><>--<>--><>--><>--><>--><>--><>
DATA_SECTION

!!cout << "Starting Beaufort Assesment Model" << endl;
!!cout << endl;
!!cout << "                BAM!" << endl;
!!cout << endl;
...
//###Video Index may not use TBD#################
//CPUE
//init_int styr_sVD_cpue;

//init_int endyr_sVD_cpue;

//init_vector obs_sVD_cpue(styr_sVD_cpue,endyr_sVD_cpue);

//init_vector sVD_cpue_cv(styr_sVD_cpue,endyr_sVD_cpue);    //CV of cpue


//################Commercial handline fleet #######################################
// Comm HL CPUE
init_int styr_cpue_cGN;

init_int endyr_cpue_cGN;

init_vector obs_cpue_cGN(styr_cpue_cGN,endyr_cpue_cGN);

init_vector obs_cv_cpue_cGN(styr_cpue_cGN,endyr_cpue_cGN);
...
init_int nyr_agec_cGN;
init_ivector yrs_agec_cGN(1,nyr_agec_cGN);
init_vector nsamp_agec_cGN(1,nyr_agec_cGN);
init_vector nfish_agec_cGN(1,nyr_agec_cGN);
init_matrix obs_agec_cGN(1,nyr_agec_cGN,1,nages_agec);
...
// von Bert parms in TL mm fishery post 1992
...
init_vector set_log_dm_lenc_cGN(1,7);    //Dirichlet-multinomial overdispersion parameter
init_vector set_log_dm_lenc_rGN(1,7);    //Dirichlet-multinomial overdispersion parameter
init_vector set_log_dm_lenc_sCT(1,7);   //Dirichlet-multinomial overdispersion parameter
init_vector set_log_dm_agec_cGN(1,7);    //Dirichlet-multinomial overdispersion parameter
...
//Commerical fleet
init_vector set_selpar_A50_cGN1(1,7);
init_vector set_selpar_slope_cGN1(1,7);
init_vector set_selpar_A50_cGN3(1,7);
init_vector set_selpar_slope_cGN3(1,7);


//Headboat/single rec fleet
...
//sVD
//init_vector set_selpar_A50_sVD(1,7);
//init_vector set_selpar_slope_sVD(1,7);
//init_vector set_selpar_A502_sVD(1,7);
//init_vector set_selpar_slope2_sVD(1,7);


//logit selectivity for discards
//init_vector set_selpar_age1logit_D(1,7);


//--index catchability-----------------------------------------------------------------------------------
init_vector set_log_q_cpue_cGN(1,7);      //catchability coefficient (log) for cGN handline index
init_vector set_log_q_cpue_rGN(1,7);      //catchability coefficient (log) for headboat index
init_vector set_log_q_cpue_sCT(1,7);     //catchability coefficient (log) for sCT  index
//init_vector set_log_q_sVD(1,7);     //catchability coefficient (log) for Video index


//--mean F's in log space --------------------------------
//init_vector set_F_init(1,7);  			// initial F (not log space)
init_vector set_log_avg_F_L_cGN(1,7);
init_vector set_log_avg_F_L_rGN(1,7);

//##################Dev Vector Parameter values (vals) and bounds #################################
//--F vectors---------------------------
init_vector set_log_dev_F_L_cGN(1,3);
...
init_number set_w_cpue_cGN;         //weight for cGN handline index
init_number set_w_cpue_rGN;         //weight for headboat index
init_number set_w_cpue_sCT;        //weight for sCT index
//init_number set_w_I_sVD;        //weight for Video index

init_number set_w_lenc_cGN;        //weight for cGN handline len comps
init_number set_w_lenc_rGN;        //weight for headboat len comps
init_number set_w_lenc_sCT;	      //weight for the chevron trap length comps

init_number set_w_agec_cGN;        //weight for cGN handline age comps
init_number set_w_agec_rGN;        //weight for headboat age comps
init_number set_w_agec_sCT;	       //weight for the chevron trap age comps
...
PARAMETER_SECTION
 ...
 LOCAL_CALCS
  ...
  const double log_dm_cGN_ac_LO=set_log_dm_agec_cGN(2); const double log_dm_cGN_ac_HI=set_log_dm_agec_cGN(3); const double log_dm_cGN_ac_PH=set_log_dm_agec_cGN(4);
  ...
  //const double selpar_A50_sVD_LO=set_selpar_A50_sVD(2); const double selpar_A50_sVD_HI=set_selpar_A50_sVD(3); const double selpar_A50_sVD_PH=set_selpar_A50_sVD(4);
  //const double selpar_slope_sVD_LO=set_selpar_slope_sVD(2); const double selpar_slope_sVD_HI=set_selpar_slope_sVD(3); const double selpar_slope_sVD_PH=set_selpar_slope_sVD(4);
  //const double selpar_A502_sVD_LO=set_selpar_A502_sVD(2); const double selpar_A502_sVD_HI=set_selpar_A502_sVD(3); const double selpar_A502_sVD_PH=set_selpar_A502_sVD(4);
  //const double selpar_slope2_sVD_LO=set_selpar_slope2_sVD(2); const double selpar_slope2_sVD_HI=set_selpar_slope2_sVD(3); const double selpar_slope2_sVD_PH=set_selpar_slope2_sVD(4);


  const double log_q_cGN_LO=set_log_q_cpue_cGN(2); const double log_q_cGN_HI=set_log_q_cpue_cGN(3); const double log_q_cGN_PH=set_log_q_cpue_cGN(4);
  ...
  //const double log_q_sVD_LO=set_log_q_sVD(2); const double log_q_sVD_HI=set_log_q_sVD(3); const double log_q_sVD_PH=set_log_q_sVD(4);
...
////--------------Growth---------------------------------------------------------------------------
  ...
  //Fishery post 1992 growth parms and conversions
  ...
  //Post 1992 Fishery-dependent
  vector len_sd_L(1,nages);
  vector len_cv_L(1,nages); //for fishgraph

//----Predicted length and age compositions
  matrix pred_cGN_lenc(1,nyr_lenc_cGN,1,nlenbins);
  matrix pred_rGN_lenc(1,nyr_lenc_rGN,1,nlenbins);
  matrix pred_sCT_lenc(1,nyr_lenc_sCT,1,nlenbins);

  matrix pred_cGN_agec(1,nyr_agec_cGN,1,nages_agec);
  matrix pred_cGN_agec_allages(1,nyr_agec_cGN,1,nages);
  matrix ErrorFree_cGN_agec(1,nyr_agec_cGN,1,nages);
...
//Sample size (perhaps adjusted herein) used in fitting comp data
  ...
  vector nsamp_cGN_agec_allyr(styr,endyr);
...
//Nfish used in MCB analysis (not used in fitting)
  ...
  vector nfish_cGN_agec_allyr(styr,endyr);
...
//Computed effective sample size for output (not used in fitting)
  ...
  vector neff_cGN_agec_allyr(styr,endyr);
...
//---Stock-Recruit Function (Beverton-Holt, steepness parameterization)----------
  ...
  init_bounded_number log_dm_agec_cGN(log_dm_cGN_ac_LO,log_dm_cGN_ac_HI,log_dm_cGN_ac_PH);
...
//Commercial handline-------------------------------------------------
  ...
  //Video index selectivity
  //matrix sel_sVD(styr,endyr,1,nages);
  //vector sel_sVD_vec(1,nages);

  //init_bounded_number selpar_A50_sVD(selpar_A50_sVD_LO,selpar_A50_sVD_HI,selpar_A50_sVD_PH);
  //init_bounded_number selpar_slope_sVD(selpar_slope_sVD_LO,selpar_slope_sVD_HI,selpar_slope_sVD_PH);
  //init_bounded_number selpar_A502_sVD(selpar_A502_sVD_LO,selpar_A502_sVD_HI,selpar_A502_sVD_PH);
  //init_bounded_number selpar_slope2_sVD(selpar_slope2_sVD_LO,selpar_slope2_sVD_HI,selpar_slope2_sVD_PH);

  //vector selpar_A50_sVD_out(1,8);
  //vector selpar_slope_sVD_out(1,8);
  //vector selpar_A502_sVD_out(1,8);
  //vector selpar_slope2_sVD_out(1,8);
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
//-------CPUE Predictions--------------------------------
  vector pred_cGN_cpue(styr_cpue_cGN,endyr_cpue_cGN);                   //predicted cGN index (weight fish per effort)
  matrix N_cGN(styr_cpue_cGN,endyr_cpue_cGN,1,nages);                   //used to compute cGN index
  ...
  //vector pred_sVD_cpue(styr_sVD_cpue,endyr_sVD_cpue);                //predicted SERFS index (number fish per effort)
  //matrix N_sVD(styr_sVD_cpue,endyr_sVD_cpue,1,nages);                //used to compute SERFS index

//---Catchability (CPUE q's)----------------------------------------------------------
  init_bounded_number log_q_cpue_cGN(log_q_cGN_LO,log_q_cGN_HI,log_q_cGN_PH);
  ...
  //init_bounded_number log_q_sVD(log_q_sVD_LO,log_q_sVD_HI,log_q_sVD_PH);
  ...
  number q_rate;
  vector q_rate_fcn_cGN(styr_cpue_cGN,endyr_cpue_cGN);         //increase due to technology creep (saturates in 2003)
...
//Fishery dependent random walk catchability
 init_bounded_vector q_RW_log_dev_cGN(styr_cpue_cGN,endyr_cpue_cGN-1,log_RWq_LO,log_RWq_HI,log_RWq_PH);
...
//does this section need to be updated??
  ...
  {
    for (iyear=styr_cpue_cGN; iyear<=endyr_cpue_cGN; iyear++)
      {   if (iyear>styr_cpue_cGN & iyear <=2003)
          {//q_rate_fcn_cGN(iyear)=(1.0+q_rate)*q_rate_fcn_cGN(iyear-1); //compound
             q_rate_fcn_cGN(iyear)=(1.0+(iyear-styr_cpue_cGN)*q_rate)*q_rate_fcn_cGN(styr_cpue_cGN);  //linear
          }
          if (iyear>2003) {q_rate_fcn_cGN(iyear)=q_rate_fcn_cGN(iyear-1);}
      }
  ...
  //selpar_A50_sVD=set_selpar_A50_sVD(1);
  //selpar_slope_sVD=set_selpar_slope_sVD(1);
  //selpar_A502_sVD=set_selpar_A502_sVD(1);
  //selpar_slope2_sVD=set_selpar_slope2_sVD(1);
...
//Used primarily for output in R object
    ...
    nfish_rGN_agec_allyr=missing;
	  ...
	  for (iyear=1; iyear<=nyr_agec_cGN; iyear++)
         {if (nsamp_agec_cGN(iyear)>=minSS_agec_cGN)
           {nsamp_cGN_agec_allyr(yrs_agec_cGN(iyear))=nsamp_agec_cGN(iyear);
            nfish_cGN_agec_allyr(yrs_agec_cGN(iyear))=nfish_agec_cGN(iyear);}}
...
FUNCTION get_length_weight_at_age
    ...
    meanlen_TL=Linf*(1.0-mfexp(-K*(agebins-t0+0.5)));     //Landings total length in mm
    ...
    wgt_lb_L=mt2lb*wgt_mt_L;                                  //lb of whole wgt
...
FUNCTION get_weight_at_age_landings  ///***in whole weight
  ...
  for (iyear=styr; iyear<=endyr_selex_phase1; iyear++) //start through 1991
  {
    len_cGN_mm(iyear)=meanlen_TL;
    wholewgt_cGN_klb(iyear)=wgt_klb;
    len_rGN_mm(iyear)=meanlen_TL;
    wholewgt_rGN_klb(iyear)=wgt_klb;


  }
  for (iyear=endyr_selex_phase1+1; iyear<=endyr; iyear++)  //1992 through end
  {
...
FUNCTION get_selectivity
  ...
  sel_cGN_block1=logistic(agebins, selpar_A50_cGN1, selpar_slope_cGN1);
  sel_cGN_block3=logistic(agebins, selpar_A50_cGN3, selpar_slope_cGN3);
  ...
  sel_sCT_vec=logistic(agebins, selpar_A50_sCT, selpar_slope_sCT);
  ...
  //sel_D_block3(1)=0; sel_D_block3(2)=0; sel_D_block3(3)=selpar_age1_D; sel_D_block3(4)=1; sel_D_block3(5,nages)=prob_belowsizelim_block3(5,nages);
  //sel_D_block1=sel_D_block3;

  //BLOCK 1 for selex. No size limit
  for (iyear=styr; iyear<=endyr_selex_phase1; iyear++)
   {
    sel_cGN(iyear)=sel_cGN_block1;
...
FUNCTION get_mortality
  ...
  for (iyear=styr; iyear<=endyr; iyear++)
  {
    ...
    if(iyear>=styr_L_rGN & iyear<=endyr_L_rGN) //spans full time series
...
// F at equilibrium
  F_initial=sel_cGN(styr)*mfexp(log_avg_F_L_cGN+log_F_dev_init_cGN)+
...
FUNCTION get_landings_wgt
  for (iyear=styr; iyear<=endyr; iyear++)
  {
    L_cGN_klb(iyear)=elem_prod(L_cGN_num(iyear),wholewgt_cGN_klb(iyear));     //in 1000 lb whole weight     //in 1000 lb whole weight
...
//---Predicted CPUEs------------------------
 ...
 //cGN  cpue
  q_cGN(styr_cpue_cGN)=mfexp(log_q_cpue_cGN);
  for (iyear=styr_cpue_cGN; iyear<=endyr_cpue_cGN; iyear++)
  {//index in weight units. original index in lb and re-scaled. predicted in klb whole weight, but difference in lb and klb is absorbed by q
      N_cGN(iyear)=elem_prod(elem_prod(N_mdyr(iyear),sel_cGN(iyear)),wholewgt_cGN_klb(iyear));
      pred_cGN_cpue(iyear)=q_cGN(iyear)*q_rate_fcn_cGN(iyear)*q_DD_fcn(iyear)*sum(N_cGN(iyear));
      if (iyear<endyr_cpue_cGN){q_cGN(iyear+1)=q_cGN(iyear)*mfexp(q_RW_log_dev_cGN(iyear));}
  }
 ...
 //SEFIS sCT cpue
  ...
  //Video cpue
   //q_sVD(styr_sVD_cpue)=mfexp(log_q_sVD);
   //for (iyear=styr_sVD_cpue; iyear<=endyr_sVD_cpue; iyear++)
   //{
     //N_sVD(iyear)=elem_prod(N_mdyr(iyear),sel_sVD(iyear));
 	//pred_sVD_cpue(iyear)=q_sVD(iyear)*q_DD_fcn(iyear)*sum(N_sVD(iyear));
     //if (iyear<endyr_sVD_cpue){q_sVD(iyear+1)=q_sVD(iyear)*mfexp(q_RW_log_dev_sVD(iyear));}
   //}
...
FUNCTION get_length_comps
  ...
  //cGN
  for (iyear=1;iyear<=nyr_lenc_cGN;iyear++)
  {pred_cGN_lenc(iyear)=(L_cGN_num(yrs_lenc_cGN(iyear))*lenprob_cGN)/sum(L_cGN_num(yrs_lenc_cGN(iyear)));}
...
FUNCTION get_age_comps
  ...
  for (iyear=1;iyear<=nyr_agec_cGN;iyear++)
  {
    ErrorFree_cGN_agec(iyear)=L_cGN_num(yrs_agec_cGN(iyear))/sum(L_cGN_num(yrs_agec_cGN(iyear)));
    pred_cGN_agec_allages(iyear)=age_error*(ErrorFree_cGN_agec(iyear)/sum(ErrorFree_cGN_agec(iyear)));
    for (iage=1; iage<=nages_agec; iage++) {pred_cGN_agec(iyear,iage)=pred_cGN_agec_allages(iyear,iage);}
    //for (iage=(nages_agec+1); iage<=nages; iage++) {pred_cGN_agec(iyear,nages_agec)+=pred_cGN_agec_allages(iyear,iage);} //plus group
  }
 ...
 for (iyear=1;iyear<=nyr_agec_rGN;iyear++)
  {
    ...
    //for (iage=(nages_agec+1); iage<=nages; iage++) {pred_rGN_agec(iyear,nages_agec_rGN)+=pred_rGN_agec_allages(iyear,iage);} //plus group
  }
...
FUNCTION get_weighted_current
  ...
  wgt_wgted_L_denom=F_cGN_prop+F_rGN_prop;
...
//switch here if var_rec_dev <=dzero
  ...
  for(iyear=styr; iyear<=endyr; iyear++)
  {
        L_total_klb_yr(iyear)=pred_cGN_L_klb(iyear)+pred_rGN_L_klb(iyear);
        L_total_knum_yr(iyear)=pred_cGN_L_knum(iyear)+pred_rGN_L_knum(iyear);
  ...
  L_total_num=(L_cGN_num+L_rGN_num);          //discards at age in number fish
  L_total_klb=L_cGN_klb+L_rGN_klb;            //discards at age in klb whole weight
...
//---Indices-------------------------------
  ...
  f_cGN_cpue=0.0;
  f_cGN_cpue=lk_lognormal(pred_cGN_cpue, obs_cpue_cGN, obs_cv_cpue_cGN, w_cpue_cGN);
  fval+=f_cGN_cpue;
  fval_data+=f_cGN_cpue;
  ...
  //f_sVD_cpue=0.0;
  //f_sVD_cpue=lk_lognormal(pred_sVD_cpue, obs_sVD_cpue, sVD_cpue_cv, w_I_sVD);
  //fval+=f_sVD_cpue;
...
//---Age comps-------------------------------
  ...
  //f_cGN_agec
  //f_cGN_agec=lk_robust_multinomial(nsamp_agec_cGN, pred_cGN_agec, obs_agec_cGN, nyr_agec_cGN, double(nages_agec), minSS_agec_cGN, w_agec_cGN);
  //f_cGN_agec=lk_logistic_normal(nsamp_agec_cGN, pred_cGN_agec, obs_agec_cGN, nyr_agec_cGN, double(nages_agec), minSS_agec_cGN);
  f_cGN_agec=lk_dirichlet_multinomial(nsamp_agec_cGN, pred_cGN_agec, obs_agec_cGN, nyr_agec_cGN, double(nages_agec), minSS_agec_cGN, log_dm_agec_cGN);
  fval+=f_cGN_agec;
  fval_data+=f_cGN_agec;
...
//-----------Constraints and penalties--------------------------------
  ...
  f_rec_dev=0.0;
  //rec_sigma_sq=square(rec_sigma);
  rec_logL_add=nyrs_rec*log(rec_sigma_sq)/2.0;
  ...
  f_rec_dev=(square(log_dev_rec(styr_rec_dev) )/(2.0*rec_sigma_sq));
  for(iyear=(styr_rec_dev+1); iyear<=endyr_rec_dev; iyear++)
  {f_rec_dev+=(square(log_dev_rec(iyear)-R_autocorr*log_dev_rec(iyear-1) )/
               (2.0*rec_sigma_sq));}
...
//pdf type 1=none, 2=lognormal, 3=normal, 4=beta
  ...
  //f_priors+=neg_log_prior(selpar_A50_sVD,set_selpar_A50_sVD(5), set_selpar_A50_sVD(6), set_selpar_A50_sVD(7));
  //f_priors+=neg_log_prior(selpar_slope_sVD,set_selpar_slope_sVD(5), set_selpar_slope_sVD(6), set_selpar_slope_sVD(7));
  //f_priors+=neg_log_prior(selpar_A502_sVD,set_selpar_A502_sVD(5), set_selpar_A502_sVD(6), set_selpar_A502_sVD(7));
  //f_priors+=neg_log_prior(selpar_slope2_sVD,set_selpar_slope2_sVD(5), set_selpar_slope2_sVD(6), set_selpar_slope2_sVD(7));

  f_priors+=neg_log_prior(log_q_cpue_cGN,set_log_q_cpue_cGN(5),set_log_q_cpue_cGN(6),set_log_q_cpue_cGN(7));
  ...
  //f_priors+=neg_log_prior(log_q_sVD,set_log_q_sVD(5),set_log_q_sVD(6),set_log_q_sVD(7));
  ...
  f_priors+=neg_log_prior(log_dm_agec_cGN,set_log_dm_agec_cGN(5),set_log_dm_agec_cGN(6),set_log_dm_agec_cGN(7));
...
REPORT_SECTION
  ...
  if (last_phase())
  {
      ...
      sdnr_lc_cGN=sdnr_multinomial(nyr_lenc_cGN, lenbins, nsamp_lenc_cGN, pred_cGN_lenc, obs_lenc_cGN, w_lenc_cGN);
      ...
      sdnr_ac_cGN=sdnr_multinomial(nyr_agec_cGN, agebins_agec, nsamp_agec_cGN, pred_cGN_agec, obs_agec_cGN, w_agec_cGN);
      ...
      sdnr_I_cGN=sdnr_lognormal(pred_cGN_cpue, obs_cpue_cGN, obs_cv_cpue_cGN, w_cpue_cGN);
      ...
      //sdnr_I_sVD=sdnr_lognormal(pred_sVD_cpue, obs_sVD_cpue, sVD_cpue_cv, w_I_sVD);
     ...
     log_dm_sCT_lc_out(8)=log_dm_lenc_sCT; log_dm_sCT_lc_out(1,7)=set_log_dm_lenc_sCT;
	   log_dm_cGN_ac_out(8)=log_dm_agec_cGN; log_dm_cGN_ac_out(1,7)=set_log_dm_agec_cGN;
       ...
       selpar_A50_cGN3_out(8)=selpar_A50_cGN3; selpar_A50_cGN3_out(1,7)=set_selpar_A50_cGN3;
       selpar_slope_cGN3_out(8)=selpar_slope_cGN3; selpar_slope_cGN3_out(1,7)=set_selpar_slope_cGN3;
       ...
       //selpar_A50_sVD_out(8)=selpar_A50_sVD; selpar_A50_sVD_out(1,7)=set_selpar_A50_sVD;
       //selpar_slope_sVD_out(8)=selpar_slope_sVD; selpar_slope_sVD_out(1,7)=set_selpar_slope_sVD;
       //selpar_A502_sVD_out(8)=selpar_A502_sVD; selpar_A502_sVD_out(1,7)=set_selpar_A502_sVD;
       //selpar_slope2_sVD_out(8)=selpar_slope2_sVD; selpar_slope2_sVD_out(1,7)=set_selpar_slope2_sVD;


       log_q_cGN_out(8)=log_q_cpue_cGN; log_q_cGN_out(1,7)=set_log_q_cpue_cGN;
       ...
       //log_q_sVD_out(8)=log_q_sVD; log_q_sVD_out(1,7)=set_log_q_sVD;
