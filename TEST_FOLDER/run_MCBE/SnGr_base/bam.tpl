...
//CPUE: MMvll
init_int styr_cpue_sVL;                                             
init_int endyr_cpue_sVL;                                            
init_vector obs_cpue_sVL(styr_cpue_sVL,endyr_cpue_sVL);//Observed CPUE
init_vector obs_cv_cpue_sVL(styr_cpue_sVL,endyr_cpue_sVL); //CV of cpue
// MMvll Age Compositions
init_int nyr_agec_sVL;
init_ivector yrs_agec_sVL(1,nyr_agec_sVL);
init_vector nsamp_agec_sVL(1,nyr_agec_sVL);
init_vector nfish_agec_sVL(1,nyr_agec_sVL);
init_matrix obs_agec_sVL(1,nyr_agec_sVL,1,nages_agec);

//################Commercial handline fleet #######################################
// Comm HL CPUE
// init_int styr_cHL_cpue;                                             
// init_int endyr_cHL_cpue;                                            
// init_vector obs_cHL_cpue(styr_cHL_cpue,endyr_cHL_cpue); //Observed CPUE
// init_vector cHL_cpue_cv(styr_cHL_cpue,endyr_cHL_cpue);  //CV of cpue
...
// init_int styr_cHL_D;
// init_int endyr_cHL_D;
// init_vector obs_cHL_released(styr_cHL_D,endyr_cHL_D);
// init_vector cHL_D_cv(styr_cHL_D,endyr_cHL_D);
...
init_int nyr_lenc_cLL;
init_ivector yrs_lenc_cLL(1,nyr_lenc_cLL);
init_vector nsamp_lenc_cLL(1,nyr_lenc_cLL);
init_vector nfish_lenc_cLL(1,nyr_lenc_cLL);
init_matrix obs_lenc_cLL(1,nyr_lenc_cLL,1,nlenbins);

// Comm cLL age compositions
// Uncomment for pooled age comps##						  
//init_int nyr_cLL_agec_pool;
//init_ivector yrs_cLL_agec_pool(1,nyr_cLL_agec_pool);
//# Annual sample size (nfish) of age comp data; used to weight years for pooling
//init_vector nfish_cLL_agec_pool(1,nyr_cLL_agec_pool);
//## cLL ## Number and vector of years of age compositions, after pooling												  
init_int nyr_agec_cLL;
init_ivector yrs_agec_cLL(1,nyr_agec_cLL);
//## cLL ## Sample size of age comp data (first row observed n.trips, second row n.fish)																					   
init_vector nsamp_agec_cLL(1,nyr_agec_cLL);
init_vector nfish_agec_cLL(1,nyr_agec_cLL);
//## cLL ## Observed age comps (proportions by year)												   
...
//  Discards (1000 fish)
// init_int styr_rGN_D;
// init_int endyr_rGN_D;
// init_vector obs_rGN_released(styr_rGN_D,endyr_rGN_D);
// init_vector rGN_D_cv(styr_rGN_D,endyr_rGN_D);
...
init_vector set_log_dm_lenc_cLL(1,7);    //Dirichlet-multinomial overdispersion parameter
...
//init_vector set_log_dm_rHB_D_lc(1,7);  //Dirichlet-multinomial overdispersion parameter
...
//init_vector set_log_dm_rHB_ac(1,7);    //Dirichlet-multinomial overdispersion parameter
...
init_vector set_log_dm_agec_sVL(1,7);   //Dirichlet-multinomial overdispersion parameter
...
init_vector set_selpar_A50_cLL1(1,7);
init_vector set_selpar_slope_cLL1(1,7);
// init_vector set_selpar_A50_cLL2(1,7);
// init_vector set_selpar_A50_cLL3(1,7);
// init_vector set_selpar_slope_cLL2(1,7);
// init_vector set_selpar_A502_cLL2(1,7); 
// init_vector set_selpar_slope2_cLL2(1,7);
...
init_vector set_selpar_afull_rGN1(1,7);
init_vector set_selpar_sigma_rGN1(1,7);
init_vector set_selpar_A50_rGN2(1,7);
init_vector set_selpar_slope_rGN2(1,7);
init_vector set_selpar_afull_rGN2(1,7);
init_vector set_selpar_sigma_rGN2(1,7);
init_vector set_selpar_A50_rGN3(1,7);
init_vector set_selpar_slope_rGN3(1,7);
init_vector set_selpar_afull_rGN3(1,7);
init_vector set_selpar_sigma_rGN3(1,7);
// init_vector set_selpar_A50_rGN1(1,7);
// init_vector set_selpar_slope_rGN1(1,7);
// init_vector set_selpar_A50_rGN2(1,7);
// init_vector set_selpar_slope_rGN2(1,7);
...
init_vector set_selpar_afull_sCT(1,7);
init_vector set_selpar_sigma_sCT(1,7);
// init_vector set_selpar_A50_sCT(1,7); 
// init_vector set_selpar_slope_sCT(1,7);
// init_vector set_selpar_A502_sCT(1,7); 
// init_vector set_selpar_slope2_sCT(1,7);

init_vector set_selpar_A50_sVL(1,7); 
init_vector set_selpar_slope_sVL(1,7);

init_vector set_selpar_age1logit_D(1,7);


//--index catchability-----------------------------------------------------------------------------------
//init_vector set_log_q_cHL(1,7);      //catchability coefficient (log) for cGN handline index
//init_vector set_log_q_rHB(1,7);      //catchability coefficient (log) for headboat index
init_vector set_log_q_cpue_rGN(1,7);      //catchability coefficient (log) for rGN index
init_vector set_log_q_cpue_sCT(1,7);     //catchability coefficient (log) for FI trap index  
init_vector set_log_q_cpue_sVL(1,7);     //catchability coefficient (log) for FI sVL index  
...
//init_vector set_log_avg_F_rHB(1,7);
init_vector set_log_avg_F_L_rGN(1,7);
//init_vector set_log_avg_F_cHL_D(1,7);
//init_vector set_log_avg_F_rHB_D(1,7);
//init_vector set_log_avg_F_rGN_D(1,7);

//##################Dev Vector Parameter values (vals) and bounds #################################
//--F vectors---------------------------
init_vector set_log_dev_F_L_cHL(1,3); 
init_vector set_log_dev_F_L_cLL(1,3); 
//init_vector set_log_F_dev_rHB(1,3);
init_vector set_log_dev_F_L_rGN(1,3);
//init_vector set_log_F_dev_cHL_D(1,3); 
//init_vector set_log_F_dev_rHB_D(1,3);
//init_vector set_log_F_dev_rGN_D(1,3);
...
init_vector set_log_dev_vals_F_L__cLL(styr_L_cLL,endyr_L_cLL);
//init_vector set_log_F_dev_rHB_vals(styr_rHB_L,endyr_rHB_L);
init_vector set_log_dev_vals_F_L__rGN(styr_L_rGN,endyr_L_rGN);
//init_vector set_log_F_dev_cHL_D_vals(styr_cHL_D,endyr_cHL_D);
//init_vector set_log_F_dev_rHB_D_vals(styr_rHB_D,endyr_rHB_D);
//init_vector set_log_F_dev_rGN_D_vals(styr_rGN_D,endyr_rGN_D);
...
//init_number set_w_I_cHL;         //weight for cGN handline index
//init_number set_w_I_rHB;       //weight for headboat index
init_number set_w_cpue_rGN;         //weight for rGN index
init_number set_w_cpue_sCT;        //weight for sCT index
init_number set_w_cpue_sVL;        //weight for sVL index

init_number set_w_lenc_cHL;        //weight for cGN handline len comps
init_number set_w_lenc_cLL;        //weight for cGN longline len comps
...
//init_number set_w_lc_rHB_D;		//weight for the headboat discard length comps   
...
//init_number set_w_ac_rHB;        //weight for headboat age comps
init_number set_w_agec_rGN;		//weight for the Recreational age comps  
init_number set_w_agec_sCT;		//weight for the FI trap age comps 
init_number set_w_agec_sVL;		//weight for the FI sVL age comps 
...
init_number minSS_lenc_cLL;
//init_number minSS_rHB_lenc;
//init_number minSS_rHB_D_lenc;
...
//init_number minSS_rHB_agec;
init_number minSS_agec_rGN;
init_number minSS_agec_sCT;
init_number minSS_agec_sVL;
...
PARAMETER_SECTION
 ...
 LOCAL_CALCS
  ...
  const double log_dm_cLL_lc_LO=set_log_dm_lenc_cLL(2); const double log_dm_cLL_lc_HI=set_log_dm_lenc_cLL(3); const double log_dm_cLL_lc_PH=set_log_dm_lenc_cLL(4);
  ...
  //const double log_dm_rHB_D_lc_LO=set_log_dm_rHB_D_lc(2); const double log_dm_rHB_D_lc_HI=set_log_dm_rHB_D_lc(3); const double log_dm_rHB_D_lc_PH=set_log_dm_rHB_D_lc(4);
  //const double log_dm_sCT_lc_LO=set_log_dm_sCT_lc(2); const double log_dm_sCT_lc_HI=set_log_dm_sCT_lc(3); const double log_dm_sCT_lc_PH=set_log_dm_sCT_lc(4);
  ...
  const double log_dm_cLL_ac_LO=set_log_dm_agec_cLL(2); const double log_dm_cLL_ac_HI=set_log_dm_agec_cLL(3); const double log_dm_cLL_ac_PH=set_log_dm_agec_cLL(4);
  ...
  const double log_dm_sVL_ac_LO=set_log_dm_agec_sVL(2); const double log_dm_sVL_ac_HI=set_log_dm_agec_sVL(3); const double log_dm_sVL_ac_PH=set_log_dm_agec_sVL(4);
  ...
  const double selpar_A50_cLL1_LO=set_selpar_A50_cLL1(2); const double selpar_A50_cLL1_HI=set_selpar_A50_cLL1(3); const double selpar_A50_cLL1_PH=set_selpar_A50_cLL1(4);
  const double selpar_slope_cLL1_LO=set_selpar_slope_cLL1(2); const double selpar_slope_cLL1_HI=set_selpar_slope_cLL1(3); const double selpar_slope_cLL1_PH=set_selpar_slope_cLL1(4);
  // const double selpar_A50_cLL2_LO=set_selpar_A50_cLL2(2); const double selpar_A50_cLL2_HI=set_selpar_A50_cLL2(3); const double selpar_A50_cLL2_PH=set_selpar_A50_cLL2(4);
  // const double selpar_A50_cLL3_LO=set_selpar_A50_cLL3(2); const double selpar_A50_cLL3_HI=set_selpar_A50_cLL3(3); const double selpar_A50_cLL3_PH=set_selpar_A50_cLL3(4);
  ...
  // const double selpar_A502_cLL2_LO=set_selpar_A502_cLL2(2); const double selpar_A502_cLL2_HI=set_selpar_A502_cLL2(3); const double selpar_A502_cLL2_PH=set_selpar_A502_cLL2(4);
  // const double selpar_slope2_cLL2_LO=set_selpar_slope2_cLL2(2); const double selpar_slope2_cLL2_HI=set_selpar_slope2_cLL2(3); const double selpar_slope2_cLL2_PH=set_selpar_slope2_cLL2(4);
  ...
  const double selpar_afull_rGN1_LO=set_selpar_afull_rGN1(2); const double selpar_afull_rGN1_HI=set_selpar_afull_rGN1(3); const double selpar_afull_rGN1_PH=set_selpar_afull_rGN1(4);
  const double selpar_sigma_rGN1_LO=set_selpar_sigma_rGN1(2); const double selpar_sigma_rGN1_HI=set_selpar_sigma_rGN1(3); const double selpar_sigma_rGN1_PH=set_selpar_sigma_rGN1(4);
  ...
  const double selpar_afull_rGN2_LO=set_selpar_afull_rGN2(2); const double selpar_afull_rGN2_HI=set_selpar_afull_rGN2(3); const double selpar_afull_rGN2_PH=set_selpar_afull_rGN2(4);
  const double selpar_sigma_rGN2_LO=set_selpar_sigma_rGN2(2); const double selpar_sigma_rGN2_HI=set_selpar_sigma_rGN2(3); const double selpar_sigma_rGN2_PH=set_selpar_sigma_rGN2(4);
  ...
  const double selpar_afull_rGN3_LO=set_selpar_afull_rGN3(2); const double selpar_afull_rGN3_HI=set_selpar_afull_rGN3(3); const double selpar_afull_rGN3_PH=set_selpar_afull_rGN3(4);
  const double selpar_sigma_rGN3_LO=set_selpar_sigma_rGN3(2); const double selpar_sigma_rGN3_HI=set_selpar_sigma_rGN3(3); const double selpar_sigma_rGN3_PH=set_selpar_sigma_rGN3(4);
  ...
  const double selpar_afull_sCT_LO=set_selpar_afull_sCT(2); const double selpar_afull_sCT_HI=set_selpar_afull_sCT(3); const double selpar_afull_sCT_PH=set_selpar_afull_sCT(4);
  const double selpar_sigma_sCT_LO=set_selpar_sigma_sCT(2); const double selpar_sigma_sCT_HI=set_selpar_sigma_sCT(3); const double selpar_sigma_sCT_PH=set_selpar_sigma_sCT(4);
  
  const double selpar_A50_sVL_LO=set_selpar_A50_sVL(2); const double selpar_A50_sVL_HI=set_selpar_A50_sVL(3); const double selpar_A50_sVL_PH=set_selpar_A50_sVL(4);
  const double selpar_slope_sVL_LO=set_selpar_slope_sVL(2); const double selpar_slope_sVL_HI=set_selpar_slope_sVL(3); const double selpar_slope_sVL_PH=set_selpar_slope_sVL(4);
  ...
  //const double log_q_rHB_LO=set_log_q_rHB(2); const double log_q_rHB_HI=set_log_q_rHB(3); const double log_q_rHB_PH=set_log_q_rHB(4);
  ...
  const double log_q_sVL_LO=set_log_q_cpue_sVL(2); const double log_q_sVL_HI=set_log_q_cpue_sVL(3); const double log_q_sVL_PH=set_log_q_cpue_sVL(4);
  ...
  const double log_avg_F_cLL_LO=set_log_avg_F_L_cLL(2); const double log_avg_F_cLL_HI=set_log_avg_F_L_cLL(3); const double log_avg_F_cLL_PH=set_log_avg_F_L_cLL(4);
  ...
  //const double log_avg_F_cHL_D_LO=set_log_avg_F_cHL_D(2); const double log_avg_F_cHL_D_HI=set_log_avg_F_cHL_D(3); const double log_avg_F_cHL_D_PH=set_log_avg_F_cHL_D(4);
  ...
  //const double log_avg_F_rGN_D_LO=set_log_avg_F_rGN_D(2); const double log_avg_F_rGN_D_HI=set_log_avg_F_rGN_D(3); const double log_avg_F_rGN_D_PH=set_log_avg_F_rGN_D(4); 
  ...
  const double log_F_dev_cLL_LO=set_log_dev_F_L_cLL(1); const double log_F_dev_cLL_HI=set_log_dev_F_L_cLL(2); const double log_F_dev_cLL_PH=set_log_dev_F_L_cLL(3);   
  ...
  //const double log_F_dev_cHL_D_LO=set_log_F_dev_cHL_D(1); const double log_F_dev_cHL_D_HI=set_log_F_dev_cHL_D(2); const double log_F_dev_cHL_D_PH=set_log_F_dev_cHL_D(3);   
  ...
  //const double log_F_dev_rGN_D_LO=set_log_F_dev_rGN_D(1); const double log_F_dev_rGN_D_HI=set_log_F_dev_rGN_D(2); const double log_F_dev_rGN_D_PH=set_log_F_dev_rGN_D(3);   
...
////--------------Growth--------------------------------------------------------------------------- 
  ...
  matrix lenprob_sVL(1,nages,1,nlenbins);    //distn of size at age in sVL
...
//----Predicted length and age compositions
  ...
  matrix pred_cLL_lenc(1,nyr_lenc_cLL,1,nlenbins);
  // matrix pred_rHB_lenc(1,nyr_rHB_lenc,1,nlenbins);  
  // matrix pred_rHB_D_lenc(1,nyr_rHB_D_lenc,1,nlenbins);  
  ...
  matrix pred_cLL_agec(1,nyr_agec_cLL,1,nages_agec);
  matrix pred_cLL_agec_allages(1,nyr_agec_cLL,1,nages);
  //uncomment 2 lines below for pooled comps
//matrix pred_cLL_agec_allages_yr(1,nyr_cLL_agec_pool,1,nages);		//matrix ErrorFree_cLL_agec_yr(1,nyr_cLL_agec_pool,1,nages);														
  matrix ErrorFree_cLL_agec(1,nyr_agec_cLL,1,nages);      
...
//matrix ErrorFree_rHB_agec(1,nyr_rHB_agec,1,nages);
  ...
  matrix pred_sVL_agec(1,nyr_agec_sVL,1,nages_agec);  
  matrix pred_sVL_agec_allages(1,nyr_agec_sVL,1,nages);  
  matrix ErrorFree_sVL_agec(1,nyr_agec_sVL,1,nages);  
...
//vector nsamp_rHB_agec_allyr(styr,endyr);
  ...
  vector nsamp_sVL_agec_allyr(styr,endyr); 
...
//vector nfish_rHB_agec_allyr(styr,endyr);
  ...
  vector nfish_sVL_agec_allyr(styr,endyr); 
...
//---Stock-Recruit Function (Beverton-Holt, steepness parameterization)----------
  ...
  init_bounded_number log_dm_lenc_cLL(log_dm_cLL_lc_LO,log_dm_cLL_lc_HI,log_dm_cLL_lc_PH);
  ...
  //init_bounded_number log_dm_rHB_D_lc(log_dm_rHB_D_lc_LO,log_dm_rHB_D_lc_HI,log_dm_rHB_D_lc_PH);
  ...
  init_bounded_number log_dm_agec_cLL(log_dm_cLL_ac_LO,log_dm_cLL_ac_HI,log_dm_cLL_ac_PH);
  ...
  init_bounded_number log_dm_agec_sVL(log_dm_sVL_ac_LO,log_dm_sVL_ac_HI,log_dm_sVL_ac_PH);
...
//Commercial handline-------------------------------------------------
  ...
  vector sel_cLL_block1(1,nages);
  vector sel_cLL_block2(1,nages);
  vector sel_cLL_block3(1,nages);
  vector sel_cLL_vec(1,nages);

  init_bounded_number selpar_A50_cLL1(selpar_A50_cLL1_LO,selpar_A50_cLL1_HI,selpar_A50_cLL1_PH);
  init_bounded_number selpar_slope_cLL1(selpar_slope_cLL1_LO,selpar_slope_cLL1_HI,selpar_slope_cLL1_PH);
  // init_bounded_number selpar_A50_cLL2(selpar_A50_cLL2_LO,selpar_A50_cLL2_HI,selpar_A50_cLL2_PH);
  // init_bounded_number selpar_A50_cLL3(selpar_A50_cLL3_LO,selpar_A50_cLL3_HI,selpar_A50_cLL3_PH);
  // init_bounded_number selpar_slope_cLL2(selpar_slope_cLL2_LO,selpar_slope_cLL2_HI,selpar_slope_cLL2_PH);
  // init_bounded_number selpar_A502_cLL2(selpar_A502_cLL2_LO,selpar_A502_cLL2_HI,selpar_A502_cLL2_PH);
  // init_bounded_number selpar_slope2_cLL2(selpar_slope2_cLL2_LO,selpar_slope2_cLL2_HI,selpar_slope2_cLL2_PH);
  
  vector selpar_A50_cLL1_out(1,8);
  vector selpar_slope_cLL1_out(1,8);
  // vector selpar_A50_cLL2_out(1,8);
  // vector selpar_A50_cLL3_out(1,8);
  // vector selpar_slope_cLL2_out(1,8);
  // vector selpar_A502_cLL2_out(1,8);
  // vector selpar_slope2_cLL2_out(1,8);
  ...
  init_bounded_number selpar_afull_rGN1(selpar_afull_rGN1_LO,selpar_afull_rGN1_HI,selpar_afull_rGN1_PH);
  init_bounded_number selpar_sigma_rGN1(selpar_sigma_rGN1_LO,selpar_sigma_rGN1_HI,selpar_sigma_rGN1_PH);
  ...
  init_bounded_number selpar_afull_rGN2(selpar_afull_rGN2_LO,selpar_afull_rGN2_HI,selpar_afull_rGN2_PH);
  init_bounded_number selpar_sigma_rGN2(selpar_sigma_rGN2_LO,selpar_sigma_rGN2_HI,selpar_sigma_rGN2_PH); 
  ...
  init_bounded_number selpar_afull_rGN3(selpar_afull_rGN3_LO,selpar_afull_rGN3_HI,selpar_afull_rGN3_PH);
  init_bounded_number selpar_sigma_rGN3(selpar_sigma_rGN3_LO,selpar_sigma_rGN3_HI,selpar_sigma_rGN3_PH); 
  // init_bounded_number selpar_A50_rGN1(selpar_A50_rGN1_LO,selpar_A50_rGN1_HI,selpar_A50_rGN1_PH);
  // init_bounded_number selpar_slope_rGN1(selpar_slope_rGN1_LO,selpar_slope_rGN1_HI,selpar_slope_rGN1_PH);
  // init_bounded_number selpar_A50_rGN2(selpar_A50_rGN2_LO,selpar_A50_rGN2_HI,selpar_A50_rGN2_PH);
  // init_bounded_number selpar_slope_rGN2(selpar_slope_rGN2_LO,selpar_slope_rGN2_HI,selpar_slope_rGN2_PH);    
  ...
  vector selpar_afull_rGN1_out(1,8);
  vector selpar_sigma_rGN1_out(1,8);
  vector selpar_A50_rGN2_out(1,8);
  vector selpar_slope_rGN2_out(1,8);
  vector selpar_afull_rGN2_out(1,8);
  vector selpar_sigma_rGN2_out(1,8); 
  vector selpar_A50_rGN3_out(1,8);
  vector selpar_slope_rGN3_out(1,8);
  vector selpar_afull_rGN3_out(1,8);
  vector selpar_sigma_rGN3_out(1,8);
...
//MARMAP chevron trap index selectivity  
  ...
  init_bounded_number selpar_afull_sCT(selpar_afull_sCT_LO,selpar_afull_sCT_HI,selpar_afull_sCT_PH);
  init_bounded_number selpar_sigma_sCT(selpar_sigma_sCT_LO,selpar_sigma_sCT_HI,selpar_sigma_sCT_PH);
  
  vector selpar_A50_sCT_out(1,8);
  vector selpar_slope_sCT_out(1,8);
  vector selpar_afull_sCT_out(1,8);
  vector selpar_sigma_sCT_out(1,8);
  
  //MARMAP sVL index selectivity  
  matrix sel_sVL(styr,endyr,1,nages);
  vector sel_sVL_vec(1,nages);
  
  init_bounded_number selpar_A50_sVL(selpar_A50_sVL_LO,selpar_A50_sVL_HI,selpar_A50_sVL_PH);
  init_bounded_number selpar_slope_sVL(selpar_slope_sVL_LO,selpar_slope_sVL_HI,selpar_slope_sVL_PH);

  vector selpar_A50_sVL_out(1,8);
  vector selpar_slope_sVL_out(1,8);
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
//-------CPUE Predictions--------------------------------
  //vector pred_cHL_cpue(styr_cHL_cpue,endyr_cHL_cpue);                   //predicted cHL index (weight fish per effort)
  //matrix N_cHL(styr_cHL_cpue,endyr_cHL_cpue,1,nages);                   //used to compute cHL index
  //vector pred_rHB_cpue(styr_rHB_cpue,endyr_rHB_cpue);                   //predicted rHB index (number fish per effort)
  //matrix N_rHB(styr_rHB_cpue,endyr_rHB_cpue,1,nages);                   //used to compute rHB index
  ...
  vector pred_sVL_cpue(styr_cpue_sVL,endyr_cpue_sVL);                //predicted sVL index (number fish per effort)
  matrix N_sVL(styr_cpue_sVL,endyr_cpue_sVL,1,nages);                //used to compute sVL index
...
//---Catchability (CPUE q's)----------------------------------------------------------
  ...
  init_bounded_number log_q_cpue_sVL(log_q_sVL_LO,log_q_sVL_HI,log_q_sVL_PH);
  //vector log_q_cHL_out(1,8);
  //vector log_q_rHB_out(1,8);
  vector log_q_rGN_out(1,8);
  vector log_q_sCT_out(1,8); 
  vector log_q_sVL_out(1,8);  
  
  number q_rate;
  //vector q_rate_fcn_cHL(styr_cHL_cpue,endyr_cHL_cpue);         //increase due to technology creep (saturates in 2003) 
  //vector q_rate_fcn_rHB(styr_rHB_cpue,endyr_rHB_cpue);         //increase due to technology creep (saturates in 2003) 
...
//Fishery dependent random walk catchability
 ...
 //vector q_RW_log_dev_rHB(styr_rHB_cpue,endyr_rHB_cpue-1); 
 //init_bounded_vector q_RW_log_dev_cHL(styr_cHL_cpue,endyr_cHL_cpue-1,log_RWq_LO,log_RWq_HI,log_RWq_PH);
 //init_bounded_vector q_RW_log_dev_rHB(styr_rHB_cpue,endyr_rHB_cpue-1,log_RWq_LO,log_RWq_HI,log_RWq_PH);
 vector q_RW_log_dev_rGN(styr_cpue_rGN,endyr_cpue_rGN-1); 
 vector q_RW_log_dev_sCT(styr_cpue_sCT,endyr_cpue_sCT-1); 
 vector q_RW_log_dev_sVL(styr_cpue_sVL,endyr_cpue_sVL-1); 

//Fishery dependent catchability over time, may be constant
 //vector q_cHL(styr_cHL_cpue,endyr_cHL_cpue); 
 //vector q_rHB(styr_rHB_cpue,endyr_rHB_cpue); 
 vector q_rGN(styr_cpue_rGN,endyr_cpue_rGN); 
 vector q_sCT(styr_cpue_sCT,endyr_cpue_sCT); 
  vector q_sVL(styr_cpue_sVL,endyr_cpue_sVL); 
...
//---Discards (number dead fish) --------------------------------------------------
  ...
  //vector pred_cHL_D_knum(styr_cHL_D,endyr_cHL_D);     //yearly dead discards summed over ages
  //vector obs_cHL_D(styr_cHL_D,endyr_cHL_D);           //observed releases multiplied by discard mortality
  //vector pred_cHL_D_klb(styr_cHL_D,endyr_cHL_D);      //yearly dead discards in klb whole wgt summed over ages
  ...
  //vector pred_rGN_D_knum(styr_rGN_D,endyr_rGN_D);     //yearly dead discards summed over ages
  //vector obs_rGN_D(styr_rGN_D,endyr_rGN_D);           //observed releases multiplied by discard mortality
  //vector pred_rGN_D_klb(styr_rGN_D,endyr_rGN_D);      //yearly dead discards in klb whole wgt summed over ages
...
////---MSY calcs----------------------------------------------------------------------------
  ...
  number F_cLL_prop;       //proportion of F_sum attributable to cHL, last X=selpar_n_yrs_wgted yrs  
  ...
  number F_init_cHL_prop;  //proportion of F_init attributable to cHL, first X yrs
  number F_init_rGN_prop;  //proportion of F_init attributable to rec, first X yrs
...
////--------Mortality------------------------------------------------------------------
  ...
  init_bounded_number log_avg_F_L_cLL(log_avg_F_cLL_LO,log_avg_F_cLL_HI,log_avg_F_cLL_PH);
  vector log_avg_F_cLL_out(1,8);  
  init_bounded_dev_vector log_dev_F_L_cLL(styr_L_cLL,endyr_L_cLL,log_F_dev_cLL_LO,log_F_dev_cLL_HI,log_F_dev_cLL_PH);
  vector log_F_dev_cLL_out(styr_L_cLL,endyr_L_cLL);
  ...
  //init_bounded_number log_avg_F_cHL_D(log_avg_F_cHL_D_LO,log_avg_F_cHL_D_HI,log_avg_F_cHL_D_PH);
  //vector log_avg_F_cHL_D_out(1,8);  
  // init_bounded_dev_vector log_F_dev_cHL_D(styr_cHL_D,endyr_cHL_D,log_F_dev_cHL_D_LO,log_F_dev_cHL_D_HI,log_F_dev_cHL_D_PH);
  // vector log_F_dev_cHL_D_out(styr_cHL_D,endyr_cHL_D);
  ...
  // init_bounded_number log_avg_F_rGN_D(log_avg_F_rGN_D_LO,log_avg_F_rGN_D_HI,log_avg_F_rGN_D_PH);
  // vector log_avg_F_rGN_D_out(1,8);  
  // init_bounded_dev_vector log_F_dev_rGN_D(styr_rGN_D,endyr_rGN_D,log_F_dev_rGN_D_LO,log_F_dev_rGN_D_HI,log_F_dev_rGN_D_PH);
  // vector log_F_dev_rGN_D_out(styr_rGN_D,endyr_rGN_D);
...
// Set values of fixed parameters or set initial guess of estimated parameters
  ...
  // for(iyear=styr_cHL_D; iyear<=endyr_cHL_D; iyear++)
	// {obs_cHL_D(iyear)=Dmort_cHL*obs_cHL_released(iyear);
	// }
  ...
  // for(iyear=styr_rGN_D; iyear<=endyr_rGN_D; iyear++)
	// {obs_rGN_D(iyear)=Dmort_rGN*obs_rGN_released(iyear);
	// }
 ...
 //Population		
  ...
  log_dm_lenc_cLL=set_log_dm_lenc_cLL(1);
  //log_dm_rHB_lc=set_log_dm_rHB_lc(1);
  log_dm_lenc_rGN=set_log_dm_lenc_rGN(1);
  //log_dm_rHB_D_lc=set_log_dm_rHB_D_lc(1);
  ...
  log_dm_agec_sVL=set_log_dm_agec_sVL(1);
  
  //log_q_cHL=set_log_q_cHL(1);
  //log_q_rHB=set_log_q_rHB(1);
  log_q_cpue_rGN=set_log_q_cpue_rGN(1);
  log_q_cpue_sCT=set_log_q_cpue_sCT(1);
  log_q_cpue_sVL=set_log_q_cpue_sVL(1);
   ...
   if (set_q_rate_phase<0 & q_rate!=0.0)
  {
    ...
    // for (iyear=styr_rHB_cpue; iyear<=endyr_rHB_cpue; iyear++)
      // {   if (iyear>styr_rHB_cpue & iyear <=2003) 
          // {//q_rate_fcn_rHB(iyear)=(1.0+q_rate)*q_rate_fcn_rHB(iyear-1); //compound
             // q_rate_fcn_rHB(iyear)=(1.0+(iyear-styr_rHB_cpue)*q_rate)*q_rate_fcn_rHB(styr_rHB_cpue);  //linear
          // }
  ...
  w_cpue_sVL=set_w_cpue_sVL;
  
  w_lenc_cHL=set_w_lenc_cHL;
  w_lenc_cLL=set_w_lenc_cLL;  
  //w_lc_rHB=set_w_lc_rHB;
  //w_lc_rHB_D=set_w_lc_rHB_D; 
  ...
  //log_avg_F_cHL_D=set_log_avg_F_cHL_D(1);
  //log_avg_F_rHB_D=set_log_avg_F_rHB_D(1); 
  //log_avg_F_rGN_D=set_log_avg_F_rGN_D(1); 
    
  log_dev_F_L_cHL=set_log_dev_vals_F_L__cHL;
  log_dev_F_L_cLL=set_log_dev_vals_F_L__cLL;
  //log_F_dev_rHB=set_log_F_dev_rHB_vals;
  log_dev_F_L_rGN=set_log_dev_vals_F_L__rGN;
  //log_F_dev_cHL_D=set_log_F_dev_cHL_D_vals;
  //log_F_dev_rHB_D=set_log_F_dev_rHB_D_vals;
  //log_F_dev_rGN_D=set_log_F_dev_rGN_D_vals;
  ...
  selpar_A50_cLL1=set_selpar_A50_cLL1(1);
  selpar_slope_cLL1=set_selpar_slope_cLL1(1);
  // selpar_A50_cLL2=set_selpar_A50_cLL2(1);
  // selpar_A50_cLL3=set_selpar_A50_cLL3(1);
  // selpar_slope_cLL2=set_selpar_slope_cLL2(1);
  // selpar_A502_cLL2=set_selpar_A502_cLL2(1);
  // selpar_slope2_cLL2=set_selpar_slope2_cLL2(1);
  ...
  selpar_afull_rGN1=set_selpar_afull_rGN1(1);
  selpar_sigma_rGN1=set_selpar_sigma_rGN1(1);
  selpar_A50_rGN2=set_selpar_A50_rGN2(1);
  selpar_slope_rGN2=set_selpar_slope_rGN2(1);
  selpar_afull_rGN2=set_selpar_afull_rGN2(1);
  selpar_sigma_rGN2=set_selpar_sigma_rGN2(1);  
  selpar_A50_rGN3=set_selpar_A50_rGN3(1);
  selpar_slope_rGN3=set_selpar_slope_rGN3(1);
  selpar_afull_rGN3=set_selpar_afull_rGN3(1);
  selpar_sigma_rGN3=set_selpar_sigma_rGN3(1);
  ...
  selpar_afull_sCT=set_selpar_afull_sCT(1);
  selpar_sigma_sCT=set_selpar_sigma_sCT(1);
  
  selpar_A50_sVL=set_selpar_A50_sVL(1);
  selpar_slope_sVL=set_selpar_slope_sVL(1);
...
//Used primarily for output in R object   
    ...
    //nfish_rHB_agec_allyr=missing;
      ...
      for (iyear=1; iyear<=nyr_lenc_cLL; iyear++)
         {if (nsamp_lenc_cLL(iyear)>=minSS_lenc_cLL)
           {nsamp_cLL_lenc_allyr(yrs_lenc_cLL(iyear))=nsamp_lenc_cLL(iyear);
            nfish_cLL_lenc_allyr(yrs_lenc_cLL(iyear))=nfish_lenc_cLL(iyear);}}			
      ...
      // for (iyear=1; iyear<=nyr_rHB_D_lenc; iyear++)                           
         // {if (nsamp_rHB_D_lenc(iyear)>=minSS_rHB_D_lenc)
            // {nsamp_rHB_D_lenc_allyr(yrs_rHB_D_lenc(iyear))=nsamp_rHB_D_lenc(iyear);
             // nfish_rHB_D_lenc_allyr(yrs_rHB_D_lenc(iyear))=nfish_rHB_D_lenc(iyear);}}
	  ...
	  for (iyear=1; iyear<=nyr_agec_cLL; iyear++)
         {if (nsamp_agec_cLL(iyear)>=minSS_agec_cLL)
           {nsamp_cLL_agec_allyr(yrs_agec_cLL(iyear))=nsamp_agec_cLL(iyear);
            nfish_cLL_agec_allyr(yrs_agec_cLL(iyear))=nfish_agec_cLL(iyear);}}
	  ...
	  for (iyear=1; iyear<=nyr_agec_sVL; iyear++)  
          {if (nsamp_agec_sVL(iyear)>=minSS_agec_sVL)
            {nsamp_sVL_agec_allyr(yrs_agec_sVL(iyear))=nsamp_agec_sVL(iyear);
             nfish_sVL_agec_allyr(yrs_agec_sVL(iyear))=nfish_agec_sVL(iyear);}} 
...
FUNCTION get_selectivity
  ...
  sel_cHL_vec=logistic(agebins, selpar_A50_cHL1, selpar_slope_cHL1);
  ...
  sel_cLL_vec=logistic(agebins, selpar_A50_cLL1, selpar_slope_cLL1);
  // sel_cLL_block2=logistic_double(agebins, selpar_A50_cLL2, selpar_slope_cLL2, selpar_A502_cLL2,selpar_slope2_cLL2);
  // sel_cLL_block3=logistic_double(agebins, selpar_A50_cLL3, selpar_slope_cLL2, selpar_A502_cLL2,selpar_slope2_cLL2);
  // sel_cLL_block1=sel_cLL_block2;
  ...
  sel_rGN_block1=logistic_exponential(agebins, selpar_A50_rGN1, selpar_slope_rGN1, selpar_sigma_rGN1, selpar_afull_rGN1);
  sel_rGN_block2=logistic_exponential(agebins, selpar_A50_rGN2, selpar_slope_rGN2, selpar_sigma_rGN2, selpar_afull_rGN2);
  sel_rGN_block3=logistic_exponential(agebins, selpar_A50_rGN3, selpar_slope_rGN3, selpar_sigma_rGN3, selpar_afull_rGN3);
  sel_sCT_vec=logistic_exponential(agebins, selpar_A50_sCT, selpar_slope_sCT, selpar_sigma_sCT, selpar_afull_sCT);
  sel_sVL_vec=logistic(agebins, selpar_A50_sVL, selpar_slope_sVL);
  ...
  for (iyear=styr; iyear<=endyr_selex_phase1; iyear++)
   {  
    sel_cHL(iyear)=sel_cHL_vec;   
    //sel_cHL(iyear)=sel_cHL_block1;
	sel_cLL(iyear)=sel_cLL_vec;
    //	sel_rHB(iyear)=sel_rHB_block1;
    sel_rGN(iyear)=sel_rGN_block1;
	sel_sCT(iyear)=sel_sCT_vec;
	sel_sVL(iyear)=sel_sVL_vec;
 	//sel_D(iyear)=sel_D_block1;
	sel_sCT(iyear)(15,nages)=sel_sCT(iyear)(14);
    sel_rGN(iyear)(15,nages)=sel_rGN(iyear)(14);     
    sel_cHL(iyear)(15,nages)=sel_cHL(iyear)(14);
   }
...
FUNCTION get_mortality
  ...
  for (iyear=styr; iyear<=endyr; iyear++) 
  {
	...
	if(iyear>=styr_L_cLL & iyear<=endyr_L_cLL) //spans full time series
    ...
    //log_F_avgdev_cHL_D=sum(log_F_dev_cHL_D(styr_cHL_D,endyr_cHL_D))/(endyr_cHL_D-styr_cHL_D+1.0);
    //log_F_avgdev_rHB_D=sum(log_F_dev_rHB_D(styr_rHB_D,endyr_rHB_D))/(endyr_rHB_D-styr_rHB_D+1.0);   
    //log_F_avgdev_rGN_D=sum(log_F_dev_rGN_D(styr_rGN_D,endyr_rGN_D))/(endyr_rGN_D-styr_rGN_D+1.0);	

    // if(iyear>=styr_cHL_D & iyear<=endyr_cHL_D)
		// {F_cHL_D_out(iyear)=mfexp(log_avg_F_cHL_D+log_F_dev_cHL_D(iyear));}    
    // if(iyear>endyr_selex_phase1 & iyear<styr_cHL_D)
		// {F_cHL_D_out(iyear)=mfexp(log_avg_F_cHL_D+log_F_avgdev_cHL_D);} 	
    ...
    // if(iyear>=styr_rGN_D & iyear<=endyr_rGN_D)
		// {F_rGN_D_out(iyear)=mfexp(log_avg_F_rGN_D+log_F_dev_rGN_D(iyear));}  
...
//Initialization
  ...
  //F_initial=sel_cHL(styr)*mfexp(log_avg_F_L_cHL+log_F_dev_init_cHL)+
            //sel_cLL(styr)*mfexp(log_avg_F_L_cLL+log_F_dev_init_cLL)+
            //sel_rHB(styr)*mfexp(log_avg_F_rHB+log_F_dev_init_rHB)+
  F_init_cHL_prop=mfexp(log_avg_F_L_cHL+log_F_dev_init_cHL)/(mfexp(log_avg_F_L_cHL+log_F_dev_init_cHL)+mfexp(log_avg_F_L_rGN+log_F_dev_init_rGN));
  F_init_rGN_prop=mfexp(log_avg_F_L_rGN+log_F_dev_init_rGN)/(mfexp(log_avg_F_L_cHL+log_F_dev_init_cHL)+mfexp(log_avg_F_L_rGN+log_F_dev_init_rGN));
  
  F_initial=sel_cHL(styr)*F_init*F_init_cHL_prop+
            sel_rGN(styr)*F_init*F_init_rGN_prop;  //cGN cLL not operating at styr            //sel_rGN(styr)*mfexp(log_avg_F_L_rGN+log_F_dev_init_rGN);			
...
//---Predicted CPUEs------------------------
 ...
 //cHL  cpue
  // q_cHL(styr_cHL_cpue)=mfexp(log_q_cHL); 
  // for (iyear=styr_cHL_cpue; iyear<=endyr_cHL_cpue; iyear++)
 ...
 //rHB  cpue
  // q_rHB(styr_rHB_cpue)=mfexp(log_q_rHB); 
  // for (iyear=styr_rHB_cpue; iyear<=endyr_rHB_cpue; iyear++)
  // {   
      ...
      // if (iyear<endyr_rHB_cpue){q_rHB(iyear+1)=q_rHB(iyear)*mfexp(q_RW_log_dev_rHB(iyear));}
  // }
 ...
 //SEFIS sCT cpue
  ...
  //MARMAP sVL
  q_sVL(styr_cpue_sVL)=mfexp(log_q_cpue_sVL); 
  for (iyear=styr_cpue_sVL; iyear<=endyr_cpue_sVL; iyear++)
  {   
    N_sVL(iyear)=elem_prod(N_mdyr(iyear),sel_sVL(iyear)); 
	pred_sVL_cpue(iyear)=q_sVL(iyear)*q_DD_fcn(iyear)*sum(N_sVL(iyear));
    if (iyear<endyr_cpue_sVL){q_sVL(iyear+1)=q_sVL(iyear)*mfexp(q_RW_log_dev_sVL(iyear));}
  } 
FUNCTION get_length_comps
  ...
  //cGN longline 
  for (iyear=1;iyear<=nyr_lenc_cLL;iyear++)
  {pred_cLL_lenc(iyear)=(L_cLL_num(yrs_lenc_cLL(iyear))*lenprob_cLL)/sum(L_cLL_num(yrs_lenc_cLL(iyear)));}
  ...
  //headboat discards   
  // for (iyear=1;iyear<=nyr_rHB_D_lenc;iyear++) 
  // {pred_rHB_D_lenc(iyear)=(D_rHB_num(yrs_rHB_D_lenc(iyear))*lenprob_rHB_D)/sum(D_rHB_num(yrs_rHB_D_lenc(iyear)));}
...
FUNCTION get_age_comps
  ...
  for (iyear=1;iyear<=nyr_agec_cLL;iyear++) 
  {
    ErrorFree_cLL_agec(iyear)=L_cLL_num(yrs_agec_cLL(iyear))/sum(L_cLL_num(yrs_agec_cLL(iyear)));  
    pred_cLL_agec_allages(iyear)=age_error*(ErrorFree_cLL_agec(iyear)/sum(ErrorFree_cLL_agec(iyear)));   
    for (iage=1; iage<=nages_agec; iage++) {pred_cLL_agec(iyear,iage)=pred_cLL_agec_allages(iyear,iage);} 
    //for (iage=(nages_agec+1); iage<=nages; iage++) {pred_cLL_agec(iyear,nages_agec)+=pred_cLL_agec_allages(iyear,iage);} //plus group                             
  }
// // Commercial longline  pooled age comps
  // for (iyear=1;iyear<=nyr_cLL_agec_pool;iyear++){
   
  // ErrorFree_cLL_agec_yr(iyear)=L_cLL_num(yrs_cLL_agec_pool(iyear))/sum(L_cLL_num(yrs_cLL_agec_pool(iyear)));
  // pred_cLL_agec_allages_yr(iyear)=age_error*(ErrorFree_cLL_agec_yr(iyear)/sum(ErrorFree_cLL_agec_yr(iyear)));							  
  // }  
  // pred_cLL_agec.initialize();
  // for (iyear=1;iyear<=nyr_cLL_agec_pool;iyear++)
    // {pred_cLL_agec_allages(1) += (nfish_cLL_agec_pool(iyear) * pred_cLL_agec_allages_yr(iyear));}
  // pred_cLL_agec_allages(1) = pred_cLL_agec_allages(1)/sum(nfish_cLL_agec_pool); //KWS moved this line out of the loop											   
 ...
 for (iyear=1;iyear<=nyr_agec_sVL;iyear++)
  {
    ErrorFree_sVL_agec(iyear)=N_sVL(yrs_agec_sVL(iyear))/sum(N_sVL(yrs_agec_sVL(iyear)));
    pred_sVL_agec_allages(iyear)=age_error*ErrorFree_sVL_agec(iyear); 
    for (iage=1; iage<=nages_agec; iage++) {pred_sVL_agec(iyear,iage)=pred_sVL_agec_allages(iyear,iage);} 
    //for (iage=(nages_agec+1); iage<=nages; iage++) {pred_sVL_agec(iyear,nages_agec)+=pred_sVL_agec_allages(iyear,iage);} //plus group                        
  }
...
FUNCTION get_weighted_current 
  ...
  // F_temp_sum+=mfexp((selpar_n_yrs_wgted*log_avg_F_cHL_D+
        // sum(log_F_dev_cHL_D((endyr-selpar_n_yrs_wgted+1),endyr)))/selpar_n_yrs_wgted);
  ...
  // F_temp_sum+=mfexp((selpar_n_yrs_wgted*log_avg_F_rGN_D+
        // sum(log_F_dev_rGN_D((endyr-selpar_n_yrs_wgted+1),endyr)))/selpar_n_yrs_wgted);
  ...
  // F_cHL_D_prop=mfexp((selpar_n_yrs_wgted*log_avg_F_cHL_D+
        // sum(log_F_dev_cHL_D((endyr-selpar_n_yrs_wgted+1),endyr)))/selpar_n_yrs_wgted)/F_temp_sum;
  ...
  // F_rGN_D_prop=mfexp((selpar_n_yrs_wgted*log_avg_F_rGN_D+
        // sum(log_F_dev_rGN_D((endyr-selpar_n_yrs_wgted+1),endyr)))/selpar_n_yrs_wgted)/F_temp_sum;
  ...
  //log_F_dev_end_cHL_D=sum(log_F_dev_cHL_D((endyr-selpar_n_yrs_wgted+1),endyr))/selpar_n_yrs_wgted;
  //log_F_dev_end_rHB_D=sum(log_F_dev_rHB_D((endyr-selpar_n_yrs_wgted+1),endyr))/selpar_n_yrs_wgted;
  //log_F_dev_end_rGN_D=sum(log_F_dev_rGN_D((endyr-selpar_n_yrs_wgted+1),endyr))/selpar_n_yrs_wgted;
  ...
  //F_end_D=sel_D(endyr)*mfexp(log_avg_F_cHL_D+log_F_dev_end_cHL_D)+
          //sel_D(endyr)*mfexp(log_avg_F_rHB_D+log_F_dev_end_rHB_D)+
          //sel_D(endyr)*mfexp(log_avg_F_rGN_D+log_F_dev_end_rGN_D);   
  ...
  wgt_wgted_L_denom=F_cHL_prop+F_cLL_prop+
				//F_rHB_prop+
				F_rGN_prop;  
  ...
  //wgt_wgted_D_denom=F_cHL_D_prop+
				//F_rHB_D_prop+	
				//F_rGN_D_prop;  
...
//switch here if var_rec_dev <=dzero 
  ...
  for(iyear=styr; iyear<=endyr; iyear++)
  {
        L_total_klb_yr(iyear)=pred_cHL_L_klb(iyear)+pred_cLL_L_klb(iyear)+
		//pred_rHB_L_klb(iyear)+
		pred_rGN_L_klb(iyear);
        L_total_knum_yr(iyear)=pred_cHL_L_knum(iyear)+pred_cLL_L_knum(iyear)+pred_rGN_L_knum(iyear);  //pred_rHB_L_knum(iyear)+
        ...
        //if (iyear>=styr_rGN_D && iyear<=endyr_rGN_D)
		// if (iyear>=styr_rGN_D && iyear<=endyr)	
        // {
  ...
  L_total_num=L_cHL_num+L_cLL_num+L_rGN_num;   //landings at age in number fish -- L_rHB_num+
  L_total_klb=L_cHL_klb+L_cLL_klb+L_rGN_klb;   //landings at age in klb whole weight -- L_rHB_klb+
 
  // D_total_num=D_rGN_num;          //discards at age in number fish  -- D_rHB_num+D_cHL_num+
  // D_total_klb=D_rGN_klb;            //discards at age in klb whole weight -- D_rHB_klb+D_cHL_klb+
...
//---Indices-------------------------------
  ...
  // f_rHB_cpue=0.0;
  // f_rHB_cpue=lk_lognormal(pred_rHB_cpue, obs_rHB_cpue, rHB_cpue_cv, w_I_rHB);
  // fval+=f_rHB_cpue;
  ...
  f_sVL_cpue=0.0;
  f_sVL_cpue=lk_lognormal(pred_sVL_cpue, obs_cpue_sVL, obs_cv_cpue_sVL, w_cpue_sVL);
  fval+=f_sVL_cpue;
  fval_data+=f_sVL_cpue;  
...
//---Discards-------------------------------
  ...
  // f_cHL_D=lk_lognormal(pred_cHL_D_knum(styr_cHL_D,endyr_cHL_D), obs_cHL_D(styr_cHL_D,endyr_cHL_D), 
                      // cHL_D_cv(styr_cHL_D,endyr_cHL_D), w_D);
  // fval+=f_cHL_D;
  // fval_data+=f_cHL_D;  
  ...
  //f_rGN_D=lk_lognormal(pred_rGN_D_knum(styr_rGN_D,endyr_rGN_D), obs_rGN_D(styr_rGN_D,endyr_rGN_D), 
                      //rGN_D_cv(styr_rGN_D,endyr_rGN_D), w_D);
  //fval+=f_rGN_D;
  //fval_data+=f_rGN_D;  
...
//---Length comps-------------------------------
  ...
  //f_cLL_lenc
  //f_cLL_lenc=lk_robust_multinomial(nsamp_lenc_cLL, pred_cLL_lenc, obs_lenc_cLL, nyr_lenc_cLL, double(nlenbins), minSS_lenc_cLL, w_lenc_cLL);
  //f_cLL_lenc=lk_logistic_normal(nsamp_lenc_cLL, pred_cLL_lenc, obs_lenc_cLL, nyr_lenc_cLL, double(nlenbins), minSS_lenc_cLL);
  f_cLL_lenc=lk_dirichlet_multinomial(nsamp_lenc_cLL, pred_cLL_lenc, obs_lenc_cLL, nyr_lenc_cLL, double(nlenbins), minSS_lenc_cLL, log_dm_lenc_cLL);
  fval+=f_cLL_lenc;
  ...
  //f_rHB_D_lenc
  //f_rHB_D_lenc=lk_robust_multinomial(nsamp_rHB_D_lenc, pred_rHB_D_lenc, obs_rHB_D_lenc, nyr_rHB_D_lenc, double(nlenbins), minSS_rHB_D_lenc, w_lc_rHB_D);
  //f_rHB_D_lenc=lk_logistic_normal(nsamp_rHB_D_lenc, pred_rHB_D_lenc, obs_rHB_D_lenc, nyr_rHB_D_lenc, double(nlenbins), minSS_rHB_D_lenc);
  // f_rHB_D_lenc=lk_dirichlet_multinomial(nsamp_rHB_D_lenc, pred_rHB_D_lenc, obs_rHB_D_lenc, nyr_rHB_D_lenc, double(nlenbins), minSS_rHB_D_lenc, log_dm_rHB_D_lc);
  // fval+=f_rHB_D_lenc;
  // fval_data+=f_rHB_D_lenc;
  
  //f_sVL_lenc
  //f_sVL_lenc=lk_robust_multinomial(nsamp_sVL_lenc, pred_sVL_lenc, obs_sVL_lenc, nyr_sVL_lenc, double(nlenbins), minSS_sVL_lenc, w_lc_sVL);
  //f_sVL_lenc=lk_logistic_normal(nsamp_sVL_lenc, pred_sVL_lenc, obs_sVL_lenc, nyr_sVL_lenc, double(nlenbins), minSS_sVL_lenc);
  // f_sVL_lenc=lk_dirichlet_multinomial(nsamp_sVL_lenc, pred_sVL_lenc, obs_sVL_lenc, nyr_sVL_lenc, double(nlenbins), minSS_sVL_lenc, log_dm_sVL_lc);
  // fval+=f_sVL_lenc;
...
//---Age comps-------------------------------
  ...
  //f_cLL_agec
  //f_cLL_agec=lk_robust_multinomial(nsamp_agec_cLL, pred_cLL_agec, obs_agec_cLL, nyr_agec_cLL, double(nages_agec), minSS_agec_cLL, w_agec_cLL);
  //f_cLL_agec=lk_logistic_normal(nsamp_agec_cLL, pred_cLL_agec, obs_agec_cLL, nyr_agec_cLL, double(nages_agec), minSS_agec_cLL);
  f_cLL_agec=lk_dirichlet_multinomial(nsamp_agec_cLL, pred_cLL_agec, obs_agec_cLL, nyr_agec_cLL, double(nages_agec), minSS_agec_cLL, log_dm_agec_cLL);
  fval+=f_cLL_agec;
  ...
  //f_sVL_agec
  //f_sVL_agec=lk_robust_multinomial(nsamp_agec_sVL, pred_sVL_agec, obs_agec_sVL, nyr_agec_sVL, double(nages_agec), minSS_agec_sVL, w_agec_sVL);
  //f_sVL_agec=lk_logistic_normal(nsamp_agec_sVL, pred_sVL_agec, obs_agec_sVL, nyr_agec_sVL, double(nages_agec), minSS_agec_sVL);
  f_sVL_agec=lk_dirichlet_multinomial(nsamp_agec_sVL, pred_sVL_agec, obs_agec_sVL, nyr_agec_sVL, double(nages_agec), minSS_agec_sVL, log_dm_agec_sVL);
  //f_sVL_agec=lk_dirichlet_multinomial(nsamp_agec_sVL, pred_sVL_agec, obs_agec_sVL, nyr_agec_sVL, double(nages_agec), minSS_agec_sVL, log_dm_agec_sVL);
  fval+=f_sVL_agec;
  fval_data+=f_sVL_agec;
...
//pdf type 1=none, 2=lognormal, 3=normal, 4=beta 
  ...
  f_priors+=neg_log_prior(selpar_A50_cLL1,set_selpar_A50_cLL1(5), set_selpar_A50_cLL1(6), set_selpar_A50_cLL1(7));
  f_priors+=neg_log_prior(selpar_slope_cLL1,set_selpar_slope_cLL1(5), set_selpar_slope_cLL1(6), set_selpar_slope_cLL1(7));
  // f_priors+=neg_log_prior(selpar_A50_cLL2,set_selpar_A50_cLL2(5), set_selpar_A50_cLL2(6), set_selpar_A50_cLL2(7));
  // f_priors+=neg_log_prior(selpar_A50_cLL3,set_selpar_A50_cLL3(5), set_selpar_A50_cLL3(6), set_selpar_A50_cLL3(7));
  // f_priors+=neg_log_prior(selpar_slope_cLL2,set_selpar_slope_cLL2(5), set_selpar_slope_cLL2(6), set_selpar_slope_cLL2(7));
  // f_priors+=neg_log_prior(selpar_A502_cLL2,set_selpar_A502_cLL2(5), set_selpar_A502_cLL2(6), set_selpar_A502_cLL2(7));
  // f_priors+=neg_log_prior(selpar_slope2_cLL2,set_selpar_slope2_cLL2(5), set_selpar_slope2_cLL2(6), set_selpar_slope2_cLL2(7));
  ...
  f_priors+=neg_log_prior(selpar_afull_rGN1,set_selpar_afull_rGN1(5), set_selpar_afull_rGN1(6), set_selpar_afull_rGN1(7));
  f_priors+=neg_log_prior(selpar_sigma_rGN1,set_selpar_sigma_rGN1(5), set_selpar_sigma_rGN1(6), set_selpar_sigma_rGN1(7));
  ...
  f_priors+=neg_log_prior(selpar_afull_rGN2,set_selpar_afull_rGN2(5), set_selpar_afull_rGN2(6), set_selpar_afull_rGN2(7));
  f_priors+=neg_log_prior(selpar_sigma_rGN2,set_selpar_sigma_rGN2(5), set_selpar_sigma_rGN2(6), set_selpar_sigma_rGN2(7)); 
  ...
  f_priors+=neg_log_prior(selpar_afull_rGN3,set_selpar_afull_rGN3(5), set_selpar_afull_rGN3(6), set_selpar_afull_rGN3(7));
  f_priors+=neg_log_prior(selpar_sigma_rGN3,set_selpar_sigma_rGN3(5), set_selpar_sigma_rGN3(6), set_selpar_sigma_rGN3(7));
  ...
  f_priors+=neg_log_prior(selpar_afull_sCT,set_selpar_afull_sCT(5), set_selpar_afull_sCT(6), set_selpar_afull_sCT(7));
  f_priors+=neg_log_prior(selpar_sigma_sCT,set_selpar_sigma_sCT(5), set_selpar_sigma_sCT(6), set_selpar_sigma_sCT(7));
  
  f_priors+=neg_log_prior(selpar_A50_sVL,set_selpar_A50_sVL(5), set_selpar_A50_sVL(6), set_selpar_A50_sVL(7));
  f_priors+=neg_log_prior(selpar_slope_sVL,set_selpar_slope_sVL(5), set_selpar_slope_sVL(6), set_selpar_slope_sVL(7));
  ...
  //f_priors+=neg_log_prior(log_q_rHB,set_log_q_rHB(5),set_log_q_rHB(6),set_log_q_rHB(7));
  ...
  f_priors+=neg_log_prior(log_q_cpue_sVL,set_log_q_cpue_sVL(5),set_log_q_cpue_sVL(6),set_log_q_cpue_sVL(7));
      
  f_priors+=neg_log_prior(log_dm_lenc_cHL,set_log_dm_lenc_cHL(5),set_log_dm_lenc_cHL(6),set_log_dm_lenc_cHL(7));
  f_priors+=neg_log_prior(log_dm_lenc_cLL,set_log_dm_lenc_cLL(5),set_log_dm_lenc_cLL(6),set_log_dm_lenc_cLL(7));
  ...
  //f_priors+=neg_log_prior(log_dm_rHB_D_lc,set_log_dm_rHB_D_lc(5),set_log_dm_rHB_D_lc(6),set_log_dm_rHB_D_lc(7));
  ...
  f_priors+=neg_log_prior(log_dm_agec_sVL,set_log_dm_agec_sVL(5),set_log_dm_agec_sVL(6),set_log_dm_agec_sVL(7));
...
REPORT_SECTION
  ...
  if (last_phase())  
  {
      ...
      sdnr_lc_cLL=sdnr_multinomial(nyr_lenc_cLL, lenbins, nsamp_lenc_cLL, pred_cLL_lenc, obs_lenc_cLL, w_lenc_cLL);  	  
      ...
      //sdnr_lc_rHB_D=sdnr_multinomial(nyr_rHB_D_lenc, lenbins, nsamp_rHB_D_lenc, pred_rHB_D_lenc, obs_rHB_D_lenc, w_lc_rHB_D); 
	  ...
	  sdnr_ac_cLL=sdnr_multinomial(nyr_agec_cLL, agebins_agec, nsamp_agec_cLL, pred_cLL_agec, obs_agec_cLL, w_agec_cLL);
      ...
      sdnr_ac_sVL=sdnr_multinomial(nyr_agec_sVL, agebins_agec, nsamp_agec_sVL, pred_sVL_agec, obs_agec_sVL, w_agec_sVL);	  
     
      //sdnr_I_cHL=sdnr_lognormal(pred_cHL_cpue, obs_cHL_cpue, cHL_cpue_cv, w_I_cHL);
      //sdnr_I_rHB=sdnr_lognormal(pred_rHB_cpue, obs_rHB_cpue, rHB_cpue_cv, w_I_rHB);
	  ...
	  sdnr_I_sVL=sdnr_lognormal(pred_sVL_cpue, obs_cpue_sVL, obs_cv_cpue_sVL, w_cpue_sVL);
      ...
      //################################################################################################# 
	   ...
	   log_dm_cLL_lc_out(8)=log_dm_lenc_cLL; log_dm_cLL_lc_out(1,7)=set_log_dm_lenc_cLL;
	   ...
	   //log_dm_rHB_D_lc_out(8)=log_dm_rHB_D_lc; log_dm_rHB_D_lc_out(1,7)=set_log_dm_rHB_D_lc;
	   ...
	   log_dm_cLL_ac_out(8)=log_dm_agec_cLL; log_dm_cLL_ac_out(1,7)=set_log_dm_agec_cLL;
	   ...
	   log_dm_sVL_ac_out(8)=log_dm_agec_sVL; log_dm_sVL_ac_out(1,7)=set_log_dm_agec_sVL;
       ...
       selpar_A50_cLL1_out(8)=selpar_A50_cLL1; selpar_A50_cLL1_out(1,7)=set_selpar_A50_cLL1;
       selpar_slope_cLL1_out(8)=selpar_slope_cLL1; selpar_slope_cLL1_out(1,7)=set_selpar_slope_cLL1;
	   // selpar_A50_cLL2_out(8)=selpar_A50_cLL2; selpar_A50_cLL2_out(1,7)=set_selpar_A50_cLL2;
       // selpar_A50_cLL3_out(8)=selpar_A50_cLL3; selpar_A50_cLL3_out(1,7)=set_selpar_A50_cLL3;
       // selpar_slope_cLL2_out(8)=selpar_slope_cLL2; selpar_slope_cLL2_out(1,7)=set_selpar_slope_cLL2;
       // selpar_A502_cLL2_out(8)=selpar_A502_cLL2; selpar_A502_cLL2_out(1,7)=set_selpar_A502_cLL2;
       // selpar_slope2_cLL2_out(8)=selpar_slope2_cLL2; selpar_slope2_cLL2_out(1,7)=set_selpar_slope2_cLL2;	  
	   ...
	   selpar_afull_rGN1_out(8)=selpar_afull_rGN1; selpar_afull_rGN1_out(1,7)=set_selpar_afull_rGN1;
	   selpar_sigma_rGN1_out(8)=selpar_sigma_rGN1; selpar_sigma_rGN1_out(1,7)=set_selpar_sigma_rGN1;
	   ...
	   selpar_afull_rGN2_out(8)=selpar_afull_rGN2; selpar_afull_rGN2_out(1,7)=set_selpar_afull_rGN2;
	   selpar_sigma_rGN2_out(8)=selpar_sigma_rGN2; selpar_sigma_rGN2_out(1,7)=set_selpar_sigma_rGN2;	   
	   ...
	   selpar_afull_rGN3_out(8)=selpar_afull_rGN3; selpar_afull_rGN3_out(1,7)=set_selpar_afull_rGN3;
	   selpar_sigma_rGN3_out(8)=selpar_sigma_rGN3; selpar_sigma_rGN3_out(1,7)=set_selpar_sigma_rGN3;
       ...
       selpar_afull_sCT_out(8)=selpar_afull_sCT; selpar_afull_sCT_out(1,7)=set_selpar_afull_sCT;
       selpar_sigma_sCT_out(8)=selpar_sigma_sCT; selpar_sigma_sCT_out(1,7)=set_selpar_sigma_sCT;
	   
	   selpar_A50_sVL_out(8)=selpar_A50_sVL; selpar_A50_sVL_out(1,7)=set_selpar_A50_sVL;
       selpar_slope_sVL_out(8)=selpar_slope_sVL; selpar_slope_sVL_out(1,7)=set_selpar_slope_sVL;
       ...
       //log_q_rHB_out(8)=log_q_rHB; log_q_rHB_out(1,7)=set_log_q_rHB;
	   ...
	   log_q_sVL_out(8)=log_q_cpue_sVL; log_q_sVL_out(1,7)=set_log_q_cpue_sVL;
                     
       log_avg_F_cHL_out(8)=log_avg_F_L_cHL; log_avg_F_cHL_out(1,7)=set_log_avg_F_L_cHL;
	   log_avg_F_cLL_out(8)=log_avg_F_L_cLL; log_avg_F_cLL_out(1,7)=set_log_avg_F_L_cLL;
       ...
       //log_avg_F_cHL_D_out(8)=log_avg_F_cHL_D; log_avg_F_cHL_D_out(1,7)=set_log_avg_F_cHL_D;
       //log_avg_F_rHB_D_out(8)=log_avg_F_rHB_D; log_avg_F_rHB_D_out(1,7)=set_log_avg_F_rHB_D;
       //log_avg_F_rGN_D_out(8)=log_avg_F_rGN_D; log_avg_F_rGN_D_out(1,7)=set_log_avg_F_rGN_D;
	   ...
	   log_F_dev_cLL_out(styr_L_cLL,endyr_L_cLL)=log_dev_F_L_cLL;
       //log_F_dev_rHB_out(styr_rHB_L,endyr_rHB_L)=log_F_dev_rHB;
       log_F_dev_rGN_out(styr_L_rGN,endyr_L_rGN)=log_dev_F_L_rGN;
       //log_F_dev_cHL_D_out(styr_cHL_D,endyr_cHL_D)=log_F_dev_cHL_D;
       //log_F_dev_rHB_D_out(styr_rHB_D,endyr_rHB_D)=log_F_dev_rHB_D;
       //log_F_dev_rGN_D_out(styr_rGN_D,endyr_rGN_D)=log_F_dev_rGN_D;
