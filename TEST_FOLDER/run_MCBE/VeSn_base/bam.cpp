...
cout << endl;
  ...
  endyr_2008.allocate("endyr_2008");
  ...
  styr_cpue_sFT.allocate("styr_cpue_sFT");
  endyr_cpue_sFT.allocate("endyr_cpue_sFT");
  obs_cpue_sFT.allocate(styr_cpue_sFT,endyr_cpue_sFT,"obs_cpue_sFT");
  obs_cv_cpue_sFT.allocate(styr_cpue_sFT,endyr_cpue_sFT,"obs_cv_cpue_sFT");
  nyr_lenc_sFT.allocate("nyr_lenc_sFT");
  yrs_lenc_sFT.allocate(1,nyr_lenc_sFT,"yrs_lenc_sFT");
  nsamp_lenc_sFT.allocate(1,nyr_lenc_sFT,"nsamp_lenc_sFT");
  nfish_lenc_sFT.allocate(1,nyr_lenc_sFT,"nfish_lenc_sFT");
  obs_lenc_sFT.allocate(1,nyr_lenc_sFT,1,nlenbins,"obs_lenc_sFT");
  sel_sFT_vec.allocate(1,nages,"sel_sFT_vec");
  ...
  set_selpar_logit_Age1_sCT.allocate(1,7,"set_selpar_logit_Age1_sCT");
  set_selpar_logit_Age2_sCT.allocate(1,7,"set_selpar_logit_Age2_sCT");
  set_selpar_A50_cHL1.allocate(1,7,"set_selpar_A50_cHL1");
  set_selpar_slope_cHL1.allocate(1,7,"set_selpar_slope_cHL1");
  set_selpar_A502_cHL1.allocate(1,7,"set_selpar_A502_cHL1");
  set_selpar_slope2_cHL1.allocate(1,7,"set_selpar_slope2_cHL1");
  set_selpar_A50_cHL2.allocate(1,7,"set_selpar_A50_cHL2");
  set_selpar_slope_cHL2.allocate(1,7,"set_selpar_slope_cHL2");
  set_selpar_A502_cHL2.allocate(1,7,"set_selpar_A502_cHL2");
  set_selpar_slope2_cHL2.allocate(1,7,"set_selpar_slope2_cHL2");
  set_selpar_A50_cOT1.allocate(1,7,"set_selpar_A50_cOT1");
  set_selpar_slope_cOT1.allocate(1,7,"set_selpar_slope_cOT1");
  set_selpar_A502_cOT1.allocate(1,7,"set_selpar_A502_cOT1");
  set_selpar_slope2_cOT1.allocate(1,7,"set_selpar_slope2_cOT1");
  ...
  set_selpar_A502_rHB4.allocate(1,7,"set_selpar_A502_rHB4");
  set_selpar_slope2_rHB4.allocate(1,7,"set_selpar_slope2_rHB4");
  ...
  set_selpar_A502_rGN3.allocate(1,7,"set_selpar_A502_rGN3");
  set_selpar_slope2_rGN3.allocate(1,7,"set_selpar_slope2_rGN3");
  set_selpar_A50_rGN4.allocate(1,7,"set_selpar_A50_rGN4");
  set_selpar_slope_rGN4.allocate(1,7,"set_selpar_slope_rGN4");
  set_selpar_A502_rGN4.allocate(1,7,"set_selpar_A502_rGN4");
  set_selpar_slope2_rGN4.allocate(1,7,"set_selpar_slope2_rGN4");
  set_sel_cHL_D_2.allocate(1,nages,"set_sel_cHL_D_2");
  set_selpar_logit_Age2_cHL_D2.allocate(1,7,"set_selpar_logit_Age2_cHL_D2");
  set_selpar_A502_cHL_D3.allocate(1,7,"set_selpar_A502_cHL_D3");
  set_selpar_Age1_cHL_D2.allocate("set_selpar_Age1_cHL_D2");
  set_selpar_A50_cHL_D3.allocate("set_selpar_A50_cHL_D3");
  set_selpar_slope_cHL_D3.allocate("set_selpar_slope_cHL_D3");
  set_selpar_slope2_cHL_D3.allocate("set_selpar_slope2_cHL_D3");
  set_sel_rHB_D_2.allocate(1,nages,"set_sel_rHB_D_2");
  set_sel_rHB_D_3.allocate(1,nages,"set_sel_rHB_D_3");
  set_selpar_Age1_rHB_D3.allocate("set_selpar_Age1_rHB_D3");
  set_sel_rHB_D_4.allocate(1,nages,"set_sel_rHB_D_4");
  set_selpar_Age1_rHB_D4.allocate("set_selpar_Age1_rHB_D4");
  set_selpar_logit_Age2_rHB_D3.allocate(1,7,"set_selpar_logit_Age2_rHB_D3");
  set_selpar_logit_Age2_rHB_D4.allocate(1,7,"set_selpar_logit_Age2_rHB_D4");
  ...
  set_log_q_cpue_sFT.allocate(1,7,"set_log_q_cpue_sFT");
  ...
  set_log_dev_vals_F_L__cOT.allocate(styr_L_cOT,endyr_L_cOT,"set_log_dev_vals_F_L__cOT");
  set_log_dev_vals_F_L__cTW.allocate(styr_L_cTW,endyr_L_cTW,"set_log_dev_vals_F_L__cTW");
  ...
  set_w_cpue_sFT.allocate("set_w_cpue_sFT");
  ...
  set_w_lenc_sFT.allocate("set_w_lenc_sFT");
  ...
  lenpar_TL2FL_a.allocate("lenpar_TL2FL_a");
  lenpar_TL2FL_b.allocate("lenpar_TL2FL_b");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  #endif
  lenprob_sFT.allocate(1,nages,1,nlenbins,"lenprob_sFT");
  #ifndef NO_AD_INITIALIZE
    lenprob_sFT.initialize();
  #endif
  ...
  #endif
  pred_sFT_lenc.allocate(1,nyr_lenc_sFT,1,nlenbins,"pred_sFT_lenc");
  #ifndef NO_AD_INITIALIZE
    pred_sFT_lenc.initialize();
  #endif
  ...
  #endif
  nsamp_sFT_lenc_allyr.allocate(styr,endyr,"nsamp_sFT_lenc_allyr");
  #ifndef NO_AD_INITIALIZE
    nsamp_sFT_lenc_allyr.initialize();
  #endif
  ...
  #endif
  nfish_sFT_lenc_allyr.allocate(styr,endyr,"nfish_sFT_lenc_allyr");
  #ifndef NO_AD_INITIALIZE
    nfish_sFT_lenc_allyr.initialize();
  #endif
  ...
  #endif
  neff_cHL_D_lenc_allyr.allocate(styr,endyr,"neff_cHL_D_lenc_allyr");
  #ifndef NO_AD_INITIALIZE
    neff_cHL_D_lenc_allyr.initialize();
  #endif
  neff_sFT_lenc_allyr.allocate(styr,endyr,"neff_sFT_lenc_allyr");
  #ifndef NO_AD_INITIALIZE
    neff_sFT_lenc_allyr.initialize();
  #endif
  ...
  #endif
  sel_sFT.allocate(styr,endyr,1,nages,"sel_sFT");
  #ifndef NO_AD_INITIALIZE
    sel_sFT.initialize();
  #endif
  ...
  selpar_logit_Age1_sCT.allocate(selpar_Age1_sCT_logit_LO,selpar_Age1_sCT_logit_HI,selpar_Age1_sCT_logit_PH,"selpar_logit_Age1_sCT");
  selpar_logit_Age2_sCT.allocate(selpar_Age2_sCT_logit_LO,selpar_Age2_sCT_logit_HI,selpar_Age2_sCT_logit_PH,"selpar_logit_Age2_sCT");
  selpar_Age2_sCT.allocate("selpar_Age2_sCT");
  #ifndef NO_AD_INITIALIZE
  selpar_Age2_sCT.initialize();
  #endif
  selpar_Age1_sCT.allocate("selpar_Age1_sCT");
  #ifndef NO_AD_INITIALIZE
  selpar_Age1_sCT.initialize();
  #endif
  ...
  #endif
  selpar_Age1_sCT_logit_out.allocate(1,8,"selpar_Age1_sCT_logit_out");
  #ifndef NO_AD_INITIALIZE
    selpar_Age1_sCT_logit_out.initialize();
  #endif
  selpar_Age2_sCT_logit_out.allocate(1,8,"selpar_Age2_sCT_logit_out");
  #ifndef NO_AD_INITIALIZE
    selpar_Age2_sCT_logit_out.initialize();
  #endif
  ...
  selpar_A502_cHL1.allocate("selpar_A502_cHL1");
  #ifndef NO_AD_INITIALIZE
  selpar_A502_cHL1.initialize();
  #endif
  selpar_slope2_cHL1.allocate("selpar_slope2_cHL1");
  #ifndef NO_AD_INITIALIZE
  selpar_slope2_cHL1.initialize();
  #endif
  ...
  selpar_A502_cHL2.allocate("selpar_A502_cHL2");
  #ifndef NO_AD_INITIALIZE
  selpar_A502_cHL2.initialize();
  #endif
  selpar_slope2_cHL2.allocate("selpar_slope2_cHL2");
  #ifndef NO_AD_INITIALIZE
  selpar_slope2_cHL2.initialize();
  #endif
  ...
  #endif
  selpar_Age1_cHL_D2.allocate("selpar_Age1_cHL_D2");
  #ifndef NO_AD_INITIALIZE
  selpar_Age1_cHL_D2.initialize();
  #endif
  selpar_Age2_cHL_D2.allocate("selpar_Age2_cHL_D2");
  #ifndef NO_AD_INITIALIZE
  selpar_Age2_cHL_D2.initialize();
  #endif
  selpar_A50_cHL_D3.allocate("selpar_A50_cHL_D3");
  #ifndef NO_AD_INITIALIZE
  selpar_A50_cHL_D3.initialize();
  #endif
  selpar_slope_cHL_D3.allocate("selpar_slope_cHL_D3");
  #ifndef NO_AD_INITIALIZE
  selpar_slope_cHL_D3.initialize();
  #endif
  selpar_slope2_cHL_D3.allocate("selpar_slope2_cHL_D3");
  #ifndef NO_AD_INITIALIZE
  selpar_slope2_cHL_D3.initialize();
  #endif
  sel_cHL_D_2.allocate(1,nages,"sel_cHL_D_2");
  #ifndef NO_AD_INITIALIZE
    sel_cHL_D_2.initialize();
  #endif
  sel_cHL_D_3.allocate(1,nages,"sel_cHL_D_3");
  #ifndef NO_AD_INITIALIZE
    sel_cHL_D_3.initialize();
  #endif
  selpar_logit_Age2_cHL_D2.allocate(selpar_Age2_cHL_D2_logit_LO,selpar_Age2_cHL_D2_logit_HI,selpar_Age2_cHL_D2_logit_PH,"selpar_logit_Age2_cHL_D2");
  selpar_A502_cHL_D3.allocate(selpar_A502_cHL_D3_LO,selpar_A502_cHL_D3_HI,selpar_A502_cHL_D3_PH,"selpar_A502_cHL_D3");
  selpar_Age2_cHL_D2_logit_out.allocate(1,8,"selpar_Age2_cHL_D2_logit_out");
  #ifndef NO_AD_INITIALIZE
    selpar_Age2_cHL_D2_logit_out.initialize();
  #endif
  selpar_A502_cHL_D3_out.allocate(1,8,"selpar_A502_cHL_D3_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A502_cHL_D3_out.initialize();
  #endif
  ...
  #endif
  selpar_A50_cOT1.allocate(selpar_A50_cOT1_LO,selpar_A50_cOT1_HI,selpar_A50_cOT1_PH,"selpar_A50_cOT1");
  selpar_slope_cOT1.allocate(selpar_slope_cOT1_LO,selpar_slope_cOT1_HI,selpar_slope_cOT1_PH,"selpar_slope_cOT1");
  selpar_A502_cOT1.allocate(selpar_A502_cOT1_LO,selpar_A502_cOT1_HI,selpar_A502_cOT1_PH,"selpar_A502_cOT1");
  selpar_slope2_cOT1.allocate(selpar_slope2_cOT1_LO,selpar_slope2_cOT1_HI,selpar_slope2_cOT1_PH,"selpar_slope2_cOT1");
  selpar_A50_cOT2.allocate("selpar_A50_cOT2");
  #ifndef NO_AD_INITIALIZE
  selpar_A50_cOT2.initialize();
  #endif
  selpar_slope_cOT2.allocate("selpar_slope_cOT2");
  #ifndef NO_AD_INITIALIZE
  selpar_slope_cOT2.initialize();
  #endif
  selpar_A502_cOT2.allocate("selpar_A502_cOT2");
  #ifndef NO_AD_INITIALIZE
  selpar_A502_cOT2.initialize();
  #endif
  selpar_slope2_cOT2.allocate("selpar_slope2_cOT2");
  #ifndef NO_AD_INITIALIZE
  selpar_slope2_cOT2.initialize();
  #endif
  selpar_A50_cOT1_out.allocate(1,8,"selpar_A50_cOT1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A50_cOT1_out.initialize();
  #endif
  selpar_slope_cOT1_out.allocate(1,8,"selpar_slope_cOT1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope_cOT1_out.initialize();
  #endif
  selpar_A502_cOT1_out.allocate(1,8,"selpar_A502_cOT1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A502_cOT1_out.initialize();
  #endif
  selpar_slope2_cOT1_out.allocate(1,8,"selpar_slope2_cOT1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope2_cOT1_out.initialize();
  #endif
  ...
  #endif
  sel_rHB_block4.allocate(1,nages,"sel_rHB_block4");
  #ifndef NO_AD_INITIALIZE
  ...
  selpar_A502_rHB4.allocate(selpar_A502_rHB4_LO,selpar_A502_rHB4_HI,selpar_A502_rHB4_PH,"selpar_A502_rHB4");
  selpar_slope2_rHB4.allocate(selpar_slope2_rHB4_LO,selpar_slope2_rHB4_HI,selpar_slope2_rHB4_PH,"selpar_slope2_rHB4");
  ...
  #endif
  selpar_A502_rHB4_out.allocate(1,8,"selpar_A502_rHB4_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A502_rHB4_out.initialize();
  #endif
  selpar_slope2_rHB4_out.allocate(1,8,"selpar_slope2_rHB4_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope2_rHB4_out.initialize();
  #endif
  sel_rHB_D.allocate(styr,endyr,1,nages,"sel_rHB_D");
  #ifndef NO_AD_INITIALIZE
    sel_rHB_D.initialize();
  #endif
  selpar_Age1_rHB_D3.allocate("selpar_Age1_rHB_D3");
  #ifndef NO_AD_INITIALIZE
  selpar_Age1_rHB_D3.initialize();
  #endif
  selpar_Age1_rHB_D4.allocate("selpar_Age1_rHB_D4");
  #ifndef NO_AD_INITIALIZE
  selpar_Age1_rHB_D4.initialize();
  #endif
  selpar_Age2_rHB_D3.allocate("selpar_Age2_rHB_D3");
  #ifndef NO_AD_INITIALIZE
  selpar_Age2_rHB_D3.initialize();
  #endif
  selpar_Age2_rHB_D4.allocate("selpar_Age2_rHB_D4");
  #ifndef NO_AD_INITIALIZE
  selpar_Age2_rHB_D4.initialize();
  #endif
  selpar_logit_Age2_rHB_D3.allocate(selpar_Age2_rHB_D3_logit_LO,selpar_Age2_rHB_D3_logit_HI,selpar_Age2_rHB_D3_logit_PH,"selpar_logit_Age2_rHB_D3");
  selpar_logit_Age2_rHB_D4.allocate(selpar_Age2_rHB_D4_logit_LO,selpar_Age2_rHB_D4_logit_HI,selpar_Age2_rHB_D4_logit_PH,"selpar_logit_Age2_rHB_D4");
  ...
  #endif
  selpar_Age2_rHB_D3_logit_out.allocate(1,8,"selpar_Age2_rHB_D3_logit_out");
  #ifndef NO_AD_INITIALIZE
    selpar_Age2_rHB_D3_logit_out.initialize();
  #endif
  selpar_Age2_rHB_D4_logit_out.allocate(1,8,"selpar_Age2_rHB_D4_logit_out");
  #ifndef NO_AD_INITIALIZE
    selpar_Age2_rHB_D4_logit_out.initialize();
  #endif
  ...
  #endif
  sel_rGN_block4.allocate(1,nages,"sel_rGN_block4");
  #ifndef NO_AD_INITIALIZE
  ...
  selpar_A502_rGN3.allocate(selpar_A502_rGN3_LO,selpar_A502_rGN3_HI,selpar_A502_rGN3_PH,"selpar_A502_rGN3");
  selpar_slope2_rGN3.allocate(selpar_slope2_rGN3_LO,selpar_slope2_rGN3_HI,selpar_slope2_rGN3_PH,"selpar_slope2_rGN3");
  ...
  selpar_A502_rGN4.allocate(selpar_A502_rGN4_LO,selpar_A502_rGN4_HI,selpar_A502_rGN4_PH,"selpar_A502_rGN4");
  selpar_slope2_rGN4.allocate(selpar_slope2_rGN4_LO,selpar_slope2_rGN4_HI,selpar_slope2_rGN4_PH,"selpar_slope2_rGN4");
  ...
  #endif
  selpar_A502_rGN3_out.allocate(1,8,"selpar_A502_rGN3_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A502_rGN3_out.initialize();
  #endif
  selpar_slope2_rGN3_out.allocate(1,8,"selpar_slope2_rGN3_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope2_rGN3_out.initialize();
  #endif
  ...
  #endif
  selpar_A502_rGN4_out.allocate(1,8,"selpar_A502_rGN4_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A502_rGN4_out.initialize();
  #endif
  selpar_slope2_rGN4_out.allocate(1,8,"selpar_slope2_rGN4_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope2_rGN4_out.initialize();
  #endif
  ...
  N_rGN.allocate(styr_cpue_rGN,endyr_cpue_rGN,1,nages,"N_rGN");
    ...
    N_rGN.initialize();
  #endif
  pred_sFT_cpue.allocate(styr_cpue_sFT,endyr_cpue_sFT,"pred_sFT_cpue");
  #ifndef NO_AD_INITIALIZE
    pred_sFT_cpue.initialize();
  #endif
  N_sFT.allocate(styr_cpue_sFT,endyr_cpue_sFT,1,nages,"N_sFT");
  #ifndef NO_AD_INITIALIZE
    N_sFT.initialize();
  #endif
  ...
  log_q_cpue_sFT.allocate(log_q_sFT_LO,log_q_sFT_HI,log_q_sFT_PH,"log_q_cpue_sFT");
  ...
  #endif
  log_q_sFT_out.allocate(1,8,"log_q_sFT_out");
  #ifndef NO_AD_INITIALIZE
    log_q_sFT_out.initialize();
  #endif
  ...
  q_RW_log_dev_sFT.allocate(styr_cpue_sFT,endyr_cpue_sFT-1,"q_RW_log_dev_sFT");
  #ifndef NO_AD_INITIALIZE
  ...
  q_rGN.allocate(styr_cpue_rGN,endyr_cpue_rGN,"q_rGN");
    ...
    q_rGN.initialize();
  #endif
  q_sFT.allocate(styr_cpue_sFT,endyr_cpue_sFT,"q_sFT");
  #ifndef NO_AD_INITIALIZE
    q_sFT.initialize();
  #endif
  ...
  #endif
  F_cTW_prop.allocate("F_cTW_prop");
  #ifndef NO_AD_INITIALIZE
  F_cTW_prop.initialize();
  #endif
  ...
  #endif
  sdnr_lc_sFT.allocate("sdnr_lc_sFT");
  #ifndef NO_AD_INITIALIZE
  sdnr_lc_sFT.initialize();
  #endif
  ...
  #endif
  sdnr_I_sFT.allocate("sdnr_I_sFT");
  #ifndef NO_AD_INITIALIZE
  sdnr_I_sFT.initialize();
  #endif
  ...
  #endif
  w_cpue_sFT.allocate("w_cpue_sFT");
  #ifndef NO_AD_INITIALIZE
  w_cpue_sFT.initialize();
  #endif
  ...
  #endif
  w_lenc_sFT.allocate("w_lenc_sFT");
  #ifndef NO_AD_INITIALIZE
  w_lenc_sFT.initialize();
  #endif
  ...
  #endif
  f_sFT_cpue.allocate("f_sFT_cpue");
  #ifndef NO_AD_INITIALIZE
  f_sFT_cpue.initialize();
  #endif
  ...
  #endif
  f_sFT_lenc.allocate("f_sFT_lenc");
  #ifndef NO_AD_INITIALIZE
  f_sFT_lenc.initialize();
  #endif
...
void model_parameters::preliminary_calculations(void)
{
 ...
 //w_agec_sCT=set_w_agec_sCT;  
  ...
  log_dev_F_L_cTW=set_log_dev_vals_F_L__cTW;
