...
open_r_info_list("parms", false);
	...
	wrt_r_item("q.sFT", mfexp(log_q_cpue_sFT));
	...
	wrt_r_item("F.prop.cOT", F_cOT_prop);
    wrt_r_item("F.prop.cTW", F_cTW_prop);	
...
open_r_df("parm.cons",1,8,2);
    ...
    //wrt_r_df_col("log.dm.cOT.lc",log_dm_cOT_lc_out);
    //wrt_r_df_col("log.dm.rHB.lc",log_dm_rHB_lc_out); //why was this already commented out from vs49  KC
    //wrt_r_df_col("log.dm.rGN.lc",log_dm_rGN_lc_out);
    wrt_r_df_col("log.dm.lenc.rHB.D",log_dm_rHB_D_lc_out);
    wrt_r_df_col("log.dm.lenc.cHL.D",log_dm_cHL_D_lc_out);
    ////wrt_r_df_col("log.dm.sCT.lc",log_dm_sCT_lc_out);
    //wrt_r_df_col("log.dm.sFT.lc",log_dm_sFT_lc_out);
    ...
    //wrt_r_df_col("selpar.A50.cTW",selpar_A50_cTW_out);
    //wrt_r_df_col("selpar.slope.cTW",selpar_slope_cTW_out);
	
    //wrt_r_df_col("selpar.A50.cOT1",selpar_A50_cOT1_out);
    //wrt_r_df_col("selpar.slope1.cOT1",selpar_slope_cOT1_out);
	//wrt_r_df_col("selpar.A502.cOT1",selpar_A502_cOT1_out);
	//wrt_r_df_col("selpar.slope2.cOT1",selpar_slope2_cOT1_out);
	
    wrt_r_df_col("selpar.A50.rHB1",selpar_A50_rHB1_out);
    wrt_r_df_col("selpar.slope.rHB1",selpar_slope_rHB1_out);
	wrt_r_df_col("selpar.A502.rHB1",selpar_A502_rHB1_out);
	...
	wrt_r_df_col("selpar.A502.rHB2",selpar_A50_rHB2_out);
    wrt_r_df_col("selpar.slope2.rHB2",selpar_slope_rHB2_out);
	wrt_r_df_col("selpar.A50.rHB3",selpar_A50_rHB3_out);
    wrt_r_df_col("selpar.slope.rHB3",selpar_slope_rHB3_out);
	wrt_r_df_col("selpar.A502.rHB3",selpar_A502_rHB3_out);
    wrt_r_df_col("selpar.slope2.rHB3",selpar_slope2_rHB3_out);
	wrt_r_df_col("selpar.A50.rHB4",selpar_A50_rHB4_out);
    wrt_r_df_col("selpar.slope.rHB4",selpar_slope_rHB4_out);
	wrt_r_df_col("selpar.A502.rHB4",selpar_A502_rHB4_out);
    wrt_r_df_col("selpar.slope2.rHB4",selpar_slope2_rHB4_out);
	...
	wrt_r_df_col("selpar.A502.rGN3",selpar_A502_rGN3_out);
    wrt_r_df_col("selpar.slope2.rGN3",selpar_slope2_rGN3_out);
	wrt_r_df_col("selpar.A50.rGN4",selpar_A50_rGN4_out);
    wrt_r_df_col("selpar.slope.rGN4",selpar_slope_rGN4_out);
	wrt_r_df_col("selpar.A502.rGN4",selpar_A502_rGN4_out);
    wrt_r_df_col("selpar.slope2.rGN4",selpar_slope2_rGN4_out);
	...
	//wrt_r_df_col("selpar.logit.Age1.sCT",selpar_Age1_sCT_logit_out);
	//wrt_r_df_col("selpar.logit.Age2.sCT",selpar_Age2_sCT_logit_out);
    ...
    //KC wrt_r_df_col("selpar.logit.Age2.cHL.D2",selpar_Age2_cHL_D2_logit_out);
    //KC wrt_r_df_col("selpar.A502.cHL.D3",selpar_A502_cHL_D3_out);

    //KC wrt_r_df_col("selpar.logit.Age2.rHB.D3",selpar_Age2_rHB_D3_logit_out);
    //KC wrt_r_df_col("selpar.logit.Age2.rHB.D4",selpar_Age2_rHB_D4_logit_out);
	...
	wrt_r_df_col("log.q.cpue.sFT",log_q_sFT_out);
	wrt_r_df_col("log.q.cpue.sCT",log_q_sCT_out);
    wrt_r_df_col("M.constant",M_constant_out);
    wrt_r_df_col("log.avg.F.L.cHL",log_avg_F_cHL_out);
	wrt_r_df_col("log.avg.F.L.cOT",log_avg_F_cOT_out);
...
open_r_df("parm.tvec", styr, endyr, 2);
	...
	wrt_r_df_col("log.F.dev.cOT", log_F_dev_cOT_out);
	...
	wrt_r_df_col("log.q.dev.rGN.RWq", q_RW_log_dev_rGN);
...
open_r_df("parm.tvec.cons",1,3,2);
	...
	wrt_r_df_col("log.F.dev.cOT",set_log_dev_F_L_cOT);
	...
	wrt_r_df_col("log.q.dev.cHL.RWq", set_log_dev_RWq);
        wrt_r_df_col("log.q.dev.rGN.RWq", set_log_dev_RWq);
close_r_df();
...
open_r_vector("sdnr");
	...
	wrt_r_item("sdnr.U.sFT", sdnr_I_sFT);
	wrt_r_item("sdnr.U.sCT", sdnr_I_sCT);
	
    //wrt_r_item("sdnr.lc.cHL", sdnr_lc_cHL);
    //wrt_r_item("sdnr.lc.cOT", sdnr_lc_cOT);	
    //wrt_r_item("sdnr.lc.rHB", sdnr_lc_rHB);
    //wrt_r_item("sdnr.lc.rGN", sdnr_lc_rGN);	
    //wrt_r_item("sdnr.lc.rHB.D", sdnr_lc_rHB_D);
	//wrt_r_item("sdnr.lc.cHL.D", sdnr_lc_cHL_D);
	//wrt_r_item("sdnr.lc.sCT", sdnr_lc_sCT);
	//wrt_r_item("sdnr.lc.sFT", sdnr_lc_sFT);
...
open_r_vector("like");
	...
	wrt_r_item("lk.U.sFT", f_sFT_cpue);
	wrt_r_item("lk.U.sCT", f_sCT_cpue);
    wrt_r_item("lk.lenc.cHL", f_cHL_lenc);
    wrt_r_item("lk.lenc.cOT", f_cOT_lenc);	
	//wrt_r_item("lk.lenc.rHB", f_rHB_lenc);
	//wrt_r_item("lk.lenc.rGN", f_rGN_lenc);	
	wrt_r_item("lk.lenc.rHB.D", f_rHB_D_lenc);
	wrt_r_item("lk.lenc.cHL.D", f_cHL_D_lenc);
	//wrt_r_item("lk.lenc.sCT", f_sCT_lenc);
	wrt_r_item("lk.lenc.sFT", f_sFT_lenc);	
    ...
    wrt_r_item("w.U.sFT", w_cpue_sFT);
	wrt_r_item("w.U.sCT", w_cpue_sCT);
	
    //wrt_r_item("w.lc.cHL", w_lenc_cHL);
    //wrt_r_item("w.lc.cOT", w_lenc_cOT);	
	//wrt_r_item("w.lc.rHB", w_lc_rHB);
	//wrt_r_item("w.lc.rGN", w_lc_rGN);
    //wrt_r_item("w.lc.rHB.D", w_lenc_rHB_D);
	//wrt_r_item("w.lc.cHL.D", w_lenc_cHL_D);
	//wrt_r_item("w.lc.sCT", w_lc_sCT);
	//wrt_r_item("w.lc.sFT", w_lenc_sFT);
	//
...
open_r_list("size.age.fishery");
    ...
    open_r_matrix("len.cOT.mm");
    wrt_r_matrix(len_cOT_mm, 2, 2);
    wrt_r_namevector(styr,endyr);
    wrt_r_namevector(agebins);
    close_r_matrix();
	...
	open_r_matrix("wholewgt.cOT.lb");
    wrt_r_matrix(wholewgt_cOT_klb*1000.0, 2, 2);
    wrt_r_namevector(styr,endyr);
    wrt_r_namevector(agebins);
    close_r_matrix();

	open_r_matrix("wholewgt.cTW.lb");
    wrt_r_matrix(wholewgt_cTW_klb*1000.0, 2, 2);
    wrt_r_namevector(styr,endyr);
    wrt_r_namevector(agebins);
    close_r_matrix();
...
open_r_list("sel.age");
	...
	open_r_matrix("sel.m.cOT");
    wrt_r_matrix(sel_cOT, 2, 2);
    wrt_r_namevector(styr,endyr);
    wrt_r_namevector(agebins);
    close_r_matrix();
  ...
  // close_r_matrix();
    ...
    open_r_matrix("sel.m.sFT");
    wrt_r_matrix(sel_sFT, 2, 2);
    wrt_r_namevector(styr,endyr);
    wrt_r_namevector(agebins);
    close_r_matrix();
    ...
    open_r_matrix("sel.m.cHL.D");
    wrt_r_matrix(sel_cHL_D, 2, 2);
    wrt_r_namevector(styr,endyr);
    wrt_r_namevector(agebins);
    close_r_matrix();
...
open_r_list("comp.mats");
    ...
    open_r_matrix("lcomp.cOT.ob");
    wrt_r_matrix(obs_lenc_cOT, 2, 2);
    wrt_r_namevector(yrs_lenc_cOT);
    wrt_r_namevector(lenbins);
    close_r_matrix();
    
    open_r_matrix("lcomp.cOT.pr");
    wrt_r_matrix(pred_cOT_lenc, 2, 2);
    wrt_r_namevector(yrs_lenc_cOT);
    wrt_r_namevector(lenbins);
    close_r_matrix();
   ...
   // close_r_matrix();
	...
	open_r_matrix("lcomp.cHL.D.ob");
    wrt_r_matrix(obs_lenc_cHL_D, 2, 2);
    wrt_r_namevector(yrs_lenc_cHL_D);
    wrt_r_namevector(lenbins);
    close_r_matrix();

    open_r_matrix("lcomp.cHL.D.pr");
    wrt_r_matrix(pred_cHL_D_lenc, 2, 2);
    wrt_r_namevector(yrs_lenc_cHL_D);
    wrt_r_namevector(lenbins);
    close_r_matrix();
	
	//open_r_matrix("lcomp.sCT.ob");
    //wrt_r_matrix(obs_sCT_lenc, 2, 2);
    //wrt_r_namevector(yrs_sCT_lenc);
    //wrt_r_namevector(lenbins);
    //close_r_matrix();

    //open_r_matrix("lcomp.sCT.pr");
    //wrt_r_matrix(pred_sCT_lenc, 2, 2);
    //wrt_r_namevector(yrs_sCT_lenc);
    //wrt_r_namevector(lenbins);
    //close_r_matrix();
	
	open_r_matrix("lcomp.sFT.ob");
    wrt_r_matrix(obs_lenc_sFT, 2, 2);
    wrt_r_namevector(yrs_lenc_sFT);
    wrt_r_namevector(lenbins);
    close_r_matrix();
    
    open_r_matrix("lcomp.sFT.pr");
    wrt_r_matrix(pred_sFT_lenc, 2, 2);
    wrt_r_namevector(yrs_lenc_sFT);
    wrt_r_namevector(lenbins);
    close_r_matrix();
...
open_r_df("t.series", styr, (endyr+1), 2);
	...
	wrt_r_df_col("cv.unwgted.U.rGN", obs_cv_cpue_rGN);

	wrt_r_df_col("U.sFT.ob", obs_cpue_sFT);
    wrt_r_df_col("U.sFT.pr", pred_sFT_cpue);
   	wrt_r_df_col("cv.U.sFT", obs_cv_cpue_sFT/w_cpue_sFT);
	wrt_r_df_col("cv.unwgted.U.sFT", obs_cv_cpue_sFT);
	
	wrt_r_df_col("U.sTV.ob", obs_cpue_sCT);
    wrt_r_df_col("U.sTV.pr", pred_sCT_cpue);
   	wrt_r_df_col("cv.U.sTV", obs_cv_cpue_sCT/w_cpue_sCT);
	wrt_r_df_col("cv.unwgted.U.sTV", obs_cv_cpue_sCT);
	...
	wrt_r_df_col("q.sFT", q_sFT);
    wrt_r_df_col("q.sFT.RW.log.dev",q_RW_log_dev_sFT);

	wrt_r_df_col("q.sTV", q_sCT);
    ...
    wrt_r_df_col("L.cOT.ob", obs_L_cOT);
    wrt_r_df_col("L.cOT.pr", pred_cOT_L_klb);
    wrt_r_df_col("cv.L.cOT", obs_cv_L_cOT);
	...
	wrt_r_df_col("lcomp.cOT.n", nsamp_cOT_lenc_allyr);
	...
	wrt_r_df_col("lcomp.cHL.D.n", nsamp_cHL_D_lenc_allyr);
	//wrt_r_df_col("lcomp.sCT.n", nsamp_sCT_lenc_allyr);
	wrt_r_df_col("lcomp.sFT.n", nsamp_sFT_lenc_allyr);
	...
	wrt_r_df_col("lcomp.cOT.nfish", nfish_cOT_lenc_allyr);
	...
	wrt_r_df_col("lcomp.cHL.D.nfish", nfish_cHL_D_lenc_allyr);
	//wrt_r_df_col("lcomp.sCT.nfish", nfish_sCT_lenc_allyr);
	wrt_r_df_col("lcomp.sFT.nfish", nfish_sFT_lenc_allyr);
	...
	//wrt_r_df_col("lcomp.cOT.neff", (1+nsamp_cOT_lenc_allyr*exp(log_dm_cOT_lc_out(8)))/(1+exp(log_dm_cOT_lc_out(8))) );
	...
	wrt_r_df_col("lcomp.cHL.D.neff", (1+nsamp_cHL_D_lenc_allyr*exp(log_dm_cHL_D_lc_out(8)))/(1+exp(log_dm_cHL_D_lc_out(8))) );
	////wrt_r_df_col("lcomp.sCT.neff", (1+nsamp_sCT_lenc_allyr*exp(log_dm_sCT_lc_out(8)))/(1+exp(log_dm_sCT_lc_out(8))) );
	//wrt_r_df_col("lcomp.sFT.neff", (1+nsamp_sFT_lenc_allyr*exp(log_dm_sFT_lc_out(8)))/(1+exp(log_dm_sFT_lc_out(8))) );
...
open_r_df("LD.pr.tseries", styr, endyr, 2);
    ...
    wrt_r_df_col("L.cOT.klb", pred_cOT_L_klb);
    wrt_r_df_col("L.cOT.knum", pred_cOT_L_knum);	
...
close_r_df();
 ...
 open_r_list("CLD.est.mats");
	 ...
	 open_r_matrix("Lw.cOT");
         wrt_r_matrix(L_cOT_klb, 1,1);
     close_r_matrix();
	 ...
	 open_r_matrix("Ln.cOT");
         wrt_r_matrix(L_cOT_num, 1,1);
     close_r_matrix();
