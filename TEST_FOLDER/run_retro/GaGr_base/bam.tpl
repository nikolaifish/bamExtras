...
// Length Compositions 
//KC init_int nyr_sVD_lenc;
//KC init_ivector yrs_sVD_lenc(1,nyr_sVD_lenc);
//KC init_vector nsamp_sVD_lenc(1,nyr_sVD_lenc);
//KC init_vector nfish_sVD_lenc(1,nyr_sVD_lenc);
//KC init_matrix obs_sVD_lenc(1,nyr_sVD_lenc,1,nlenbins);
...
//KC init_int nyr_cHL_lenc;
//KC init_ivector yrs_cHL_lenc(1,nyr_cHL_lenc);
//KC init_vector nsamp_cHL_lenc(1,nyr_cHL_lenc);
//KC init_vector nfish_cHL_lenc(1,nyr_cHL_lenc);
//KC init_matrix obs_cHL_lenc(1,nyr_cHL_lenc,1,nlenbins);
...
// !!cout <<styr_L_cHL<<endl;
// !!cout <<endyr_L_cHL<<endl;
// !!cout <<obs_L_cHL<<endl;
//!!cout <<obs_cv_L_cHL<<endl;
//!!cout <<nyr_cHL_lenc<<endl;
//!!cout <<yrs_cHL_lenc<<endl;
//!!cout <<nyr_agec_cHL<<endl;
...
init_int styr_L_cDV;
init_int endyr_L_cDV;
init_vector obs_L_cDV(styr_L_cDV,endyr_L_cDV);
init_vector obs_cv_L_cDV(styr_L_cDV,endyr_L_cDV);

// Comm dive length compositions (3 cm bins)
//KC init_int nyr_cDV_lenc;
//KC init_ivector yrs_cDV_lenc(1,nyr_cDV_lenc);
//KC init_vector nsamp_cDV_lenc(1,nyr_cDV_lenc);
//KCinit_vector nfish_cDV_lenc(1,nyr_cDV_lenc);
//KC init_matrix obs_cDV_lenc(1,nyr_cDV_lenc,1,nlenbins);

// Comm dive age compositions
init_int nyr_agec_cDV;
init_ivector yrs_agec_cDV(1,nyr_agec_cDV);
init_vector nsamp_agec_cDV(1,nyr_agec_cDV);
init_vector nfish_agec_cDV(1,nyr_agec_cDV);
init_matrix obs_agec_cDV(1,nyr_agec_cDV,1,nages_agec);
...
//!!cout <<nyr_lenc_rHB_D<<endl;
//###################General Recreational fleet ##########################################
// // rGN CPUE
// init_int styr_rGN_cpue;                                             
// init_int endyr_rGN_cpue;                                            
// init_vector obs_rGN_cpue(styr_rGN_cpue,endyr_rGN_cpue);//Observed CPUE
// init_vector rGN_cpue_cv(styr_rGN_cpue,endyr_rGN_cpue); //CV of cpue
...
//KC init_int nyr_rGN_lenc;
//KC init_ivector yrs_rGN_lenc(1,nyr_rGN_lenc);
//KC init_vector nsamp_rGN_lenc(1,nyr_rGN_lenc);
//KC init_vector nfish_rGN_lenc(1,nyr_rGN_lenc);
//KC init_matrix obs_rGN_lenc(1,nyr_rGN_lenc,1,nlenbins);

//rGN Age compositions
...
//KC init_int nyr_rGN_D_lenc;
//KC init_ivector yrs_rGN_D_lenc(1,nyr_rGN_D_lenc);
//KC init_vector nsamp_rGN_D_lenc(1,nyr_rGN_D_lenc);
//KC init_vector nfish_rGN_D_lenc(1,nyr_rGN_D_lenc);
//KC init_matrix obs_rGN_D_lenc(1,nyr_rGN_D_lenc,1,nlenbins);
...
//KC init_vector set_log_dm_cHL_lc(1,7);    //Dirichlet-multinomial overdispersion parameter
//KC init_vector set_log_dm_cDV_lc(1,7);    //Dirichlet-multinomial overdispersion parameter
init_vector set_log_dm_lenc_rHB(1,7);    //Dirichlet-multinomial overdispersion parameter
//KC init_vector set_log_dm_rGN_lc(1,7);    //Dirichlet-multinomial overdispersion parameter
init_vector set_log_dm_lenc_rHB_D(1,7);  //Dirichlet-multinomial overdispersion parameter
//KC init_vector set_log_dm_rGN_D_lc(1,7);  //Dirichlet-multinomial overdispersion parameter
//KC init_vector set_log_dm_sVD_lc(1,7);   //Dirichlet-multinomial overdispersion parameter
init_vector set_log_dm_agec_cHL(1,7);    //Dirichlet-multinomial overdispersion parameter
init_vector set_log_dm_agec_cDV(1,7);    //Dirichlet-multinomial overdispersion parameter
...
init_vector set_selpar_A50_cHL1(1,7);              //KC uncommented
init_vector set_selpar_slope_cHL1(1,7);            //KC uncommented
...
//init_vector set_selpar_A50_cDV1(1,7);
init_vector set_selpar_A50_cDV2(1,7);
//KC init_vector set_selpar_A50_cDV3(1,7);
init_vector set_selpar_slope_cDV2(1,7);
init_vector set_selpar_A502_cDV2(1,7); 
init_vector set_selpar_slope2_cDV2(1,7);
...
init_vector set_selpar_A502_sCT(1,7);           //KC
init_vector set_selpar_slope2_sCT(1,7);         //KC
...
//init_vector set_log_q_rGN(1,7);      //catchability coefficient (log) for rGN index
...
init_vector set_log_avg_F_L_cDV(1,7);
...
init_vector set_log_dev_F_L_cDV(1,3); 
...
init_vector set_log_dev_vals_F_L_cDV(styr_L_cDV,endyr_L_cDV);
...
//init_number set_w_I_rGN;         //weight for rGN index
init_number set_w_cpue_sVD;        //weight for sVD index
//KC init_number set_w_lc_cHL;        //weight for cGN handline len comps
//KC init_number set_w_lc_cDV;        //weight for cGN other len comps
init_number set_w_lenc_rHB;        //weight for headboat len comps
//KC init_number set_w_lc_rGN;		//weight for the recreational length comps
init_number set_w_lenc_rHB_D;		//weight for the headboat discard length comps
//KC init_number set_w_lc_rGN_D;		//weight for the rGN discard length comps
//KC init_number set_w_lc_sVD;		//weight for the SERFS length comps  
init_number set_w_agec_cHL;        //weight for cGN handline age comps
init_number set_w_agec_cDV;        //weight for cGN dive age comps
...
//KC init_number minSS_cHL_lenc;
//KC init_number minSS_cDV_lenc;
init_number minSS_lenc_rHB;
init_number minSS_lenc_rHB_D;
//KC init_number minSS_rGN_lenc;
//KC init_number minSS_rGN_D_lenc;
//KC init_number minSS_sVD_lenc;

//threshold sample sizes for age comps
init_number minSS_agec_cHL;
init_number minSS_agec_cDV
...
PARAMETER_SECTION
 ...
 LOCAL_CALCS
  ...
  //KC const double log_dm_cHL_lc_LO=set_log_dm_cHL_lc(2); const double log_dm_cHL_lc_HI=set_log_dm_cHL_lc(3); const double log_dm_cHL_lc_PH=set_log_dm_cHL_lc(4);
  //KC const double log_dm_cDV_lc_LO=set_log_dm_cDV_lc(2); const double log_dm_cDV_lc_HI=set_log_dm_cDV_lc(3); const double log_dm_cDV_lc_PH=set_log_dm_cDV_lc(4);
  ...
  //KC const double log_dm_rGN_lc_LO=set_log_dm_rGN_lc(2); const double log_dm_rGN_lc_HI=set_log_dm_rGN_lc(3); const double log_dm_rGN_lc_PH=set_log_dm_rGN_lc(4);
  ...
  //KC const double log_dm_rGN_D_lc_LO=set_log_dm_rGN_D_lc(2); const double log_dm_rGN_D_lc_HI=set_log_dm_rGN_D_lc(3); const double log_dm_rGN_D_lc_PH=set_log_dm_rGN_D_lc(4);       //KC
  //KC const double log_dm_sVD_lc_LO=set_log_dm_sVD_lc(2); const double log_dm_sVD_lc_HI=set_log_dm_sVD_lc(3); const double log_dm_sVD_lc_PH=set_log_dm_sVD_lc(4);
  ...
  const double log_dm_cDV_ac_LO=set_log_dm_agec_cDV(2); const double log_dm_cDV_ac_HI=set_log_dm_agec_cDV(3); const double log_dm_cDV_ac_PH=set_log_dm_agec_cDV(4);   //KC
  ...
  const double selpar_A50_cHL1_LO=set_selpar_A50_cHL1(2); const double selpar_A50_cHL1_HI=set_selpar_A50_cHL1(3); const double selpar_A50_cHL1_PH=set_selpar_A50_cHL1(4);       //KC uncommented
  const double selpar_slope_cHL1_LO=set_selpar_slope_cHL1(2); const double selpar_slope_cHL1_HI=set_selpar_slope_cHL1(3); const double selpar_slope_cHL1_PH=set_selpar_slope_cHL1(4);  //KC uncommented
  ...
  //KC const double selpar_A50_cDV3_LO=set_selpar_A50_cDV3(2); const double selpar_A50_cDV3_HI=set_selpar_A50_cDV3(3); const double selpar_A50_cDV3_PH=set_selpar_A50_cDV3(4);
  ...
  const double selpar_A50_rGN2_LO=set_selpar_A50_rGN2(2); const double selpar_A50_rGN2_HI=set_selpar_A50_rGN2(3); const double selpar_A50_rGN2_PH=set_selpar_A50_rGN2(4);              //KC
  const double selpar_slope_rGN2_LO=set_selpar_slope_rGN2(2); const double selpar_slope_rGN2_HI=set_selpar_slope_rGN2(3); const double selpar_slope_rGN2_PH=set_selpar_slope_rGN2(4);   //KC
  ...
  const double log_avg_F_cDV_LO=set_log_avg_F_L_cDV(2); const double log_avg_F_cDV_HI=set_log_avg_F_L_cDV(3); const double log_avg_F_cDV_PH=set_log_avg_F_L_cDV(4);
  ...
  const double log_F_dev_cDV_LO=set_log_dev_F_L_cDV(1); const double log_F_dev_cDV_HI=set_log_dev_F_L_cDV(2); const double log_F_dev_cDV_PH=set_log_dev_F_L_cDV(3);   
...
//KC added section below for the fishery growth curve
  ...
  matrix gutwgt_cHL_klb(styr,endyr,1,nages);      //gutted wgt of commercial handline landings in 1000 lb                  //KC
  ...
  matrix gutwgt_cDV_klb(styr,endyr,1,nages);      //gutted wgt of commercial diving landings in 1000 lb                    //KC
  ...
  matrix gutwgt_rHB_klb(styr,endyr,1,nages);      //gutted wgt of rHB landings in 1000 lb                                   //KC
  ...
  matrix gutwgt_rGN_klb(styr,endyr,1,nages);      //gutted wgt of rGN landings in 1000 lb                                   //KC
  ...
  matrix gutwgt_cHL_D_klb(styr,endyr,1,nages);      //gutted wgt of commercial handline discards in 1000 lb               //KC
  ...
  matrix gutwgt_rHB_D_klb(styr,endyr,1,nages);    //whole wgt of rHB discards in 1000 lb                                  //KC
  ...
  matrix gutwgt_rGN_D_klb(styr,endyr,1,nages);      //gutted wgt of rGN discards in 1000 lb                                 //KC
...
//KC added this section below   
 ...
 //KC  matrix lenprob_cHL(1,nages,1,nlenbins);     //distn of size at age in cHL
 //KC  matrix lenprob_cDV(1,nages,1,nlenbins);     //distn of size at age in cDV
  ...
  //KC matrix lenprob_rGN(1,nages,1,nlenbins);     //distn of size at age in rGN
  //KC matrix lenprob_rGN_D(1,nages,1,nlenbins);   //distn of size at age in rGN discards        //KC
  //KC matrix lenprob_sVD(1,nages,1,nlenbins);    //distn of size at age in sVD  
...
//----Predicted length and age compositions
  //KC matrix pred_cHL_lenc(1,nyr_cHL_lenc,1,nlenbins);
  //KC matrix pred_cDV_lenc(1,nyr_cDV_lenc,1,nlenbins);
  matrix pred_rHB_lenc(1,nyr_lenc_rHB,1,nlenbins);  
  matrix pred_rHB_D_lenc(1,nyr_lenc_rHB_D,1,nlenbins);  
  //KC matrix pred_rGN_lenc(1,nyr_rGN_lenc,1,nlenbins);
  //KC matrix pred_rGN_D_lenc(1,nyr_rGN_D_lenc,1,nlenbins);             //KC
  //KC matrix pred_sVD_lenc(1,nyr_sVD_lenc,1,nlenbins);  
  ...
  matrix pred_cDV_agec(1,nyr_agec_cDV,1,nages_agec);  //KC
  matrix pred_cDV_agec_allages(1,nyr_agec_cDV,1,nages);  //KC
  matrix ErrorFree_cDV_agec(1,nyr_agec_cDV,1,nages);  //KC
  ...
  matrix pred_sCT_agec(1,nyr_agec_sCT,1,nages_agec);      //KC  
...
//Sample size (perhaps adjusted herein) used in fitting comp data
  //KC vector nsamp_cHL_lenc_allyr(styr,endyr);
  //KC vector nsamp_cDV_lenc_allyr(styr,endyr);
  vector nsamp_rHB_lenc_allyr(styr,endyr);
  vector nsamp_rHB_D_lenc_allyr(styr,endyr);   
  //KC vector nsamp_rGN_lenc_allyr(styr,endyr);
  //KC vector nsamp_rGN_D_lenc_allyr(styr,endyr);       //KC
  //KC vector nsamp_sVD_lenc_allyr(styr,endyr);
  
  vector nsamp_cHL_agec_allyr(styr,endyr);
  vector nsamp_cDV_agec_allyr(styr,endyr);         //KC
...
//Nfish used in MCB analysis (not used in fitting)
  //KC vector nfish_cHL_lenc_allyr(styr,endyr);
  //KC vector nfish_cDV_lenc_allyr(styr,endyr);
  vector nfish_rHB_lenc_allyr(styr,endyr);
  vector nfish_rHB_D_lenc_allyr(styr,endyr);  
  //KC vector nfish_rGN_lenc_allyr(styr,endyr);
  //KC vector nfish_rGN_D_lenc_allyr(styr,endyr);       //KC 
  //KC vector nfish_sVD_lenc_allyr(styr,endyr);
  
  vector nfish_cHL_agec_allyr(styr,endyr);
  vector nfish_cDV_agec_allyr(styr,endyr); //KC
...
//Computed effective sample size for output (not used in fitting)
  //KC vector neff_cHL_lenc_allyr(styr,endyr);
  //KC vector neff_cDV_lenc_allyr(styr,endyr);
  vector neff_rHB_lenc_allyr(styr,endyr);
  vector neff_rHB_D_lenc_allyr(styr,endyr);  
  //KC vector neff_rGN_lenc_allyr(styr,endyr);
  //KC vector neff_rGN_D_lenc_allyr(styr,endyr);        //KC
  //KC vector neff_sVD_lenc_allyr(styr,endyr);
  
  vector neff_cHL_agec_allyr(styr,endyr);
  vector neff_cDV_agec_allyr(styr,endyr);  //KC
...
//---Stock-Recruit Function (Beverton-Holt, steepness parameterization)----------
  ...
  //KC init_bounded_number log_dm_cHL_lc(log_dm_cHL_lc_LO,log_dm_cHL_lc_HI,log_dm_cHL_lc_PH);
  //KC init_bounded_number log_dm_cDV_lc(log_dm_cDV_lc_LO,log_dm_cDV_lc_HI,log_dm_cDV_lc_PH);
  init_bounded_number log_dm_lenc_rHB(log_dm_rHB_lc_LO,log_dm_rHB_lc_HI,log_dm_rHB_lc_PH);
  //KC init_bounded_number log_dm_rGN_lc(log_dm_rGN_lc_LO,log_dm_rGN_lc_HI,log_dm_rGN_lc_PH);
  init_bounded_number log_dm_lenc_rHB_D(log_dm_rHB_D_lc_LO,log_dm_rHB_D_lc_HI,log_dm_rHB_D_lc_PH);
  //KC init_bounded_number log_dm_rGN_D_lc(log_dm_rGN_D_lc_LO,log_dm_rGN_D_lc_HI,log_dm_rGN_D_lc_PH);      //KC
  //KC init_bounded_number log_dm_sVD_lc(log_dm_sVD_lc_LO,log_dm_sVD_lc_HI,log_dm_sVD_lc_PH);
  init_bounded_number log_dm_agec_cHL(log_dm_cHL_ac_LO,log_dm_cHL_ac_HI,log_dm_cHL_ac_PH);
  init_bounded_number log_dm_agec_cDV(log_dm_cDV_ac_LO,log_dm_cDV_ac_HI,log_dm_cDV_ac_PH);              //KC
  ...
  //KC vector log_dm_cHL_lc_out(1,8);
  //KC vector log_dm_cDV_lc_out(1,8);
  vector log_dm_rHB_lc_out(1,8);
  //KC vector log_dm_rGN_lc_out(1,8);
  vector log_dm_rHB_D_lc_out(1,8);
  //KC vector log_dm_rGN_D_lc_out(1,8); //KC
  //KC vector log_dm_sVD_lc_out(1,8);
  vector log_dm_cHL_ac_out(1,8);
  vector log_dm_cDV_ac_out(1,8);  //KC
...
//Commercial handline-------------------------------------------------
  ...
  init_bounded_number selpar_A50_cHL1(selpar_A50_cHL1_LO,selpar_A50_cHL1_HI,selpar_A50_cHL1_PH);              //KC added
  init_bounded_number selpar_slope_cHL1(selpar_slope_cHL1_LO,selpar_slope_cHL1_HI,selpar_slope_cHL1_PH);      //KC added
  ...
  vector selpar_A50_cHL1_out(1,8);         //KC added
  vector selpar_slope_cHL1_out(1,8);       //KC added
  ...
  //KC init_bounded_number selpar_A50_cDV3(selpar_A50_cDV3_LO,selpar_A50_cDV3_HI,selpar_A50_cDV3_PH);
  ...
  //KC vector selpar_A50_cDV3_out(1,8);
  ...
  init_bounded_number selpar_A50_rGN2(selpar_A50_rGN2_LO,selpar_A50_rGN2_HI,selpar_A50_rGN2_PH);              //KC
  init_bounded_number selpar_slope_rGN2(selpar_slope_rGN2_LO,selpar_slope_rGN2_HI,selpar_slope_rGN2_PH);      //KC
  ...
  vector selpar_A50_rGN2_out(1,8);  //KC
  vector selpar_slope_rGN2_out(1,8); //KC
...
//SEFIS index selectivity  
  ...
  matrix sel_sVD(styr,endyr,1,nages);     //KC added to map sCT selectivity to sVD selectivity
  vector sel_sVD_vec(1,nages);   //KC added to map sCT selectivity to sVD selectivity
  number selpar_switch_sVD;  //KC added based on KWS code for sVD selectivity
...
////---MSY calcs----------------------------------------------------------------------------
  ...
  number F_init_cHL_prop;  //proportion of F_init attributable to cHL, first X yrs, No diving or discards in initial yrs            //KC
  number F_init_rHB_prop;  //proportion of F_init attributable to rHB, first X yrs                                                  //KC
  number F_init_rGN_prop;  //proportion of F_init attributable to rGN, first X yrs                                                  //KC
...
////--------Mortality------------------------------------------------------------------
  ...
  init_bounded_number log_avg_F_L_cDV(log_avg_F_cDV_LO,log_avg_F_cDV_HI,log_avg_F_cDV_PH);
  vector log_avg_F_cDV_out(1,8);  
  init_bounded_dev_vector log_dev_F_L_cDV(styr_L_cDV,endyr_L_cDV,log_F_dev_cDV_LO,log_F_dev_cDV_HI,log_F_dev_cDV_PH);
  vector log_F_dev_cDV_out(styr_L_cDV,endyr_L_cDV);
...
////-------SDNR output-----------------------------------------------------------------------------
  ...
  //KC number sdnr_lc_cHL;
  //KC number sdnr_lc_cDV;
  number sdnr_lc_rHB;
  number sdnr_lc_rHB_D;
  //KC number sdnr_lc_rGN_D;   //KC
  //KC number sdnr_lc_rGN;  
  //KC number sdnr_lc_sVD; 
 
  number sdnr_ac_cHL;
  number sdnr_ac_cDV;      //KC
  number sdnr_ac_rHB;
  number sdnr_ac_rGN;
  number sdnr_ac_sCT;  
...
////-------Objective function components-----------------------------------------------------------------------------
  ...
  number w_lenc_rHB_D;
  //KC number w_lc_rGN;
  //KC number w_lc_rGN_D;       //KC
  //KC number w_lc_sVD;  
  
  number w_agec_cHL;
  number w_agec_cDV;         //KC
  number w_agec_rHB;
  number w_agec_rGN;  
  number w_agec_sCT; 
  ...
  //KC number f_cHL_lenc;
  //KC number f_cDV_lenc;  
  number f_rHB_lenc;
  number f_rHB_D_lenc;  
  //KC number f_rGN_lenc;
  //KC number f_rGN_D_lenc;     //KC
  //KC number f_sVD_lenc;  
...
// Set values of fixed parameters or set initial guess of estimated parameters
 ...
 //All fisheries
  ...
  //KC log_dm_cHL_lc=set_log_dm_cHL_lc(1);
  //KC log_dm_cDV_lc=set_log_dm_cDV_lc(1);
  log_dm_lenc_rHB=set_log_dm_lenc_rHB(1);
  //KC log_dm_rGN_lc=set_log_dm_rGN_lc(1);
  log_dm_lenc_rHB_D=set_log_dm_lenc_rHB_D(1);
  //KC log_dm_rGN_D_lc=set_log_dm_rGN_D_lc(1);   //KC
  //KC log_dm_sVD_lc=set_log_dm_sVD_lc(1);
  log_dm_agec_cHL=set_log_dm_agec_cHL(1);
  log_dm_agec_cDV=set_log_dm_agec_cDV(1);       //KC
  ...
  //KC w_lc_cHL=set_w_lc_cHL;
  //KC w_lc_cDV=set_w_lc_cDV;  
  w_lenc_rHB=set_w_lenc_rHB;
  w_lenc_rHB_D=set_w_lenc_rHB_D;
  //KC w_lc_rGN=set_w_lc_rGN;
  //KC w_lc_rGN_D=set_w_lc_rGN_D;        //KC
  //KC w_lc_sVD=set_w_lc_sVD;    
    
  w_agec_cHL=set_w_agec_cHL;
  w_agec_cDV=set_w_agec_cDV;            //KC
  ...
  log_avg_F_L_cDV=set_log_avg_F_L_cDV(1);  
  ...
  log_dev_F_L_cDV=set_log_dev_vals_F_L_cDV;
  ...
  selpar_A50_cHL1=set_selpar_A50_cHL1(1);           //KC uncommented
  selpar_slope_cHL1=set_selpar_slope_cHL1(1);       //KC uncommented
  ...
  //KC selpar_A50_cDV3=set_selpar_A50_cDV3(1);
  ...
  selpar_A50_rGN2=set_selpar_A50_rGN2(1);   //KC
  selpar_slope_rGN2=set_selpar_slope_rGN2(1);       //KC
...
//Used primarily for output in R object   
       ...
       //KC nsamp_cHL_lenc_allyr=missing;
       //KC nsamp_cDV_lenc_allyr=missing;  
       nsamp_rHB_lenc_allyr=missing;
       nsamp_rHB_D_lenc_allyr=missing;  
       //KC nsamp_rGN_lenc_allyr=missing;
       //KC nsamp_rGN_D_lenc_allyr=missing;     //KC
       //KC nsamp_sVD_lenc_allyr=missing;	  
       nsamp_cHL_agec_allyr=missing;
       nsamp_cDV_agec_allyr=missing;       //KC
       nsamp_rHB_agec_allyr=missing;
       nsamp_rGN_agec_allyr=missing;  
       nsamp_sCT_agec_allyr=missing;  	  
      
      //KC nfish_cHL_lenc_allyr=missing;
      //KC nfish_cDV_lenc_allyr=missing;  
      nfish_rHB_lenc_allyr=missing;
      nfish_rHB_D_lenc_allyr=missing;  
      //KC nfish_rGN_lenc_allyr=missing;
      //KC nfish_rGN_D_lenc_allyr=missing;      //KC
      //KC nfish_sVD_lenc_allyr=missing;	  
      nfish_cHL_agec_allyr=missing;
      nfish_cDV_agec_allyr=missing;        //KC
      nfish_rHB_agec_allyr=missing;
      nfish_rGN_agec_allyr=missing;  
      nfish_sCT_agec_allyr=missing;  	  
   
//KC      for (iyear=1; iyear<=nyr_cHL_lenc; iyear++)
//KC         {if (nsamp_cHL_lenc(iyear)>=minSS_cHL_lenc)
//KC           {nsamp_cHL_lenc_allyr(yrs_cHL_lenc(iyear))=nsamp_cHL_lenc(iyear);
//KC            nfish_cHL_lenc_allyr(yrs_cHL_lenc(iyear))=nfish_cHL_lenc(iyear);}}
//KC      for (iyear=1; iyear<=nyr_cDV_lenc; iyear++)
//KC         {if (nsamp_cDV_lenc(iyear)>=minSS_cDV_lenc)
//KC           {nsamp_cDV_lenc_allyr(yrs_cDV_lenc(iyear))=nsamp_cDV_lenc(iyear);
//KC            nfish_cDV_lenc_allyr(yrs_cDV_lenc(iyear))=nfish_cDV_lenc(iyear);}}			
...
//KC	  for (iyear=1; iyear<=nyr_rGN_lenc; iyear++)                           
//KC         {if (nsamp_rGN_lenc(iyear)>=minSS_rGN_lenc)
//KC            {nsamp_rGN_lenc_allyr(yrs_rGN_lenc(iyear))=nsamp_rGN_lenc(iyear);
//KC             nfish_rGN_lenc_allyr(yrs_rGN_lenc(iyear))=nfish_rGN_lenc(iyear);}}
//KC              for (iyear=1; iyear<=nyr_rGN_D_lenc; iyear++)                                //KC                    
//KC         {if (nsamp_rGN_D_lenc(iyear)>=minSS_rGN_D_lenc)                                    //KC
//KC            {nsamp_rGN_D_lenc_allyr(yrs_rGN_D_lenc(iyear))=nsamp_rGN_D_lenc(iyear);          //KC
//KC             nfish_rGN_D_lenc_allyr(yrs_rGN_D_lenc(iyear))=nfish_rGN_D_lenc(iyear);}}        //KC
//KC	  for (iyear=1; iyear<=nyr_sVD_lenc; iyear++)                           
//KC         {if (nsamp_sVD_lenc(iyear)>=minSS_sVD_lenc)
//KC            {nsamp_sVD_lenc_allyr(yrs_sVD_lenc(iyear))=nsamp_sVD_lenc(iyear);
//KC             nfish_sVD_lenc_allyr(yrs_sVD_lenc(iyear))=nfish_sVD_lenc(iyear);}}
	  ...
	  for (iyear=1; iyear<=nyr_agec_cHL; iyear++)
         {if (nsamp_agec_cHL(iyear)>=minSS_agec_cHL)
          ...
          for (iyear=1; iyear<=nyr_agec_cDV; iyear++)                              //KC
         {if (nsamp_agec_cDV(iyear)>=minSS_agec_cDV)                                //KC
           {nsamp_cDV_agec_allyr(yrs_agec_cDV(iyear))=nsamp_agec_cDV(iyear);         //KC
            nfish_cDV_agec_allyr(yrs_agec_cDV(iyear))=nfish_agec_cDV(iyear);}}       //KC
...
FUNCTION get_length_at_age_dist
 ...
 //KC  lenprob_cHL=lenprob;
 //KC  lenprob_cDV=lenprob; 
  lenprob_rHB=lenprob;
  lenprob_rHB_D=lenprob;
  //KC lenprob_rGN=lenprob;
  //KClenprob_rGN_D=lenprob;   //KC
  //KC lenprob_sVD=lenprob; 
...
FUNCTION get_weight_at_age_landings  ///***in whole weight
  ...
  {
    len_cHL_mm(iyear)=meanlen_TL_L;  //KC changed from meanlen_TL to meanlen_TL_L  
   //KC  wholewgt_cHL_klb(iyear)=wgt_klb;
    gutwgt_cHL_klb(iyear)=wgt_klb_gut; wholewgt_cHL_klb(iyear)=wgt_klb_L; //wholeweight used to match index          //KC taken from gag2019.tpl  //KC changed wgt_klb to wgt_klb_L (wgt_klb_gut is already computed from wgt_klb_L above) 
    len_cDV_mm(iyear)=meanlen_TL_L;  //KC changed from meanlen_TL to meanlen_TL_L 
   //KC  wholewgt_cDV_klb(iyear)=wgt_klb;
    gutwgt_cDV_klb(iyear)=wgt_klb_gut;             //KC 
    len_rHB_mm(iyear)=meanlen_TL_L;  //KC changed from meanlen_TL to meanlen_TL_L 
   //KC  wholewgt_rHB_klb(iyear)=wgt_klb;
    gutwgt_rHB_klb(iyear)=wgt_klb_gut;             //KC
    len_rGN_mm(iyear)=meanlen_TL_L;  //KC changed from meanlen_TL to meanlen_TL_L 
   //KC  wholewgt_rGN_klb(iyear)=wgt_klb;
    gutwgt_rGN_klb(iyear)=wgt_klb_gut;             //KC

    len_cHL_D_mm(iyear)=meanlen_TL_L;    //KC changed from meanlen_TL to meanlen_TL_L             
  //KC wholewgt_cHL_D_klb(iyear)=wgt_klb;
    gutwgt_cHL_D_klb(iyear)=wgt_klb_gut;           //KC
    len_rHB_D_mm(iyear)=meanlen_TL_L;    //KC changed from meanlen_TL to meanlen_TL_L 
  //KC  wholewgt_rHB_D_klb(iyear)=wgt_klb;
    gutwgt_rHB_D_klb(iyear)=wgt_klb_gut;           //KC
    len_rGN_D_mm(iyear)=meanlen_TL_L;    //KC changed from meanlen_TL to meanlen_TL_L 
  //KC  wholewgt_rGN_D_klb(iyear)=wgt_klb;
    gutwgt_rGN_D_klb(iyear)=wgt_klb_gut;           //KC
  }  
...
FUNCTION get_selectivity
  ...
  sel_cHL_block1=logistic(agebins, selpar_A50_cHL1, selpar_slope_cHL1);              //KC added
  ...
  sel_cHL_block3=sel_cHL_block1;  //KC
  sel_cHL_block2=sel_cHL_block1;  //KC
  
  sel_cDV_block2=logistic_double(agebins, selpar_A50_cDV2, selpar_slope_cDV2, selpar_A502_cDV2,selpar_slope2_cDV2);
  //KC sel_cDV_block3=logistic_double(agebins, selpar_A50_cDV3, selpar_slope_cDV2, selpar_A502_cDV2,selpar_slope2_cDV2);
  sel_cDV_block1=sel_cDV_block2;
  sel_cDV_block3=sel_cDV_block2;  //KC added
  ...
  //KC sel_rHB_block3=logistic(agebins, selpar_A50_rHB3, selpar_slope_rHB3);
  sel_rHB_block3=sel_rHB_block2;   //KC added
  ...
  sel_rGN_block3=sel_rHB_block2;
   
  sel_sCT_vec=logistic_double(agebins, selpar_A50_sCT, selpar_slope_sCT, selpar_A502_sCT,selpar_slope2_sCT);
  //KC sel_sCT_vec=logistic(agebins, selpar_A50_sCT, selpar_slope_sCT);            //KC added

  //original code from KWS--assumes have a separate sCT and sVD selectivity
 ...
 //modification of  code from KWS--assumes have a single  sVD selectivity
//  selpar_switch_sVD=0.0;
//  for (iage=1; iage<=nages; iage++)
//    {if (selpar_switch_sVD==1.0 | sel_sVD_vec(iage)==max(sel_sVD_vec))
//      {sel_sVD_vec(iage)=1.0;
//      selpar_switch_sVD=1.0;
//    } else {sel_sVD_vec(iage)=sel_sVD_vec(iage);}
//  }
...
FUNCTION get_mortality
  ...
  Fapex.initialize();
  F.initialize();
  //initialization F is avg from first 3 yrs of observed landings; cDV excluded bc it doesn't start in styr
  log_F_dev_init_cHL=sum(log_dev_F_L_cHL(styr_L_cHL,(styr_L_cHL+2)))/3.0;  
 // log_F_dev_init_cDV=sum(log_dev_F_L_cDV(styr_L_cDV,(styr_L_cDV+2)))/3.0;      
  ...
  for (iyear=styr; iyear<=endyr; iyear++) 
  {
    ...
    if(iyear>=styr_L_cDV & iyear<=endyr_L_cDV) //spans full time series
		{F_cDV_out(iyear)=mfexp(log_avg_F_L_cDV+log_dev_F_L_cDV(iyear));}     
    ...
    if(iyear>endyr_selex_phase2 & iyear<styr_D_cHL)                                        //KC changed to selex_phase2 from selex_phase1 since cHL discards do not start until 1999
...
//KC took below initialization from 2014 gag update
  F_init_denom=mfexp(log_avg_F_L_cHL+log_F_dev_init_cHL)+mfexp(log_avg_F_L_rHB+log_F_dev_init_rHB)+mfexp(log_avg_F_L_rGN+log_F_dev_init_rGN);         //KC
  F_init_cHL_prop=mfexp(log_avg_F_L_cHL+log_F_dev_init_cHL)/F_init_denom;                                                                      //KC
  F_init_rHB_prop=mfexp(log_avg_F_L_rHB+log_F_dev_init_rHB)/F_init_denom;                                                                      //KC
  F_init_rGN_prop=mfexp(log_avg_F_L_rGN+log_F_dev_init_rGN)/F_init_denom;                                                                      //KC
  
  F_initial=sel_cHL(styr)*F_init*F_init_cHL_prop+                                                                                           //KC
            sel_rHB(styr)*F_init*F_init_rHB_prop+                                                                                           //KC
//KC            sel_rHB(styr)*F_init*F_init_rGN_prop; //rGN uses rHB selex                                                                    //KC
            sel_rGN(styr)*F_init*F_init_rGN_prop; //KC changed to use rGN selectivity                                                        //KC
...
//Below is old initialization based on virgin or estimate of 1st 3 years of F (without estimating an Finit)
   ...
   //KC         sel_cDV(styr)*mfexp(log_avg_F_L_cDV+log_F_dev_init_cDV)+
...
FUNCTION get_landings_wgt
  for (iyear=styr; iyear<=endyr; iyear++)
  {    
    L_cHL_klb(iyear)=elem_prod(L_cHL_num(iyear),gutwgt_cHL_klb(iyear));     //in 1000 lb gutted weight               //KC
    L_cDV_klb(iyear)=elem_prod(L_cDV_num(iyear),gutwgt_cDV_klb(iyear));     //in 1000 lb gutted weight                //KC
    L_rHB_klb(iyear)=elem_prod(L_rHB_num(iyear),gutwgt_rHB_klb(iyear));     //in 1000 lb gutted weight                //KC
    L_rGN_klb(iyear)=elem_prod(L_rGN_num(iyear),gutwgt_rGN_klb(iyear));     //in 1000 lb gutted weight                //KC
    
   //KC  L_cHL_klb(iyear)=elem_prod(L_cHL_num(iyear),wholewgt_cHL_klb(iyear));     //in 1000 lb whole weight
   //KC  L_cDV_klb(iyear)=elem_prod(L_cDV_num(iyear),wholewgt_cDV_klb(iyear));     //in 1000 lb whole weight
   //KC  L_rHB_klb(iyear)=elem_prod(L_rHB_num(iyear),wholewgt_rHB_klb(iyear));     //in 1000 lb whole weight
   //KC  L_rGN_klb(iyear)=elem_prod(L_rGN_num(iyear),wholewgt_rGN_klb(iyear));     //in 1000 lb whole weight
...
FUNCTION get_dead_discards
  ...
  for (iyear=styr; iyear<=endyr; iyear++)	  
  {
    ...
    pred_cHL_D_klb(iyear)=sum(elem_prod(D_cHL_num(iyear),gutwgt_cHL_D_klb(iyear))); //annual dead discards in 1000 lb gutted (for output only)       //KC
    //KC pred_cHL_D_klb(iyear)=sum(elem_prod(D_cHL_num(iyear),wholewgt_cHL_D_klb(iyear))); //annual dead discards in 1000 lb whole (for output only)
  }
  ...
  for (iyear=styr; iyear<=endyr; iyear++)
  {
    ...
    pred_rHB_D_klb(iyear)=sum(elem_prod(D_rHB_num(iyear),gutwgt_rHB_D_klb(iyear))); //annual dead discards in 1000 lb gutted (for output only)       //KC
    //KC pred_rHB_D_klb(iyear)=sum(elem_prod(D_rHB_num(iyear),wholewgt_rHB_D_klb(iyear))); //annual dead discards in 1000 lb whole (for output only)
  }
  ...
  for (iyear=styr; iyear<=endyr; iyear++)
  {
    ...
    pred_rGN_D_klb(iyear)=sum(elem_prod(D_rGN_num(iyear),gutwgt_rGN_D_klb(iyear))); //annual dead discards in 1000 lb gutted (for output only)      //KC
    //KC pred_rGN_D_klb(iyear)=sum(elem_prod(D_rGN_num(iyear),wholewgt_rGN_D_klb(iyear))); //annual dead discards in 1000 lb whole (for output only)
  }
...
FUNCTION get_length_comps
  ...
  //KC //cGN lines 
  //KC for (iyear=1;iyear<=nyr_cHL_lenc;iyear++)
  //KC {pred_cHL_lenc(iyear)=(L_cHL_num(yrs_cHL_lenc(iyear))*lenprob_cHL)/sum(L_cHL_num(yrs_cHL_lenc(iyear)));}
 
  //KC //cGN dive 
  //KC for (iyear=1;iyear<=nyr_cDV_lenc;iyear++)
  //KC {pred_cDV_lenc(iyear)=(L_cDV_num(yrs_cDV_lenc(iyear))*lenprob_cDV)/sum(L_cDV_num(yrs_cDV_lenc(iyear)));}
 ...
 //general rec   
//KC  for (iyear=1;iyear<=nyr_rGN_lenc;iyear++) 
//KC  {pred_rGN_lenc(iyear)=(L_rGN_num(yrs_rGN_lenc(iyear))*lenprob_rGN)/sum(L_rGN_num(yrs_rGN_lenc(iyear)));}
  
//KC  //rGN  discards   
//KC  for (iyear=1;iyear<=nyr_rGN_D_lenc;iyear++)                                                                      //KC
//KC  {pred_rGN_D_lenc(iyear)=(D_rGN_num(yrs_rGN_D_lenc(iyear))*lenprob_rGN_D)/sum(D_rGN_num(yrs_rGN_D_lenc(iyear)));}      //KC
  
 //KC  //sVD    
 //KC for (iyear=1;iyear<=nyr_sCT_lenc;iyear++) 
 //KC {pred_sCT_lenc(iyear)=(N_sCT(yrs_sCT_lenc(iyear))*lenprob_sCT)/sum(N_sCT(yrs_sCT_lenc(iyear)));}
...
FUNCTION get_age_comps
  ...
  for (iyear=1;iyear<=nyr_agec_cDV;iyear++) 
  {
    ErrorFree_cDV_agec(iyear)=L_cDV_num(yrs_agec_cDV(iyear))/sum(L_cDV_num(yrs_agec_cDV(iyear)));  
    pred_cDV_agec_allages(iyear)=age_error*(ErrorFree_cDV_agec(iyear)/sum(ErrorFree_cDV_agec(iyear)));   
    for (iage=1; iage<=nages_agec; iage++) {pred_cDV_agec(iyear,iage)=pred_cDV_agec_allages(iyear,iage);} 
    //for (iage=(nages_agec+1); iage<=nages; iage++) {pred_cDV_agec(iyear,nages_agec)+=pred_cDV_agec_allages(iyear,iage);} //plus group                             
  }
 ...
 for (iyear=1;iyear<=nyr_agec_sCT;iyear++)
  {
    ErrorFree_sCT_agec(iyear)=N_sVD(yrs_agec_sCT(iyear))/sum(N_sVD(yrs_agec_sCT(iyear)));
...
FUNCTION get_weighted_current 
  ...
  F_temp_sum+=mfexp((selpar_n_yrs_wgted*log_avg_F_L_cDV+
        sum(log_dev_F_L_cDV((endyr-selpar_n_yrs_wgted+1),endyr)))/selpar_n_yrs_wgted);  
  ...
  F_cDV_prop=mfexp((selpar_n_yrs_wgted*log_avg_F_L_cDV+
        sum(log_dev_F_L_cDV((endyr-selpar_n_yrs_wgted+1),endyr)))/selpar_n_yrs_wgted)/F_temp_sum;
  ...
  log_F_dev_end_cDV=sum(log_dev_F_L_cDV((endyr-selpar_n_yrs_wgted+1),endyr))/selpar_n_yrs_wgted;
  ...
  F_end_L=sel_cHL(endyr)*mfexp(log_avg_F_L_cHL+log_F_dev_end_cHL)+
          sel_cDV(endyr)*mfexp(log_avg_F_L_cDV+log_F_dev_end_cDV)+
  ...
  wgt_wgted_L_denom=F_cHL_prop+F_cDV_prop+F_rHB_prop+F_rGN_prop;              //KC
  wgt_wgted_L_klb=F_cHL_prop/wgt_wgted_L_denom*gutwgt_cHL_klb(endyr)+       //KC
                  F_cDV_prop/wgt_wgted_L_denom*gutwgt_cDV_klb(endyr)+       //KC
                  F_rHB_prop/wgt_wgted_L_denom*gutwgt_rHB_klb(endyr)+       //KC
                  F_rGN_prop/wgt_wgted_L_denom*gutwgt_rGN_klb(endyr);       //KC
  //KC wgt_wgted_L_klb=F_cHL_prop/wgt_wgted_L_denom*wholewgt_cHL_klb(endyr)+ 
  //KC	          F_cDV_prop/wgt_wgted_L_denom*wholewgt_cDV_klb(endyr)+ 
  //KC                F_rHB_prop/wgt_wgted_L_denom*wholewgt_rHB_klb(endyr)+
  //KC                F_rGN_prop/wgt_wgted_L_denom*wholewgt_rGN_klb(endyr);                          

  wgt_wgted_D_denom=F_cHL_D_prop+F_rHB_D_prop+F_rGN_D_prop;                                           //KC
  wgt_wgted_D_klb=F_cHL_D_prop/wgt_wgted_D_denom*gutwgt_cHL_D_klb(endyr)+                            //KC
                  F_rHB_D_prop/wgt_wgted_D_denom*gutwgt_rHB_D_klb(endyr)+                            //KC
                  F_rGN_D_prop/wgt_wgted_D_denom*gutwgt_rGN_D_klb(endyr);                            //KC
  //KC wgt_wgted_D_denom=F_cHL_D_prop+F_rHB_D_prop+F_rGN_D_prop;  
  //KC wgt_wgted_D_klb=F_cHL_D_prop/wgt_wgted_D_denom*wholewgt_cHL_D_klb(endyr)+ 
  //KC                F_rHB_D_prop/wgt_wgted_D_denom*wholewgt_rHB_D_klb(endyr)+
  //KC                F_rGN_D_prop/wgt_wgted_D_denom*wholewgt_rGN_D_klb(endyr);                
...
//switch here if var_rec_dev <=dzero 
  ...
  for(iyear=styr; iyear<=endyr; iyear++)
  {
        L_total_klb_yr(iyear)=pred_cHL_L_klb(iyear)+pred_cDV_L_klb(iyear)+pred_rHB_L_klb(iyear)+pred_rGN_L_klb(iyear);
        L_total_knum_yr(iyear)=pred_cHL_L_knum(iyear)+pred_cDV_L_knum(iyear)+pred_rHB_L_knum(iyear)+pred_rGN_L_knum(iyear);
	         ...
	         if (iyear>endyr_selex_phase1 && iyear<=endyr)			
        {
         ...
         D_cHL_klb(iyear)=elem_prod(D_cHL_num(iyear),gutwgt_cHL_D_klb(iyear));     //in 1000 lb gutted      //KC
         //KC D_cHL_klb(iyear)=elem_prod(D_cHL_num(iyear),wholewgt_cHL_D_klb(iyear));     //in 1000 lb 
        }
		...
		if (iyear>endyr_selex_phase1 && iyear<=endyr)
        {
         ...
         D_rHB_klb(iyear)=elem_prod(D_rHB_num(iyear),gutwgt_rHB_D_klb(iyear));     //in 1000 lb gutted       //KC
         //KC D_rHB_klb(iyear)=elem_prod(D_rHB_num(iyear),wholewgt_rHB_D_klb(iyear));     //in 1000 lb 
        }    
		...
		if (iyear>=styr_D_rGN && iyear<=endyr)	
        {
         ...
         D_rGN_klb(iyear)=elem_prod(D_rGN_num(iyear),gutwgt_rGN_D_klb(iyear));     //in 1000 lb gutted       //KC
         //KC D_rGN_klb(iyear)=elem_prod(D_rGN_num(iyear),wholewgt_rGN_D_klb(iyear));     //in 1000 lb 
        }                          
  }
  
  L_total_num=L_cHL_num+L_cDV_num+L_rHB_num+L_rGN_num;   //landings at age in number fish
  L_total_klb=L_cHL_klb+L_cDV_klb+L_rHB_klb+L_rGN_klb;   //landings at age in klb whole weight
...
//---Indices-------------------------------
  ...
  //KC f_cHL_cpue=0.0;
  //KC f_cHL_cpue=lk_lognormal(pred_cHL_cpue, obs_cpue_cHL, obs_cv_cpue_cHL, w_cpue_cHL);
  //KC fval+=f_cHL_cpue;
  //KC fval_data+=f_cHL_cpue;  
...
//---Landings-------------------------------
  ...
  f_cDV_L=lk_lognormal(pred_cDV_L_klb(styr_L_cDV,endyr_L_cDV), obs_L_cDV(styr_L_cDV,endyr_L_cDV),
                      obs_cv_L_cDV(styr_L_cDV,endyr_L_cDV), w_L);
  fval+=f_cDV_L;
  fval_data+=f_cDV_L;
...
//---Length comps-------------------------------
  ...
  //KC f_cHL_lenc=lk_dirichlet_multinomial(nsamp_cHL_lenc, pred_cHL_lenc, obs_cHL_lenc, nyr_cHL_lenc, double(nlenbins), minSS_cHL_lenc, log_dm_cHL_lc);
  //KC fval+=f_cHL_lenc;
  //KC fval_data+=f_cHL_lenc;
  ...
  //f_rGN_lenc
  //f_rGN_lenc=lk_robust_multinomial(nsamp_rGN_lenc, pred_rGN_lenc, obs_rGN_lenc, nyr_rGN_lenc, double(nlenbins), minSS_rGN_lenc, w_lc_rGN);
  //f_rGN_lenc=lk_logistic_normal(nsamp_rGN_lenc, pred_rGN_lenc, obs_rGN_lenc, nyr_rGN_lenc, double(nlenbins), minSS_rGN_lenc);
  //KC f_rGN_lenc=lk_dirichlet_multinomial(nsamp_rGN_lenc, pred_rGN_lenc, obs_rGN_lenc, nyr_rGN_lenc, double(nlenbins), minSS_rGN_lenc, log_dm_rGN_lc);
  //KC fval+=f_rGN_lenc;
  //KC fval_data+=f_rGN_lenc;
  ...
  //f_rGN_D_lenc
  //f_rGN_D_lenc=lk_robust_multinomial(nsamp_rGN_D_lenc, pred_rGN_D_lenc, obs_rGN_D_lenc, nyr_rGN_D_lenc, double(nlenbins), minSS_rGN_D_lenc, w_lc_rGN_D);       //KC
  //f_rGN_D_lenc=lk_logistic_normal(nsamp_rGN_D_lenc, pred_rGN_D_lenc, obs_rGN_D_lenc, nyr_rGN_D_lenc, double(nlenbins), minSS_rGN_D_lenc);                     //KC
  //f_rGN_D_lenc=lk_dirichlet_multinomial(nsamp_rGN_D_lenc, pred_rGN_D_lenc, obs_rGN_D_lenc, nyr_rGN_D_lenc, double(nlenbins), minSS_rGN_D_lenc, log_dm_rGN_D_lc); //KC
  //fval+=f_rGN_D_lenc;                                                                                                                                      //KC
  //fval_data+=f_rGN_D_lenc;                                                                                                                                 //KC
  
  //f_sVD_lenc
  //f_sVD_lenc=lk_robust_multinomial(nsamp_sVD_lenc, pred_sVD_lenc, obs_sVD_lenc, nyr_sVD_lenc, double(nlenbins), minSS_sVD_lenc, w_lc_sVD);
  //f_sVD_lenc=lk_logistic_normal(nsamp_sVD_lenc, pred_sVD_lenc, obs_sVD_lenc, nyr_sVD_lenc, double(nlenbins), minSS_sVD_lenc);
  //KC f_sVD_lenc=lk_dirichlet_multinomial(nsamp_sVD_lenc, pred_sVD_lenc, obs_sVD_lenc, nyr_sVD_lenc, double(nlenbins), minSS_sVD_lenc, log_dm_sVD_lc);
  //KC fval+=f_sVD_lenc;
  //KC fval_data+=f_sVD_lenc;
...
//---Age comps-------------------------------
  ...
  //f_cDV_agec             //KC added this whole section
  //f_cDV_agec=lk_robust_multinomial(nsamp_agec_cDV, pred_cDV_agec, obs_agec_cDV, nyr_agec_cDV, double(nages_agec), minSS_agec_cDV, w_agec_cDV);
  //f_cDV_agec=lk_logistic_normal(nsamp_agec_cDV, pred_cDV_agec, obs_agec_cDV, nyr_agec_cDV, double(nages_agec), minSS_agec_cDV);
  f_cDV_agec=lk_dirichlet_multinomial(nsamp_agec_cDV, pred_cDV_agec, obs_agec_cDV, nyr_agec_cDV, double(nages_agec), minSS_agec_cDV, log_dm_agec_cDV);
  fval+=f_cDV_agec;
 ...
 //fval_data+=f_rGN_agec;
  ...
  //f_sVD_agec
  //f_sVD_agec=lk_robust_multinomial(nsamp_sVD_agec, pred_sVD_agec, obs_sVD_agec, nyr_sVD_agec, double(nages_agec), minSS_sVD_agec, w_ac_sVD);
  //f_sVD_agec=lk_logistic_normal(nsamp_sVD_agec, pred_sVD_agec, obs_sVD_agec, nyr_sVD_agec, double(nages_agec), minSS_sVD_agec);
...
//pdf type 1=none, 2=lognormal, 3=normal, 4=beta 
  ...
  f_priors+=neg_log_prior(selpar_A50_cHL1,set_selpar_A50_cHL1(5), set_selpar_A50_cHL1(6), set_selpar_A50_cHL1(7));            //KC uncommented
  f_priors+=neg_log_prior(selpar_slope_cHL1,set_selpar_slope_cHL1(5), set_selpar_slope_cHL1(6), set_selpar_slope_cHL1(7));    //KC uncommented
  ...
  //KC f_priors+=neg_log_prior(selpar_A50_cDV3,set_selpar_A50_cDV3(5), set_selpar_A50_cDV3(6), set_selpar_A50_cDV3(7));
  ...
  f_priors+=neg_log_prior(selpar_A50_rGN2,set_selpar_A50_rGN2(5), set_selpar_A50_rGN2(6), set_selpar_A50_rGN2(7));            //KC
  f_priors+=neg_log_prior(selpar_slope_rGN2,set_selpar_slope_rGN2(5), set_selpar_slope_rGN2(6), set_selpar_slope_rGN2(7));    //KC
  ...
  //KC f_priors+=neg_log_prior(log_dm_cHL_lc,set_log_dm_cHL_lc(5),set_log_dm_cHL_lc(6),set_log_dm_cHL_lc(7));
  //KC f_priors+=neg_log_prior(log_dm_cDV_lc,set_log_dm_cDV_lc(5),set_log_dm_cDV_lc(6),set_log_dm_cDV_lc(7));
  f_priors+=neg_log_prior(log_dm_lenc_rHB,set_log_dm_lenc_rHB(5),set_log_dm_lenc_rHB(6),set_log_dm_lenc_rHB(7));
 //KC  f_priors+=neg_log_prior(log_dm_rGN_lc,set_log_dm_rGN_lc(5),set_log_dm_rGN_lc(6),set_log_dm_rGN_lc(7));
  f_priors+=neg_log_prior(log_dm_lenc_rHB_D,set_log_dm_lenc_rHB_D(5),set_log_dm_lenc_rHB_D(6),set_log_dm_lenc_rHB_D(7));
  //KC f_priors+=neg_log_prior(log_dm_rGN_D_lc,set_log_dm_rGN_D_lc(5),set_log_dm_rGN_D_lc(6),set_log_dm_rGN_D_lc(7));      //KC
  //KC f_priors+=neg_log_prior(log_dm_sVD_lc,set_log_dm_sVD_lc(5),set_log_dm_sVD_lc(6),set_log_dm_sVD_lc(7));
  f_priors+=neg_log_prior(log_dm_agec_cHL,set_log_dm_agec_cHL(5),set_log_dm_agec_cHL(6),set_log_dm_agec_cHL(7));
  f_priors+=neg_log_prior(log_dm_agec_cDV,set_log_dm_agec_cDV(5),set_log_dm_agec_cDV(6),set_log_dm_agec_cDV(7));      //KC
...
REPORT_SECTION
  ...
  if (last_phase())  
  {
      ...
      //KC sdnr_lc_cHL=sdnr_multinomial(nyr_cHL_lenc, lenbins, nsamp_cHL_lenc, pred_cHL_lenc, obs_cHL_lenc, w_lc_cHL);  
      //KC sdnr_lc_cDV=sdnr_multinomial(nyr_cDV_lenc, lenbins, nsamp_cDV_lenc, pred_cDV_lenc, obs_cDV_lenc, w_lc_cDV);  	  
      sdnr_lc_rHB=sdnr_multinomial(nyr_lenc_rHB, lenbins, nsamp_lenc_rHB, pred_rHB_lenc, obs_lenc_rHB, w_lenc_rHB); 
      //KC sdnr_lc_rGN=sdnr_multinomial(nyr_rGN_lenc, lenbins, nsamp_rGN_lenc, pred_rGN_lenc, obs_rGN_lenc, w_lc_rGN); 
      sdnr_lc_rHB_D=sdnr_multinomial(nyr_lenc_rHB_D, lenbins, nsamp_lenc_rHB_D, pred_rHB_D_lenc, obs_lenc_rHB_D, w_lenc_rHB_D);
      //KC sdnr_lc_rGN_D=sdnr_multinomial(nyr_rGN_D_lenc, lenbins, nsamp_rGN_D_lenc, pred_rGN_D_lenc, obs_rGN_D_lenc, w_lc_rGN_D);   //KC
      //KC sdnr_lc_sVD=sdnr_multinomial(nyr_sVD_lenc, lenbins, nsamp_sVD_lenc, pred_sVD_lenc, obs_sVD_lenc, w_lc_sVD); 
       
      sdnr_ac_cHL=sdnr_multinomial(nyr_agec_cHL, agebins_agec, nsamp_agec_cHL, pred_cHL_agec, obs_agec_cHL, w_agec_cHL);
      sdnr_ac_cDV=sdnr_multinomial(nyr_agec_cDV, agebins_agec, nsamp_agec_cDV, pred_cDV_agec, obs_agec_cDV, w_agec_cDV);          //KC
      ...
      //################################################################################################# 
	   ...
	   //KC log_dm_cHL_lc_out(8)=log_dm_cHL_lc; log_dm_cHL_lc_out(1,7)=set_log_dm_cHL_lc;
	   //KC log_dm_cDV_lc_out(8)=log_dm_cDV_lc; log_dm_cDV_lc_out(1,7)=set_log_dm_cDV_lc;
	   log_dm_rHB_lc_out(8)=log_dm_lenc_rHB; log_dm_rHB_lc_out(1,7)=set_log_dm_lenc_rHB;
	   //KC log_dm_rGN_lc_out(8)=log_dm_rGN_lc; log_dm_rGN_lc_out(1,7)=set_log_dm_rGN_lc;
	   log_dm_rHB_D_lc_out(8)=log_dm_lenc_rHB_D; log_dm_rHB_D_lc_out(1,7)=set_log_dm_lenc_rHB_D;
           //KC log_dm_rGN_D_lc_out(8)=log_dm_rGN_D_lc; log_dm_rGN_D_lc_out(1,7)=set_log_dm_rGN_D_lc;      //KC
	   //KC log_dm_sVD_lc_out(8)=log_dm_sVD_lc; log_dm_sVD_lc_out(1,7)=set_log_dm_sVD_lc;
	   log_dm_cHL_ac_out(8)=log_dm_agec_cHL; log_dm_cHL_ac_out(1,7)=set_log_dm_agec_cHL;
           log_dm_cDV_ac_out(8)=log_dm_agec_cDV; log_dm_cDV_ac_out(1,7)=set_log_dm_agec_cDV;              //KC
       ...
       selpar_A50_cHL1_out(8)=selpar_A50_cHL1; selpar_A50_cHL1_out(1,7)=set_selpar_A50_cHL1;          //KC uncommented
       selpar_slope_cHL1_out(8)=selpar_slope_cHL1; selpar_slope_cHL1_out(1,7)=set_selpar_slope_cHL1;  //KC uncommented
       ...
       //KC selpar_A50_cDV3_out(8)=selpar_A50_cDV3; selpar_A50_cDV3_out(1,7)=set_selpar_A50_cDV3;
       ...
       selpar_A50_rGN2_out(8)=selpar_A50_rGN2; selpar_A50_rGN2_out(1,7)=set_selpar_A50_rGN2;          //KC
       selpar_slope_rGN2_out(8)=selpar_slope_rGN2; selpar_slope_rGN2_out(1,7)=set_selpar_slope_rGN2;  //KC
       ...
       log_avg_F_cDV_out(8)=log_avg_F_L_cDV; log_avg_F_cDV_out(1,7)=set_log_avg_F_L_cDV;
       ...
       log_F_dev_cDV_out(styr_L_cDV,endyr_L_cDV)=log_dev_F_L_cDV;
