...
cout << endl;
  ...
  nyr_lenc_pool_rGND.allocate("nyr_lenc_pool_rGND");
  yrs_lenc_pool_rGND.allocate(1,nyr_lenc_pool_rGND,"yrs_lenc_pool_rGND");
  nfish_lenc_pool_rGND.allocate(1,nyr_lenc_pool_rGND,"nfish_lenc_pool_rGND");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  #endif
  pred_rGN_D_lenc_yr.allocate(1,nyr_lenc_pool_rGND,1,nlenbins,"pred_rGN_D_lenc_yr");
  #ifndef NO_AD_INITIALIZE
