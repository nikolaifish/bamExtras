...
// SERFS chevron trap/video length compositions (3 cm bins)
init_int nyr_lenc_sTV;
init_ivector yrs_lenc_sTV(1,nyr_lenc_sTV);
init_vector nsamp_lenc_sTV(1,nyr_lenc_sTV);
init_vector nfish_lenc_sTV(1,nyr_lenc_sTV);
init_matrix obs_lenc_sTV(1,nyr_lenc_sTV,1,nlenbins);
 
// SERFS chevron trap/video age compositions
...
init_matrix obs_agec_sTV(1,nyr_agec_sTV,1,nages_agec);
...
// rHB landings length compositions (3 cm bins)
...
// rHB discard length compositions
...
// rGN (MRIP) landings length compositions (3 cm bins)
...
// // rGN landings age compositions (single pooled age comp over 2004-2005 MRIP CB mode; weighted by number trips)
...
// init_matrix obs_rGN_agec(1,nyr_rGN_agec,1,nages_agec);
...
// FISHERY INDEPENDENT  Von Bert parameters in mm FL mm all FI (SERFS chevron trap/video) fish
init_vector set_Linf_sTV(1,7);
init_vector set_K_sTV(1,7);
init_vector set_t0_sTV(1,7);
//CV of length at age fishery-independent trap/video
init_vector set_len_cv_sTV(1,7)
...
init_vector set_selpar_L50_cHL1(1,7);
init_vector set_selpar_slope_cHL1(1,7);

// init_vector set_selpar_L50_cHL2(1,7);   //if using selectivity blocks
// init_vector set_selpar_slope_cHL2(1,7); //if using selectivity blocks

// init_vector set_selpar_L50_cHL3(1,7);   //if using selectivity blocks
// init_vector set_selpar_slope_cHL3(1,7); //if using selectivity blocks

// SERFS chevron trap/video selectivity
init_vector set_selpar_L50_sTV(1,7);
...
init_vector set_selpar_L51_rHB1(1,7);
init_vector set_selpar_slope1_rHB1(1,7);
init_vector set_selpar_L52_rHB1(1,7);
init_vector set_selpar_slope2_rHB1(1,7);

init_vector set_selpar_L50_rHB2(1,7);
init_vector set_selpar_slope_rHB2(1,7);
init_vector set_selpar_afull_rHB2(1,7);
init_vector set_selpar_sigma_rHB2(1,7)
    
// init_vector set_selpar_L50_rHB3(1,7); //if using selectivity blocks
// init_vector set_selpar_slope_rHB3(1,7); //if using selectivity blocks

// Headboat discard selectivity
init_vector set_selpar_L50_rHB_D(1,7);
init_vector set_selpar_slope_rHB_D(1,7);
init_vector set_selpar_afull_rHB_D(1,7);
init_vector set_selpar_sigma_rHB_D(1,7);

// rGN selectivity
init_vector set_selpar_L51_rGN(1,7);
init_vector set_selpar_slope1_rGN(1,7);
init_vector set_selpar_L52_rGN(1,7);
init_vector set_selpar_slope2_rGN(1,7);

//--index catchability-----------------------------------------------------------------------------------
init_vector set_log_q_cpue_cHL(1,7);      //catchability coefficient (log) for cGN handline index
init_vector set_log_q_cpue_sTV(1,7);    //catchability coefficient (log) for SERFS chevron trap/video index
...
init_vector set_log_q_cpue_rGN(1,7);      //catchability coefficient (log) for general rec index
...
init_number set_w_cpue_sTV;       //weight for SERFS chevron trap/video index
//init_number set_w_I_vid;        //weight for SEFIS video index
init_number set_w_cpue_rHB;         //weight for headboat index
init_number set_w_cpue_rGN;         //weight for MRFSS index
init_number set_w_lenc_cHL;        //weight for cGN handline len comps
init_number set_w_lenc_sTV;      //weight for SERFS chevron trap/video len comps
init_number set_w_lenc_rHB;        //weight for headboat len comps
init_number set_w_lenc_rHB_D;      //weight for headboat discards len comps
init_number set_w_lenc_rGN;        //weight for rGN (rGN) len comps 
init_number set_w_agec_cHL;        //weight for cGN handline age comps
init_number set_w_agec_sTV;      //weight for SERFS chevron trap/video age comps
init_number set_w_agec_rHB;        //weight for headboat age comps
//init_number set_w_ac_rGN;        //weight for rGN (MRIP) age comps
...
init_number minSS_agec_sTV;
init_number minSS_agec_rHB;
//init_number minSS_rGN_agec;
...
//const double selpar_L50_cHL3_LO=set_selpar_L50_cHL3(2); const double selpar_L50_cHL3_HI=set_selpar_L50_cHL3(3); const double selpar_L50_cHL3_PH=set_selpar_L50_cHL3(4);
...
//const double selpar_L50_rHB3_LO=set_selpar_L50_rHB3(2); const double selpar_L50_rHB3_HI=set_selpar_L50_rHB3(3); const double selpar_L50_rHB3_PH=set_selpar_L50_rHB3(4);
...
////--------------Growth-------------------------------------------------------------------------------- 
  ...
  //FISHERY INDEPENDENT (SERFS chevron trap/video) GROWTH CURVE
  init_bounded_number Linf_sTV(Linf_sTV_LO,Linf_sTV_HI,Linf_sTV_PH);
  init_bounded_number K_sTV(K_sTV_LO,K_sTV_HI,K_sTV_PH);
  init_bounded_number t0_sTV(t0_sTV_LO,t0_sTV_HI,t0_sTV_PH);
  init_bounded_number len_cv_val_sTV(len_cv_sTV_LO,len_cv_sTV_HI,len_cv_sTV_PH);
  ...
  vector Linf_sTV_out(1,8);
  vector K_sTV_out(1,8);
  vector t0_sTV_out(1,8);
  vector len_cv_val_sTV_out(1,8);
  ...
  //FISHERY INDEPENDENT (SERFS chevron trap/video) GROWTH CURVE
  vector meanlen_FL_sTV(1,nages);   //mean fork length (mm) at age all fish
  ...
  matrix len_sTV_mm(styr,endyr,1,nages);        //mean length at age of SERFS chevron trap/video in mm (may differ from popn mean)
  matrix wholewgt_sTV_klb(styr,endyr,1,nages);  //whole wgt of SERFS chevron trap/video in 1000 lb   
  ...
  matrix lenprob_sTV(1,nages,1,nlenbins);   //distn of size at age in SERFS chevron trap/video
...
//  number log_len_cv
  ...
  //SERFS chevron trap/video
  vector len_sd_sTV(1,nages);
  vector len_cv_sTV(1,nages); //for fishgraph

//----Predicted length and age compositions
  matrix pred_cHL_lenc(1,nyr_lenc_cHL,1,nlenbins);  
  matrix pred_sTV_lenc(1,nyr_lenc_sTV,1,nlenbins);  
  ...
  matrix pred_sTV_agec(1,nyr_agec_sTV,1,nages_agec);
  matrix pred_sTV_agec_allages(1,nyr_agec_sTV,1,nages);  
  ...
  //matrix pred_rGN_agec(1,nyr_rGN_agec,1,nages_agec);
  //matrix pred_rGN_agec_allages(1,nyr_rGN_agec,1,nages);  
...
//Effective sample size applied in multinomial distributions
  ...
  vector nsamp_sTV_lenc_allyr(styr,endyr);
...
//Nfish used in MCB analysis (not used in fitting)
  ...
  vector nfish_sTV_lenc_allyr(styr,endyr);
...
//Computed effective sample size for output (not used in fitting)
  ...
  vector neff_sTV_lenc_allyr_out(styr,endyr);
...
//Commercial handline-------------------------------------------------
  ...
  init_bounded_number selpar_L50_cHL1(selpar_L50_cHL1_LO,selpar_L50_cHL1_HI,selpar_L50_cHL1_PH);
...
//Recreational (rHB)-------------------------------------------------
  ...
  init_bounded_number selpar_L51_rHB1(selpar_L51_rHB1_LO,selpar_L51_rHB1_HI,selpar_L51_rHB1_PH);
  init_bounded_number selpar_slope1_rHB1(selpar_slope1_rHB1_LO,selpar_slope1_rHB1_HI,selpar_slope1_rHB1_PH);
  init_bounded_number selpar_L52_rHB1(selpar_L52_rHB1_LO,selpar_L52_rHB1_HI,selpar_L52_rHB1_PH);
  init_bounded_number selpar_slope2_rHB1(selpar_slope2_rHB1_LO,selpar_slope2_rHB1_HI,selpar_slope2_rHB1_PH);

  init_bounded_number selpar_L50_rHB2(selpar_L50_rHB2_LO,selpar_L50_rHB2_HI,selpar_L50_rHB2_PH);
  init_bounded_number selpar_slope_rHB2(selpar_slope_rHB2_LO,selpar_slope_rHB2_HI,selpar_slope_rHB2_PH);
  init_bounded_number selpar_afull_rHB2(selpar_afull_rHB2_LO,selpar_afull_rHB2_HI,selpar_afull_rHB2_PH);
  init_bounded_number selpar_sigma_rHB2(selpar_sigma_rHB2_LO,selpar_sigma_rHB2_HI,selpar_sigma_rHB2_PH)

//  init_bounded_number selpar_L50_rHB3(selpar_L50_rHB3_LO,selpar_L50_rHB3_HI,selpar_L50_rHB3_PH);
//  init_bounded_number selpar_slope_rHB3(selpar_slope_rHB3_LO,selpar_slope_rHB3_HI,selpar_slope_rHB3_PH);
  
  vector selpar_L51_rHB1_out(1,8);
  vector selpar_slope1_rHB1_out(1,8);
  vector selpar_L52_rHB1_out(1,8);
  vector selpar_slope2_rHB1_out(1,8);

  vector selpar_L50_rHB2_out(1,8);
  vector selpar_slope_rHB2_out(1,8);
  vector selpar_afull_rHB2_out(1,8);
  vector selpar_sigma_rHB2_out(1,8);

//  vector selpar_L50_rHB3_out(1,8);
//  vector selpar_slope_rHB3_out(1,8);

//rHB discard selectivities
  matrix sel_rHB_D(styr,endyr,1,nages);
  init_bounded_number selpar_L50_rHB_D(selpar_L50_rHB_D_LO,selpar_L50_rHB_D_HI,selpar_L50_rHB_D_PH);
  init_bounded_number selpar_slope_rHB_D(selpar_slope_rHB_D_LO,selpar_slope_rHB_D_HI,selpar_slope_rHB_D_PH);
  init_bounded_number selpar_afull_rHB_D(selpar_afull_rHB_D_LO,selpar_afull_rHB_D_HI,selpar_afull_rHB_D_PH);
  init_bounded_number selpar_sigma_rHB_D(selpar_sigma_rHB_D_LO,selpar_sigma_rHB_D_HI,selpar_sigma_rHB_D_PH);

  vector selpar_L50_rHB_D_out(1,8);
  vector selpar_slope_rHB_D_out(1,8);
  vector selpar_afull_rHB_D_out(1,8);
  vector selpar_sigma_rHB_D_out(1,8);
 
//Recreational (rGN)----------------------------------------
  matrix sel_rGN(styr,endyr,1,nages);
  init_bounded_number selpar_L51_rGN(selpar_L51_rGN_LO,selpar_L51_rGN_HI,selpar_L51_rGN_PH);
  init_bounded_number selpar_slope1_rGN(selpar_slope1_rGN_LO,selpar_slope1_rGN_HI,selpar_slope1_rGN_PH);
  init_bounded_number selpar_L52_rGN(selpar_L52_rGN_LO,selpar_L52_rGN_HI,selpar_L52_rGN_PH);
  init_bounded_number selpar_slope2_rGN(selpar_slope2_rGN_LO,selpar_slope2_rGN_HI,selpar_slope2_rGN_PH);

  vector selpar_L51_rGN_out(1,8);
  vector selpar_slope1_rGN_out(1,8);
  vector selpar_L52_rGN_out(1,8);
  vector selpar_slope2_rGN_out(1,8);

//rGN discard selectivity
  matrix sel_rGN_D(styr,endyr,1,nages);
//  vector selpar_L50_rGN_D_out(1,8); //set to rHB_D selectivity
//  vector selpar_slope_rGN_D_out(1,8); //set to rHB_D selectivity
...
//-------CPUE Predictions--------------------------------
  ...
  vector pred_sTV_cpue(styr_cpue_sTV,endyr_cpue_sTV);  //predicted SERFS chevron trap/video  index (weight fish per effort)
  matrix N_sTV(styr_cpue_sTV,endyr_cpue_sTV,1,nages);  //used to compute SERFS chevron trap/video index
...
//---Catchability (CPUE q's)----------------------------------------------------------
  ...
  init_bounded_number log_q_cpue_sTV(log_q_sTV_LO,log_q_sTV_HI,log_q_sTV_PH);  
...
//  init_bounded_number q_rate(0.001,0.1,set_q_rate_phase); //not estimated 
  ...
  vector q_rate_fcn_sTV(styr_cpue_sTV,endyr_cpue_sTV);   //increase due to technology creep (saturates in 2003)
...
//  init_bounded_vector q_RW_log_dev_rHB(styr_cpue_rHB,endyr_cpue_rHB-1,-3.0,3.0,set_q_RW_phase); //not estimated in this model 
 vector q_RW_log_dev_cHL(styr_cpue_cHL,endyr_cpue_cHL-1); 
 vector q_RW_log_dev_sTV(styr_cpue_sTV,endyr_cpue_sTV-1); 
...
//Fishery dependent catchability over time, may be constant
 ...
 vector q_sTV(styr_cpue_sTV,endyr_cpue_sTV) 
...
//---Landings in numbers (total or 1000 fish) and in wgt (whole klb)--------------------------------------------------
  ...
  //vector obs_cHL_L_wbias(styr,endyr);     //yearly landings observed, perhaps adjusted for multiplicitive bias
  ...
  vector pred_rHB_L_klb(styr,endyr);      //yearly landings in 1000 lb gutted summed over ages
...
//---Discards (number dead fish) --------------------------------------------------  
  ...
  matrix D_rHB_klb(styr,endyr,1,nages);             //discards (1000 lb whole) at age
  ...
  matrix D_rGN_klb(styr,endyr,1,nages);             //discards (1000 lb whole) at age
...
////---MSY calcs----------------------------------------------------------------------------
  ...
  number F_init_rHB_D_prop;  //proportion of F_init attributable to rHB discards, first X yrs
  number F_init_rGN_D_prop;  //proportion of F_init attributable to rGN discards, first X yrs
...
// selpar_L50_rHB3=set_selpar_L50_rHB3(1);
...
//year-specific age at peak selectivity based on inspection of rHB age comps (rHB1=peak at age 3, rHB2=peak at age 6
//if no annual age comp available then assume peak at age 3 (rHB1); above loop
 
//     sel_rHB(1991)=logistic_double(agebins, selpar_L50_rHB2, selpar_slope_rHB2, selpar_afull_rHB2, selpar_sigma_rHB2);
//     sel_rHB(2007)=logistic_double(agebins, selpar_L50_rHB2, selpar_slope_rHB2, selpar_afull_rHB2, selpar_sigma_rHB2);
//     sel_rHB(2008)=logistic_double(agebins, selpar_L50_rHB2, selpar_slope_rHB2, selpar_afull_rHB2, selpar_sigma_rHB2);
//     sel_rHB(2009)=logistic_double(agebins, selpar_L50_rHB2, selpar_slope_rHB2, selpar_afull_rHB2, selpar_sigma_rHB2);
//     sel_rHB(2011)=logistic_double(agebins, selpar_L50_rHB2, selpar_slope_rHB2, selpar_afull_rHB2, selpar_sigma_rHB2); 
...
//     sel_sTV(iyear)=logistic_exponential(agebins, selpar_L50_sTV, selpar_slope_sTV, selpar_sigma_sTV, selpar_afull_sTV);      
//     sel_rHB(iyear)=logistic(agebins, selpar_L50_rHB2, selpar_slope_rHB2);
     
//     sel_sTV(iyear)(8,nages)=sel_sTV(iyear)(7);
...
//   {
//     sel_cHL(iyear)=logistic(agebins, selpar_L50_cHL3, selpar_slope_cHL3);
//     sel_sTV(iyear)=logistic_exponential(agebins, selpar_L50_sTV, selpar_slope_sTV, selpar_sigma_sTV, selpar_afull_sTV);      
//     sel_rHB(iyear)=logistic(agebins, selpar_L50_rHB3, selpar_slope_rHB3);
...
//        len_sd_sTV(iage)=len_sd_val_sTV;
//        len_cv_sTV(iage)=len_sd_sTV(iage)/meanlen_FL_sTV(iage);
...
//  f_priors+=neg_log_prior(selpar_L50_cHL3,set_selpar_L50_cHL3(5), set_selpar_L50_cHL3(6), set_selpar_L50_cHL3(7));
...
//  f_priors+=neg_log_prior(selpar_L50_rHB3,set_selpar_L50_rHB3(5), set_selpar_L50_rHB3(6), set_selpar_L50_rHB3(7));
...
//       selpar_L50_cHL3_out(8)=selpar_L50_cHL3; selpar_L50_cHL3_out(1,7)=set_selpar_L50_cHL3;
...
//       selpar_L50_rHB3_out(8)=selpar_L50_rHB3; selpar_L50_rHB3_out(1,7)=set_selpar_L50_rHB3;
