...
open_r_df("parm.cons",1,8,2);
	...
	wrt_r_df_col("log.dm.lenc.cOT",log_dm_cOT_lc_out);
    ...
    wrt_r_df_col("selpar.A50.cOT2",selpar_A50_cOT2_out);
    wrt_r_df_col("selpar.A50.cOT3",selpar_A50_cOT3_out);	
    wrt_r_df_col("selpar.slope1.cOT2",selpar_slope_cOT2_out);
	wrt_r_df_col("selpar.A502.cOT2",selpar_A502_cOT2_out);
	wrt_r_df_col("selpar.slope2.cOT2",selpar_slope2_cOT2_out);
