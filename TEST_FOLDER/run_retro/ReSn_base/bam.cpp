...
cout << endl;
  ...
  nyr_lenc_pool_cHLD1.allocate("nyr_lenc_pool_cHLD1");
  yrs_lenc_pool_cHLD1.allocate(1,nyr_lenc_pool_cHLD1,"yrs_lenc_pool_cHLD1");
  nsamp_lenc_pool_cHLD1.allocate(1,nyr_lenc_pool_cHLD1,"nsamp_lenc_pool_cHLD1");
  nyr_lenc_pool_cHLD2.allocate("nyr_lenc_pool_cHLD2");
  yrs_lenc_pool_cHLD2.allocate(1,nyr_lenc_pool_cHLD2,"yrs_lenc_pool_cHLD2");
  nsamp_lenc_pool_cHLD2.allocate(1,nyr_lenc_pool_cHLD2,"nsamp_lenc_pool_cHLD2");
  ...
  styr_cpue_rHB_D.allocate("styr_cpue_rHB_D");
  endyr_cpue_rHB_D.allocate("endyr_cpue_rHB_D");
  obs_cpue_rHB_D.allocate(styr_cpue_rHB_D,endyr_cpue_rHB_D,"obs_cpue_rHB_D");
  obs_cv_cpue_rHB_D.allocate(styr_cpue_rHB_D,endyr_cpue_rHB_D,"obs_cv_cpue_rHB_D");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  #endif
  pred_cHL_D_lenc_yr1.allocate(1,nyr_lenc_pool_cHLD1,1,nlenbins,"pred_cHL_D_lenc_yr1");
  #ifndef NO_AD_INITIALIZE
    pred_cHL_D_lenc_yr1.initialize();
  #endif
  pred_cHL_D_lenc_yr2.allocate(1,nyr_lenc_pool_cHLD2,1,nlenbins,"pred_cHL_D_lenc_yr2");
  #ifndef NO_AD_INITIALIZE
  ...
  N_rHB.allocate(styr_cpue_rHB,endyr_cpue_rHB,1,nages,"N_rHB");
    ...
    N_rHB.initialize();
  #endif
  pred_rHB_D_cpue.allocate(styr_cpue_rHB_D,endyr_cpue_rHB_D,"pred_rHB_D_cpue");
  #ifndef NO_AD_INITIALIZE
    pred_rHB_D_cpue.initialize();
  #endif
  N_rHB_D.allocate(styr_cpue_rHB_D,endyr_cpue_rHB_D,1,nages,"N_rHB_D");
  #ifndef NO_AD_INITIALIZE
    N_rHB_D.initialize();
  #endif
  ...
  #endif
  q_rate_fcn_rHB_D.allocate(styr_cpue_rHB_D,endyr_cpue_rHB_D,"q_rate_fcn_rHB_D");
  #ifndef NO_AD_INITIALIZE
  ...
  #endif
  q_RW_log_dev_rHB_D.allocate(styr_cpue_rHB_D,endyr_cpue_rHB_D-1,"q_RW_log_dev_rHB_D");
  #ifndef NO_AD_INITIALIZE
  ...
  q_rHB.allocate(styr_cpue_rHB,endyr_cpue_rHB,"q_rHB");
    ...
    q_rHB.initialize();
  #endif
  q_rHB_D.allocate(styr_cpue_rHB_D,endyr_cpue_rHB_D,"q_rHB_D");
  #ifndef NO_AD_INITIALIZE
    q_rHB_D.initialize();
  #endif
