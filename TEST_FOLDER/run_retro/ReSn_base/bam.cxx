...
open_r_info_list("parms", false);
	...
	wrt_r_item("Linf.20", Linf_20);
	wrt_r_item("K.20", K_20);
	wrt_r_item("t0.20", t0_20);
	wrt_r_item("len.cv.val.20",len_cv_val_20);
	...
	wrt_r_item("fecpar.scale",fecpar_scale);
...
open_r_df("parm.cons",1,8,2);
	...
	wrt_r_df_col("Linf.20", Linf_20_out);
	wrt_r_df_col("K.20", K_20_out);
	wrt_r_df_col("t0.20", t0_20_out);
	wrt_r_df_col("len.cv.val.20",len_cv_val_20_out);
	...
	wrt_r_df_col("selpar.A501.cHL2.D",selpar_A50_cHL2_D_out);
	wrt_r_df_col("selpar.slope1.cHL2.D",selpar_slope_cHL2_D_out);
	wrt_r_df_col("selpar.A502.cHL2.D",selpar_A502_cHL2_D_out);
	wrt_r_df_col("selpar.slope2.cHL2.D",selpar_slope2_cHL2_D_out);
	wrt_r_df_col("selpar.A50.cHL3.D",selpar_A50_cHL3_D_out);
	wrt_r_df_col("selpar.slope.cHL3.D",selpar_slope_cHL3_D_out);
	...
	wrt_r_df_col("selpar.A502.rHB2",selpar_A502_rHB2_out);
	wrt_r_df_col("selpar.slope2.rHB2",selpar_slope2_rHB2_out);
	...
	wrt_r_df_col("selpar.A501.rHB2.D",selpar_A50_rHB2_D_out);
	wrt_r_df_col("selpar.slope1.rHB2.D",selpar_slope_rHB2_D_out);
	wrt_r_df_col("selpar.A502.rHB2.D",selpar_A502_rHB2_D_out);
	wrt_r_df_col("selpar.slope2.rHB2.D",selpar_slope2_rHB2_D_out);
	wrt_r_df_col("selpar.A501.rHB3.D",selpar_A50_rHB3_D_out);
	wrt_r_df_col("selpar.slope1.rHB3.D",selpar_slope_rHB3_D_out);
	wrt_r_df_col("selpar.A502.rHB3.D",selpar_A502_rHB3_D_out);
	wrt_r_df_col("selpar.slope2.rHB3.D",selpar_slope2_rHB3_D_out);
	
    wrt_r_df_col("selpar.A501.rGN2",selpar_A50_rGN2_out);
    wrt_r_df_col("selpar.slope1.rGN2",selpar_slope_rGN2_out);
    ...
    wrt_r_df_col("selpar.A501.rGN3.D",selpar_A50_rGN3_D_out);
	wrt_r_df_col("selpar.slope1.rGN3.D",selpar_slope_rGN3_D_out);
	wrt_r_df_col("selpar.A502.rGN3.D",selpar_A502_rGN3_D_out);
	wrt_r_df_col("selpar.slope2.rGN3.D",selpar_slope2_rGN3_D_out);
	
	wrt_r_df_col("selpar.A50.sCT",selpar_A50_sCT_out);
    wrt_r_df_col("selpar.slope.sCT",selpar_slope_sCT_out);
    ...
    wrt_r_df_col("log.q.cpue.rHB.D",log_q_rHB_D_out);
