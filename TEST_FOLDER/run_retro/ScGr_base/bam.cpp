...
cout << endl;
  ...
  styr_cpue_cGN.allocate("styr_cpue_cGN");
  endyr_cpue_cGN.allocate("endyr_cpue_cGN");
  obs_cpue_cGN.allocate(styr_cpue_cGN,endyr_cpue_cGN,"obs_cpue_cGN");
  obs_cv_cpue_cGN.allocate(styr_cpue_cGN,endyr_cpue_cGN,"obs_cv_cpue_cGN");
  ...
  nyr_agec_cGN.allocate("nyr_agec_cGN");
  yrs_agec_cGN.allocate(1,nyr_agec_cGN,"yrs_agec_cGN");
  nsamp_agec_cGN.allocate(1,nyr_agec_cGN,"nsamp_agec_cGN");
  nfish_agec_cGN.allocate(1,nyr_agec_cGN,"nfish_agec_cGN");
  obs_agec_cGN.allocate(1,nyr_agec_cGN,1,nages_agec,"obs_agec_cGN");
  ...
  set_log_dm_agec_cGN.allocate(1,7,"set_log_dm_agec_cGN");
  ...
  set_selpar_A50_cGN3.allocate(1,7,"set_selpar_A50_cGN3");
  set_selpar_slope_cGN3.allocate(1,7,"set_selpar_slope_cGN3");
  ...
  set_log_q_cpue_cGN.allocate(1,7,"set_log_q_cpue_cGN");
  ...
  set_w_cpue_cGN.allocate("set_w_cpue_cGN");
  ...
  set_w_agec_cGN.allocate("set_w_agec_cGN");
  ...
  minSS_agec_cGN.allocate("minSS_agec_cGN");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  #endif
  pred_cGN_agec.allocate(1,nyr_agec_cGN,1,nages_agec,"pred_cGN_agec");
  #ifndef NO_AD_INITIALIZE
    pred_cGN_agec.initialize();
  #endif
  pred_cGN_agec_allages.allocate(1,nyr_agec_cGN,1,nages,"pred_cGN_agec_allages");
  #ifndef NO_AD_INITIALIZE
    pred_cGN_agec_allages.initialize();
  #endif
  ErrorFree_cGN_agec.allocate(1,nyr_agec_cGN,1,nages,"ErrorFree_cGN_agec");
  #ifndef NO_AD_INITIALIZE
    ErrorFree_cGN_agec.initialize();
  #endif
  ...
  #endif
  nsamp_cGN_agec_allyr.allocate(styr,endyr,"nsamp_cGN_agec_allyr");
  #ifndef NO_AD_INITIALIZE
    nsamp_cGN_agec_allyr.initialize();
  #endif
  ...
  #endif
  nfish_cGN_agec_allyr.allocate(styr,endyr,"nfish_cGN_agec_allyr");
  #ifndef NO_AD_INITIALIZE
    nfish_cGN_agec_allyr.initialize();
  #endif
  ...
  #endif
  neff_cGN_agec_allyr.allocate(styr,endyr,"neff_cGN_agec_allyr");
  #ifndef NO_AD_INITIALIZE
    neff_cGN_agec_allyr.initialize();
  #endif
  ...
  log_dm_agec_cGN.allocate(log_dm_cGN_ac_LO,log_dm_cGN_ac_HI,log_dm_cGN_ac_PH,"log_dm_agec_cGN");
  ...
  #endif
  log_dm_cGN_ac_out.allocate(1,8,"log_dm_cGN_ac_out");
  #ifndef NO_AD_INITIALIZE
    log_dm_cGN_ac_out.initialize();
  #endif
  ...
  sel_cGN.allocate(styr,endyr,1,nages,"sel_cGN");
    ...
    sel_cGN.initialize();
  #endif
  sel_cGN_block1.allocate(1,nages,"sel_cGN_block1");
  #ifndef NO_AD_INITIALIZE
    sel_cGN_block1.initialize();
  #endif
  sel_cGN_block3.allocate(1,nages,"sel_cGN_block3");
  #ifndef NO_AD_INITIALIZE
  ...
  selpar_A50_cGN3.allocate(selpar_A50_cGN3_LO,selpar_A50_cGN3_HI,selpar_A50_cGN3_PH,"selpar_A50_cGN3");
  selpar_slope_cGN3.allocate(selpar_slope_cGN3_LO,selpar_slope_cGN3_HI,selpar_slope_cGN3_PH,"selpar_slope_cGN3");
  ...
  #endif
  selpar_A50_cGN3_out.allocate(1,8,"selpar_A50_cGN3_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A50_cGN3_out.initialize();
  #endif
  selpar_slope_cGN3_out.allocate(1,8,"selpar_slope_cGN3_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope_cGN3_out.initialize();
  #endif
  ...
  #endif
  pred_cGN_cpue.allocate(styr_cpue_cGN,endyr_cpue_cGN,"pred_cGN_cpue");
  #ifndef NO_AD_INITIALIZE
    pred_cGN_cpue.initialize();
  #endif
  N_cGN.allocate(styr_cpue_cGN,endyr_cpue_cGN,1,nages,"N_cGN");
  #ifndef NO_AD_INITIALIZE
    N_cGN.initialize();
  #endif
  ...
  N_sCT.allocate(styr_cpue_sCT,endyr_cpue_sCT,1,nages,"N_sCT");
    ...
    N_sCT.initialize();
  #endif
  log_q_cpue_cGN.allocate(log_q_cGN_LO,log_q_cGN_HI,log_q_cGN_PH,"log_q_cpue_cGN");
  ...
  log_q_cGN_out.allocate(1,8,"log_q_cGN_out");
  #ifndef NO_AD_INITIALIZE
    log_q_cGN_out.initialize();
  #endif
  ...
  q_rate.initialize();
  #endif
  q_rate_fcn_cGN.allocate(styr_cpue_cGN,endyr_cpue_cGN,"q_rate_fcn_cGN");
  #ifndef NO_AD_INITIALIZE
    q_rate_fcn_cGN.initialize();
  #endif
  ...
  B_q_DD.allocate(styr,endyr,"B_q_DD");
    ...
    B_q_DD.initialize();
  #endif
  q_RW_log_dev_cGN.allocate(styr_cpue_cGN,endyr_cpue_cGN-1,log_RWq_LO,log_RWq_HI,log_RWq_PH,"q_RW_log_dev_cGN");
  q_RW_log_dev_rGN.allocate(styr_cpue_rGN,endyr_cpue_rGN-1,log_RWq_LO,log_RWq_HI,log_RWq_PH,"q_RW_log_dev_rGN");
  q_RW_log_dev_sCT.allocate(styr_cpue_sCT,endyr_cpue_sCT-1,"q_RW_log_dev_sCT");
  #ifndef NO_AD_INITIALIZE
    q_RW_log_dev_sCT.initialize();
  #endif
  q_cGN.allocate(styr_cpue_cGN,endyr_cpue_cGN,"q_cGN");
  #ifndef NO_AD_INITIALIZE
    q_cGN.initialize();
  #endif
  ...
  #endif
  sdnr_ac_cGN.allocate("sdnr_ac_cGN");
  #ifndef NO_AD_INITIALIZE
  sdnr_ac_cGN.initialize();
  #endif
  ...
  #endif
  sdnr_I_cGN.allocate("sdnr_I_cGN");
  #ifndef NO_AD_INITIALIZE
  sdnr_I_cGN.initialize();
  #endif
  ...
  w_L.initialize();
  #endif
  w_cpue_cGN.allocate("w_cpue_cGN");
  #ifndef NO_AD_INITIALIZE
  w_cpue_cGN.initialize();
  #endif
  ...
  #endif
  w_agec_cGN.allocate("w_agec_cGN");
  #ifndef NO_AD_INITIALIZE
  w_agec_cGN.initialize();
  #endif
  ...
  f_rGN_L.initialize();
  #endif
  f_cGN_cpue.allocate("f_cGN_cpue");
  #ifndef NO_AD_INITIALIZE
  f_cGN_cpue.initialize();
  #endif
  ...
  #endif
  f_cGN_RWq_cpue.allocate("f_cGN_RWq_cpue");
  #ifndef NO_AD_INITIALIZE
  f_cGN_RWq_cpue.initialize();
  #endif
  ...
  #endif
  f_cGN_agec.allocate("f_cGN_agec");
  #ifndef NO_AD_INITIALIZE
  f_cGN_agec.initialize();
  #endif
