...
cout << endl;
  ...
  set_log_dev_vals_F_LcH.allocate(styr_L_cHL,endyr_L_cHL,"set_log_dev_vals_F_LcH");
  set_log_dev_vals_F_LcL.allocate(styr_L_cLL,endyr_L_cLL,"set_log_dev_vals_F_LcL");
  set_log_dev_vals_F_LrA.allocate(styr_L_rGN,endyr_L_rGN,"set_log_dev_vals_F_LrA");
...
void model_parameters::preliminary_calculations(void)
{
  ...
  log_dev_F_L_cHL=set_log_dev_vals_F_LcH;
  log_dev_F_L_cLL=set_log_dev_vals_F_LcL;
  log_dev_F_L_rGN=set_log_dev_vals_F_LrA;
