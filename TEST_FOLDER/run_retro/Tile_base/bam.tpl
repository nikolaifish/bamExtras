...
init_vector set_log_dev_vals_F_LcH(styr_L_cHL,endyr_L_cHL);
init_vector set_log_dev_vals_F_LcL(styr_L_cLL,endyr_L_cLL);
init_vector set_log_dev_vals_F_LrA(styr_L_rGN,endyr_L_rGN);
