...
init_vector set_log_dm_lenc_cOT(1,7);    //Dirichlet-multinomial overdispersion parameter
...
init_vector set_log_q_cpue_sCT(1,7);     //catchability coefficient (log) for SERFS index  
...
init_number set_w_lenc_sCT;		//weight for the SERFS length comps  
...
////--------------Growth--------------------------------------------------------------------------- 
  ...
  matrix lenprob_cOT(1,nages,1,nlenbins);     //distn of size at age in cOT
...
REPORT_SECTION
  ...
  if (last_phase())  
  {
   ...
   #include "RedGrouper.cxx"   // write the R-compatible report
